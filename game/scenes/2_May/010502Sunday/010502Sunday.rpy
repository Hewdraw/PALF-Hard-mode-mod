...
python:
    renpy.music.play("Audio/music/runawayfugitives.mp3", channel='music', loop=True, fadein=1.0)
...
$ pichuid = pokedexlookupname("Pichu", DexMacros.Id)
$ PlaySound("pokemon/cries/{}.wav".format(pichuid))
...
leaf "Are you just going to sleep there and pretend there isn't a {i}big{/i} elephant in the room? What are we going to do?"
...
leaf @talkingmouth "My name's Leaf, not Leaflet. And I thought you were, like, his best friend."

ethan @happy "Man, I'm not {i}anybody's{/i} best friend."

leaf @talkingmouth "Do you at least know where he is?"
...
leaf @angrybrow angrysmilemouth "Oh, right, so it's a {i}total{/i} coincidence that you always end up in the same places? You just {i}coincidentally{/i} end up doing everything he does?"
...
leaf @talkingmouth "...Well, if you could be anywhere right now, where do you wish you were?"

ethan @happy "Honestly? Home."

leaf @closedbrow talkingmouth "...Ugh."

ethan @talking2mouth "Yeah, sorry. Why are you even asking? Don't you have his phone number?"

leaf @talkingmouth "I do! But he's not answering his phone. I haven't been able to track him down all of today, or yesterday."

leaf @closedbrow talkingmouth "I gave him some space yesterday, but... I thought we needed to talk today..."
...
leaf surprised "Did... did you not go to the speeches? You didn't even go there to support your two roommates?"
...
leaf -surprised frownmouth @sadbrow talkingmouth "Oh. Um... then someone should probably tell you what happened."

ethan @confused "Sounds like you're going to tell me some bad news that wasn't affecting me before just now. Can I opt out?"

leaf @talkingmouth "[first_name] has a power that makes people and Pokémon like him. That's how all his Pokémon listen to him, and how he got so many... so many friends."
...
leaf closedbrow @talkingmouth "You're going to want to be sitting down for this."
...
ethanmind sad "Why...?"
ethanmind closedbrow frownmouth "Why didn't he just lie and tell everyone Cheren was crazy? It's not that hard. It's... {i}really{/i} easy, actually..."
ethanmind "It sounds like Cheren was willing to accept any lie he was told, if only [first_name] was willing to lie..."

hide blank2 with dis

leaf -angrysmilemouth -angrybrow frownmouth @talkingmouth "...so everyone lost track of him after the election. And no-one I've talked to has been able to find him since."

ethan @talking2mouth "Well, sorry to disappoint. He wasn't there when I went to bed last night."
ethan @closedbrow "Come to think of it, I don't think any of my roomies were, and I went to bed pretty close to curfew."

leaf @talkingmouth "...We were meant to go into the city today."
...
leaf @talkingmouth "You didn't think to, I dunno, call him and see if your plans were still on?"
...
leaf @talkingmouth "Great. Thanks."

pause 1.0

leaf @sadbrow talkingmouth "But, uh, where to, then?"

ethan @confused "Well, you said you were meant to meet up in the city, right? Maybe he's out there?"

leaf @talkingmouth "...Without me?"
...
leaf @talkingmouth "...Sure. I'm willing to try it."
...
leaf @angrybrow talkingmouth "...Hold on. You were asking me questions about Tia. Then you started asking me questions about [first_name]. Aren't you Cheren's roommate? Were you spying on [first_name] for him?"
...
leaf -surprised angrybrow angrysmilemouth "If {i}that{/i} was all you did, why are you looking so guilty? You've been asking me a bunch of questions about Tia and [first_name]. You were asking Ethan a bunch of questions, too, weren't you?"
...
leaf @talkingmouth "What did the video show?"
...
leaf @talkingmouth "Great, so now that the ship is sinking, you think you can just stuff a towel in the holes, and we'll forgive you?"
...
leaf @talkingmouth "What information did you want so desperately that you were willing to burn down Kobukan to get it?"

nate @talking2mouth "I can't tell you that."

leaf @talkingmouth "Why the hell not?"
...
leaf @closedbrow talkingmouth "Well, since you can't get a single piece of information from two idiots without ruining everything for everyone, and can't fight off a mystery 'dangerous Pokémon', excuse my disbelief, do you at least know where [first_name] is?"
...
leaf @talkingmouth "My name's Leaf, but yeah?"
...
blue -surprised sweat frownmouth @closedbrow talkingmouth "...Damn."

ethanmind frownmouth "'Frienergy'? Is that what... I have?"

leaf @talkingmouth "Well? How did you... {w=0.5}wait."

pause 0.5

leaf surprised "You already knew."
...
blue "You saw how [first_name] was at the Battle Team meeting on Friday! Mouthing off to Lance like that. 'Oh, I'm on the left side of the room!'"
blue "I {i}hate{/i} that dumb country boy schtick of his! We're from the same damn town, but he acts like he grew up riding Rhyhorn and milking Tauros!"

leaf -surprised flirtbrow frownmouth @sarcastic "Uh-huh."

blue "So, yeah, I was complaining to Cheren! And I told him that [first_name] gets anything he wants, and {i}everyone{/i} pays attention to him, just because of who he is!"
blue "That he's just had everything he ever wanted {i}handed{/i} to him!"

ethan @surprised "Wait, so...?"

blue @closedbrow "So Cheren asked if that seemed 'unusual' to me, like he had some sort of 'power!' And I said yeah, because what kind of idiot would think it was an {i}actual{/i} power?!"
...
leaf "Well, great job. You ruined his life again. You and Nate."

blue surprised "Nate? What did that egghead--"

pause 0.5 

blue -surprised frownmouth @closedbrow angrymouth "...The lab's security cameras. Damn it, Gramps."
...
leaf @talkingmouth "Think about it, Ethan. If those purple students wanted to see video footage from the research lab, then [first_name] must have been there. Probably talking to someone." 
leaf @talkingmouth "Who do we know who [first_name] is close to, who hangs out around the Research Center a lot?"

ethan @confused "Uh... that redhead with the right proper Ga'arian accent? What was her name, Sonia?"

leaf @closedbrow talkingmouth "God."
...
blue -surprised frownmouth angrybrow @angry "There wasn't a single goddamn second when I was a kid when I wasn't being {i}reminded{/i} that [first_name] had this 'special power' that made him {i}sooo{/i} much more important than me!"

pause 1.0

leaf sadbrow frownmouth "{w=0.5}.{w=0.5}.{w=0.5}."

leaf @talkingmouth "That... I mean, you're still an {i}enormous{/i} douchebag, but..."
...
leaf @talkingmouth "Do you at least know where [first_name] is?"

blue "No, but he's probably with his other Student Council nerd friends. I bet they're all decorating the student council room right now."

leaf @talkingmouth "Are you serious?"

blue @surprised "What?"

leaf @talkingmouth "You seriously think [first_name]--any of them--got elected? After Sabrina dropped her bombshell, there was a twenty-minute riot in the auditorium. {i}Lance{/i} had to step in to quiet everything."
...
blue @closedbrow "...I'm not used to something actually going {i}badly{/i} for [first_name]. Even with my screwup, I figured..."
...
lance @talkingmouth "I can assure you, Mr. Oak, that this went {i}very{/i} poorly for {i}everyone{/i} involved."
lance @closedbrow talkingmouth "A third of the school's student population was involved in that nonsense. The news, I imagine, has spread to the other two-thirds."
lance @angrybrow "And {i}someone{/i} is going to have to clean up your messes. The school has already incurred two significant legal actions as a result of that catastrophe."

pause 1.0

lance @talkingmouth "I might have known that the first major crisis this year would be because of you and [first_name], Blue."
...
leaf -surprised @talkingmouth "Advisor Lance."

lance @sadbrow talkingmouth "I cannot begin to describe how frustrated I am right now. Think {i}very{/i} carefully about whether what you are about to say needs to be said."

leaf @talkingmouth "Do you know where [first_name] is?"

lance @angry "{size=30}.{w=0.5}.{w=0.5}.{w=0.5}I give good advice, and the children just ignore it.{/size}"
lance @sadbrow talkingmouth "No, I do not. But, if he is intelligent, which there is not yet any evidence of, he'll make sure I do not know where he is for {i}at least{/i} one week."

leaf frownmouth @sad "Oh."

pause 1.0

lance @sadbrow talkingmouth "...But, if I were to hazard a guess as to who might know, I would point you in the direction of Professor Oak. He seems to have a close relationship with the boy."
lance @talkingmouth "I imagine he sees something of interest in young Mr. [last_name], though I can't imagine what. A fascinating gut flora, perhaps."

leaf @talkingmouth "Right. Thank you, advisor."
...
blue @closedbrow "I don't know. But sometimes I wish he hadn't. Now you can't get [first_name] to shut up."
...
leaf @talkingmouth "...We need to see your grandfather, then."
...
leaf @talkingmouth "Professor Oak."
...
leaf @talkingmouth "Wait!{w=0.5} It's about [first_name]."
...
leaf @talkingmouth "Please, Professor. Tell us everything."
...
leaf @talkingmouth "...Fine. What is [first_name]'s power?"
...
leaf @talkingmouth "So... it's not mind control?"
...
leaf "{w=0.5}.{w=0.5}.{w=0.5}."
leaf -frownmouth @talking2mouth "So... he wasn't mind controlling me? The reason I liked him so much is because... he, uh... wanted that?"
...
leaf @blush talking2mouth closedbrow "Knew it."

pause 1.0

leaf @talkingmouth "Alright, I'm happy. Ethan, you can ask your questions now."

ethan @surprised "Huh?"

oak @surprised "Er... you asked three."

leaf @talking2mouth "Sure, but you said we can both ask three."
...
leaf @talkingmouth "Yes."

oak @sad "Yes?"

leaf @talkingmouth "Well, if you insist. Ethan, go ahead."

ethan @talkingmouth "{size=30}Gaslighting an old man, nice. All you gotta do now is gatekeep and girlboss.{/size}"

leaf @angrybrow angrysmilemouth "{size=30}Are you going to complain, or ask your questions?{/size}"
...
drayden surprised "Oh."

stop music fadeout 10.0

pause 1.0

drayden -surprised sad "This is... exceedingly painful for me to tell you, then."
...
extend "{cps=20}{color=#ff0000}[first_name] [last_name] dropped out of Kobukan.{/color}{/cps}"
