...
sonia @talkingmouth "Extinct."

red @confusedeyebrows talkingmouth "Extinct?"

sonia @talkingmouth "That's right."
sonia @sadbrow talkingmouth "I'm sorry. I wish I could tell you more about it. But my specialties are Galarian myth-history, and astrobiology."
sonia @sadbrow happymouth "And, er, your Pikachu doesn't quite appear to be from Galar. Or space."
sonia @talkingmouth "They were a Unovan regional variant of Pikachu, though. It was called Pikachu's 'Liberation Form.' The first president of Unova famously had one."
...
oak @talking2mouth "My tests so far are coming up with simple conclusion."
...
red @thinking "Huh... I thought so. It looks too similar to a Pikachu to be a full evolution."
...
red @thinking "I guess he does look {i}kinda{/i} different outside of battle..."
...
sonia @talkingmouth "Or perhaps it transforms when it sees a real threat worth fighting, and then that form just stays?"
...
sonia -surprised @closedbrow talkingmouth "Yes. Their 'Crowned' forms were--"
...
oak -surprised @closedbrow talkingmouth "Hm... he seemed to react negatively when you mentioned the scientific classification of Zacian and Zamazenta's forms... perhaps that has some connection to this ability of his, whatever it might be."
...
red @thinking "Hey... Professor Oak?"
...
red @thinking "Hm. Do you know where Brock caught this Pikachu?"
...
red @closedbrow "Huh. I'll have to drop by and talk to him, then."
...
narrator "Inspecting the pile closer, it appears... that they are... teardrop-shaped gems?"
...
oak "Good lord! Emeras, my boy!"

oak "Quickly, we need to get them into a containment unit!"
...
sonia -surprised @talkingmouth "A type of gem."
sonia @talkingmouth "They're not usually seen in a solid form like that, though."
sonia @closedbrow talking2mouth "Most of the time, they're just a dusty powder."
sonia @talkingmouth "Emeras exist in a wholly unstable state--even attempts in laboratories to solidify their structure haven't managed to produce anything that stays stable for more than 10 minutes."
sonia @closedbrow talking2mouth "They can only coalesce in an environment saturated with Mysteriosity."

red @talkingmouth "Mysteriosity?"

sonia @closedbrow talking2mouth "A natural phenomenon that certain wild locations seem to exhibit. Woods, caves, oceans." 
sonia @talkingmouth "We don't know much about it, though. Anytime humans move into an area with Mysteriosity, the Mysteriosity fades in a matter of days."
...
sonia @talkingmouth "That's the sum of it. The Wishing Stars of Galar do a similar thing when taken too far from Eternatus, actually."
sonia @sadbrow talking2mouth "Of course... Eternatus is pretty big... so its effect is equal over the entire planet, largely."
...
sonia @thinking "...It sounds like you're saying 'forever old', though."
...
red @thinking "Um... should we get [pika_name] some tummy medication, then?"
...
redmind @sadbrow "So... the same deal as before, then?"
...
redmind @sadbrow "Oh, Sam..."

oak @closedbrow "For now, I might suggest that you take these Foreverals and take good care of them."
...
python:
    ...
    for i in range(0, len(added), 3):
        fvl1, fvl2, fvl3 = added[i:i+3]
        renpy.say(None, "Your bond with {} earned you the {}, {}, and {}!".format(lookupforeveraldata(fvl1, FVLMacros.FVLTrainer), fvl1, fvl2, fvl3))
...
queue music "audio/music/imminence.mp3" fadein 10.0
...
queue music "audio/music/viridianforestgentle.mp3"
...
if (numforeverals > 0):
    ...
    if (numforeverals > 20):
        $ ValueChange("Yellow", 10, 0.25, False)
        $ ValueChange("Yellow", numforeverals - 20, 0.5, False)
        $ ValueChange("Yellow", 10, 0.75)
    elif (numforeverals > 10):
        $ ValueChange("Yellow", 10, 0.33, False)
        $ ValueChange("Yellow", numforeverals - 10, 0.66)
    else:
        $ ValueChange("Yellow", numforeverals, 0.5)
