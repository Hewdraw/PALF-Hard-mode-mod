...
yellow -happy @happymouth "I sure am. I was doing a bunch of research last night on fish-type Pokémon anatomy, and I think I should be a lot better at healing them, now."
...
yellow fullblush @happymouth "Yes."
...
show yellow -fullblush surprised with dis:
    xalign 0.5
...
blue @angrybrow "So? Who {i}cares?{/i} You know I love a good argument."
...
yellow -surprised "Oh? We're going to the seaport? I thought we were going to the fields."
...
yellow fullblush "Oh. Um. Then-- then, um. {size=30}Oh, gosh, you're close.{/size} F-fifty wild Pokémon in a row?"
...
show yellow -surprised -fullblush
...
menu:
    "{b}>Go Exploring!{/b} Consecutive battles won: 49.":
        ...
        if (magikarpobj in playerparty):
            ...
            yellow @angrybrow talking2mouth "You're getting even better, Blue. I {i}know{/i} you'll beat [first_name] next time."
            ...
            $ PlaySound("pokemon/cries/129.wav")
...
whitney "Please, Flan, you've got to believe me! I {i}really{/i} see you as a friend, not just a project!"

flannery @talkingmouth "...I don't care."

whitney "N-no, c'mon, Flan, please! Yes, I want to help you with your--"

show flannery furious:
    ease 0.2 xpos 0.5

flannery "With {i}what?!{/i} With my {i}emotions?!{/i} With my {i}mood?!{/i} That's not something you can just {i}fix{/i}, Whitney!"
flannery "And if you're trying, then I don't see how you could {i}actually{/i} be my friend, if you're just looking at me like a... worse than a project, like a {i}patient!{/i}"

whitney "Flan, please, I--"
...
leaf @talkingmouth "...Aw. I'm sorry, sweetie."
...
leaf "Don't pretend, {i}even for a second{/i}, that you're handling this any better than the rest of us!"
...
leaf "Wait. You don't know?"

blue @surprised "What, we're playing 20 questions now? What is it?"

show leaf -surprised frownmouth angrybrow with dis

leaf @talkingmouth "So, you don't know."
...
oak "{i}Spectaculum pergere debet,{/i} students. The show must go on. You've all invested too much into this school--monetarily or otherwise--to let it all fall apart now."
oak "Now. If we are to continue our unit on so-called 'Mythical' Pokémon, it's important to remember that they, by their very nature, have not had their existence ever scientifically proven."
oak "This is counter to 'Legendary' Pokémon, who definitely exist, though our records of them may be thin and prone to embellishment."

pause 1.0

oak "Let's see... in Unova, the Pokémon 'Victini' is known to..."
...
leaf @talkingmouth "Psst. We've got dragon class fifth period, right?"

blue @surprised "Huh? Yeah, I think. Why, what's it to you?"

leaf @talkingmouth "You're a dick, but this is important, so I'll tell you then."

blue @closedbrow "Great, I've got {i}more{/i} of you flapping your gums to look forward to."
...
blue uniform frownmouth @closedbrow "...Here too, huh."
...
skyla "...Is, um... would it help to talk about it?"
...
calem @talking2mouth "{w=0.5}.{w=0.5}.{w=0.5}."

show skyla -surprised sadbrow frownmouth with dis
...
winona "Okay. Flying-type abilities can be separated into two distinct categories, usually."
winona "Those provided by lift, and those provided by levitation. Now, it's important to remember the difference between these, because... um... let me check my notes..."
...
play music "<from 10>audio/crowdargue.mp3" channel "crowd"
play music "audio/crowdargue2.mp3" channel "crowd2"
...
play music "audio/music/viridianforest.mp3"
...
yellow "You're trying to shout down Cheren before he even gets a chance to say anything!"
...
show cheren -surprised sad2eyes shadow noshine
show yellow sad 
with dis
...
cheren "--I will work as the Disciplinary Committee's--"

show gym with vpunch

"???" "Get out of here!"

cheren "--student liasion, to reduce pressure on--"

show gym with vpunch

"???" "We don't want you!"

cheren "--the student council, and the faculty."

bluemind @sad "Get {i}out{/i} of there, Yellow!"

cheren "My door is always open. Come to me with any complaints."
...
skyla frownmouth -surprised @surprised "Ah! Our first villain!"
...
extend " monumental,{w=0.5}{nw}"

show cheren noshine with dis

extend " colossal,{w=0.5}{nw}"

show cheren sad2eyes with dis

extend " tremendous,{w=0.5}{nw}"
...
flannery @talkingmouth "Yeah, we're not in the mood to argue."
...
flannery @closedbrow talkingmouth "I don't even know why I keep coming to this table."
...
flannery @talkingmouth "Yeah, I think I'll probably just go take a nap until lunch is over."
...
dawn surprised "You!{w=1.0} Wait, no, I meant n-nothing! I was just thinking 'don't say you', so I said it, but I meant to say 'nothing!' Not to imply you're nothing, though, I mean, you're really something, but not in a bad way, I just-- I mean--"
dawn sad "I'm sorry!"
...
leaf @talkingmouth "Figured it out, yet?"

blue @talkingmouth "Cut the crap. What were you going to tell me this morning?"

leaf @talkingmouth "You could say 'Please'."
...
leaf @talkingmouth "[first_name] dropped out of Kobukan."
...
leaf @talking2mouth "So you agree."

blue @surprised "Huh?"

leaf @talkingmouth "I was just thinking the same thing. Sure, he handed in his dropout paperwork, and sure, he's flown back to Pallet Town, but, y'know, that's not enough to actually {i}quit.{/i}"
...
clair -surprised @talking2mouth "I... I beg your pardon?"
...
leaf @talkingmouth "{size=30}Meet me in the garden after school. We're going to get [first_name] back.{/size}"
...
if (WonBattle("Blue1")):
    leaf @talkingmouth "{size=30}Your first battle. You lost, but only because you were using a brand-new Pokémon.{/size}"
else:
    $ bluewins += 1
    leaf @talkingmouth "{size=30}Your first battle. You won, but only because [first_name] was using a brand-new Pokémon.{/size}"

if (WonBattle("Blue2")):
    leaf @talkingmouth "{size=30}Your second battle. You lost, but only because [first_name] massively outnumbered your team.{/size}"
else:
    $ bluewins += 1
    leaf @talkingmouth "{size=30}Your second battle. You won, but only because [first_name] was massively underleveled compared to you.{/size}"

if (WonBattle("Blue3")):
    leaf @talkingmouth "{size=30}Your third battle. You lost, but only because the Battle Tryouts' ruleset totally cut into your level advantage.{/size}"
else:
    $ bluewins += 1
    leaf @talkingmouth "{size=30}Your third battle. You won, but only because [first_name] wasn't used to battling under a level equalizer.{/size}"

if (WonBattle("Blue4")):
    leaf @talkingmouth "{size=30}Finally, your most recent battle. You lost, but that's because I was there. So, obviously, you {i}never{/i} had a chance.{/size}"
    ...
    $ bluewins += 1
    leaf @talkingmouth "{size=30}Finally, your most recent battle. You won, but that's because [first_name] and I weren't totally in-sync, and our Pokémon got in each others' way.{/size}"
...
leaf "{size=30}I mean, just doing some math on the back of the napkin here, but it looks like your win record is...{/size}"

if (bluewins == 4):
    leaf @talkingmouth "{size=30}Four out of four. Not bad, right? But there isn't a single one-on-one battle where you're fighting each other on equal ground in there, is there?{/size}"
    ...
    leaf @talkingmouth "{size=30}Three out of four. Which, you know, good job. That's not bad at all. But there's always going to be that one less against you, won't there?{/size}"
    ...
    leaf @talkingmouth "{size=30}One more battle as equals, one-on-one? So you can finally prove you're better than him?{/size}"

elif (bluewins == 2):
    leaf @talkingmouth "{size=30}Two to two. You're tied. I mean, doesn't that just kinda {i}bite{/i} at you?{/size}"
    ...
    leaf @talkingmouth "{size=30}One to three. I mean, doesn't that just kinda {i}bite{/i} at you?{/size}"
    ...
    leaf @talkingmouth "{size=30}Don't you want just one more battle as equals, one-on-one? No gimmicks, no handicaps, nothing in your way? Just one more, so you can finally prove you're better than him?{/size}"
  
elif (bluewins == 0):
    leaf @talkingmouth "{size=30}Zero to four. I mean, doesn't that just kinda {i}bite{/i} at you?{/size}"
...
leaf sadbrow @talkingmouth "{size=30}No. I just think you deserve better than what you've gotten.{/size}"
...
leaf @talkingmouth "Hey, did you see Tia in our Dragon class?"

blue uniform @surprised "What? No. Why do you care?"

leaf @closedbrow talkingmouth "I figured that she might be able to help us get [first_name] back. If there's one person in this school more obsessed with him than you, it's Tia."
...
oak "Whoever's talking should {i}stop{/i}!"

blue @closedbrow frownmouth "Tch."

pause 1.0

oak "As everyone should remember, it's time to take your quiz. Please pull out your pens."
oak "As for what you should know... [bluecolor]The opponent Excadrill only knows Dig. The opponent Wailord only knows Dive. And the opponent Braviary only knows Fly.{/color}"
oak "[bluecolor]Additionally, each opponent will target the foe they can do the most damage to.{/color}"

pause 1.0

oak "Remember to look at your party before committing to any moves. Finally, remember that this is graded."
...
yellow -surprised @talkingmouth "Not this time."
...
yellow "{size=30}...Stop yelling at me...{/size}"
...
show tia neutral2 tired tears sadbrow frownmouth with gaussdissolve:
    xpos 0.4 xzoom -1
...
show tia -surprised frownmouth sadbrow with dis

yellow -surprised frownmouth @surprisedbrow talkingmouth "Oh."
...
leaf @talkingmouth "So, I've called him a bunch, but he's not answering. I'm pretty sure that he'll only come back if someone {i}goes there{/i} and gets him."

leaf @closedbrow talkingmouth "Yeah, so, here's the issue. [first_name] told me there was a student in this school named 'Skyla'."
...
leaf @talkingmouth "Right. Anyway, I asked her if she could, um, fly her plane over to Kanto."
...
leaf @talkingmouth "{w=0.5}.{w=0.5}.{w=0.5}.You're the one who showed up to the garden."
...
leaf @talkingmouth "Anyway, since Skyla's plane isn't an option, I was wondering if your Pidgeotto could fly you."
...
leaf -surprisedbrow @talkingmouth "I... I thought Pidgeotto could go at Mach 2?"
...
leaf sadbrow @talkingmouth "I'm... open to other ideas."
...
leaf @angrybrow talkingmouth "How do you know so much about planes?"
...
leaf @talkingmouth "You figured out how fast someone would have to go in order to get to Pallet Town and back."
...
leaf @closedbrow talkingmouth "Okay, wait, wait, we're not over yet. Dragonite. They can circle the globe in 16 hours, right? How about--"
...
leaf closedbrow @talkingmouth "Some... some kind of barrier?"
...
leaf @angrybrow talking2mouth "A Dragonite... with a barrier!"
...
lance @talkingmouth "Absolutely not."
...
leaf sadbrow @talkingmouth "Did you mean yes?"

lance @closedbrow talkingmouth "No."

leaf @closedbrow talkingmouth "{size=30}Damn, that normally works.{/size}"

blue @closedbrow talkingmouth "What the hell is happening here?"

lance @sadbrow talkingmouth "{size=30}Oh, joy, there's more.{/size}"

leaf @talkingmouth "Well... you said that no-one could ride on a Dragonite at its top speed without some sort of barrier."
leaf @surprisedbrow talkingmouth "And that reminded me that Advisor Lance has a Dragonite that {i}knows{/i} Barrier!"

lance @talkingmouth "I see you have been listening to my cousin's lectures. Good. She is an excellent teacher, and you would do well to listen to her."
lance @talkingmouth "In any case, you are correct. Dragonite cannot normally learn the Barrier technique." 
lance @closedbrow talkingmouth "However, I taught it the move after months of intensive training, learning from powerful Espers who have exiled themselves to the far reaches of Mount Silver, in order to train their skills."
lance @angrybrow talkingmouth "One can understand, then, why I would be reticent to allow my Dragonite to assist in the recapture of a truculent runaway."

leaf @surprised "Wait, you know what I was going to ask?"

lance @sadbrow talkingmouth "Your appalling taste in men has not escaped me, no."
lance @talkingmouth "It is quite obvious that you think my Dragonite, who can erect a psychic barrier around its rider to protect said rider from wind resistance, could be used to retrieve Mr. [last_name] from whatever hole he has crawled into."
lance @sadbrow talkingmouth "My answer to this request, as stated, is {i}no.{/i}"
...
lance @angrybrow talkingmouth "Your attempt to bait me is disrespectful--and, may I add, laughable."

show leaf surprisedbrow with dis

lance @closedbrow talkingmouth "My Dragonite, who I might add is {i}female{/i}, once flew from Kobukan to Cinnabar Island in a matter of hours."

leaf "{size=30}What?{/size}"
...
lance @talkingmouth "There is an immense amount I {i}could{/i} do. I see no reason to."

leaf @angry "Wait, but--you said-- you said that once [first_name] failed, you would finally respect him!"

lance @sadbrow talkingmouth "I believe I told you to leave the room for that conversation."

leaf @angry "I was by the door! But that doesn't matter--You made a promise!"

lance @talkingmouth "I made no such thing, and certainly not to you."
lance @sadbrow talkingmouth "What I {i}said{/i} was that I {i}may{/i} respect him."
lance @sadbrow talkingmouth "I didn't think it was necessary that I state failure alone was not a condition of my respect."
lance @talkingmouth "{i}Perseverance{/i} is. Failure, followed by another attempt at success."
lance @sadbrow talkingmouth "Given that, upon being faced with failure, his first recourse was to run home, it is clear he does not have the mental fortitude or wherewithal to succeed in this academy, so there is no reason to drag him back."

pause 1.0

show leaf angrybrow frownmouth with dis

lance @angrybrow talkingmouth "Exactly as I said."

pause 1.0

leaf @angrymouth "{cps=20}Why do you hate him so much?!{/cps}"

lance @closedbrow talkingmouth "Your characterization of my feelings towards him as 'hate' is incorrect."
lance @talkingmouth "I would have liked to see him succeed, as I would any student of Kobukan. But his personality is one that hinders itself, and I object to having my time wasted training a student who does not do their best."

leaf @talkingmouth "Why are you even a teacher?"

lance happymouth "{w=0.5}.{w=0.5}.{w=0.5}."
lance @closedbrow talkingmouth "For the pay, of course."

leaf @sarcastic "I don't believe that for a moment."

lance -happymouth @closedbrow talkingmouth "That's the first intelligent thing you've said since you walked in here."

pause 1.0

leaf @closedbrow talkingmouth "Wait. If... if we can somehow get another Dragonite... would you teach it Barrier?"

lance @angrybrow "{w=0.5}.{w=0.5}.{w=0.5}."

show leaf sadbrow with dis

lance @sadbrow talkingmouth "{i}If{/i} you could somehow get your hands on another Dragonite. Then, certainly, I would be willing to spend the {i}multiple weeks{/i} of dedicated training it would take to teach your Dragonite Barrier."

hide lance with dis

pause 1.0

leaf @talkingmouth "Blue? Can you... can you train my Dratini into a Dragonite?"

bluemind @frownmouth "No."

blue @talkingmouth "What level is it?"

leaf @talkingmouth "Sixteen..."
...
leaf @closedbrow talkingmouth "Okay, but what if we--"
...
show yellow surprised with vpunch

blue @angry "Not now, Yellow!"

show leaf surprised behind yellow:
...
stop music fadeout 0.5
queue music "audio/music/viridianforest.mp3"
...
show yellow sad:
    ease 0.5 ypos 1.0 zoom 1.0
show leaf -surprised frownmouth 
show tia -surprised frownmouth
with dis
...
leaf @talkingmouth "That's... that's great. Um, sorry, I don't think I've seen you before?"
...
leaf @talkingmouth "Well, Tia? What do you think you can do to help us?"
...
leaf "{size=30}What am I seeing? Should I be screaming?{/size}"

blue @surprisedbrow talkingmouth "No, really, {i}what?{/i}"

leaf "{size=30}I think I should be screaming, right? I should probably be screaming.{/size}"
...
leaf "{size=30}Okay, but, like, what... {i}is{/i} she? Is she a Pokémon?{/size}"

blue @talkingmouth "Why are you still whispering?"

leaf "{size=30}I don't know!{/size}"
...
leaf @talkingmouth "Wait, you can {i}speak Pokémon?{/i}"
...
leaf @talkingmouth "Okay, but, wait. You--Tia--you said that you thought you could help us get [first_name] back, right?"
...
yellow @closedbrow "No. She's just a special Pokémon that has never been caught."
...
leaf @talkingmouth "Tia, our Pokédexes aren't working on you, but you at least {i}look{/i} like some sort of dragon. Does this mean--does this mean {i}you{/i} can get to Pallet Town and back before the Quarter Qlashes?"
...
leaf @talkingmouth "Blue! Focus! Tia's how you can get to Pallet Town!"

blue @surprised "Me?"

leaf frownmouth @talkingmouth "Yeah. Of course! What, you didn't think I was going to ride on her back for, like, an entire day, did you? {i}Across an ocean?{/i}"
...
leaf -surprisedbrow @embarrassedbrow "Well... when you put it like that..."

latias sadeyes @talking2mouth "Tias... Latias..."

stop music fadeout 20
queue music "audio/music/lament.mp3"
...
leaf sadbrow @talkingmouth "Tia? Can you go by yourself?"
...
leaf @thinking "But..."
leaf @sadbrow talkingmouth "I... I can't. I can't go across an ocean. I just can't."

blue @surprised "What, can't you swim?"

leaf @angrybrow talkingmouth "I mean, yes, but that's not the point!"
...
leaf @surprisedbrow talkingmouth "That's not the point! I can't just... I mean, I... it's {i}an entire ocean!{/i}"
...
leaf @talkingmouth "Blue. Please. {i}Please{/i}. I need you to get [first_name]. I can't. I {i}c-can't.{/i}"
...
yellow "{i}We have... 20 hours to find a pilot.{/i}"
