...
leaf @talkingmouth "Mmmmorning."

red @happy "Not a morning person?"

leaf @talkingmouth "Bleh. Want some coffee?"
...
if ("Splashed" in persondex["Leaf"]["Events"]):
...
leaf @talkingmouth "Whatever. You have a plan for Dawn?"
...
leaf @talkingmouth "Well, that woke me up."
leaf -surprisedbrow @talkingmouth "You're friendly with Lance now, huh?"

red @thinking "I think he respected that I came back. {w=0.5}...Which I guess I have you to thank for."

leaf @talkingmouth "More like your Mom. You've called her to say how awesome she is, right?"

red @talkingmouth "Of course."

leaf @talkingmouth "Next time you talk to her, tell her that her Jigglypuff is a badass."

red @sweat happymouth "I might word it differently, but sure."

pause 2.0

leaf @talkingmouth "{i}Sip.{/i}"

pause 2.0

leaf @talkingmouth "Alright. You need to be at the Battle Hall by... ten, you said? Then let's do some quick studying or battling first. Everyone else is ready in the main room." 
leaf @talkingmouth "This'll probably be the last chance you have to upgrade your team before you have to face Dawn."
...
ethan @talkingmouth "This might be the last time we see you before your battle with Dawn, if Lance keeps you for a while."
...
lance @talkingmouth "You're here on time."

red @talkingmouth "This seemed pretty important to talk about."

lance -closedbrow "{w=0.5}.{w=0.5}.{w=0.5}."

lance @talkingmouth "I do not understand why you sometimes seem able to speak. And why sometimes you cannot."

pause 1.0

lance @talkingmouth "When I berated you the first time, I saw that same frozen fear in your eyes as I did yesterday. But now you speak as though we are 'chums.'"
...
lance @sad2eyes talkingmouth "It's of no consequence."

pause 1.0

lance @talkingmouth "Rather, we are here to talk about how we could squeeze the slightest amount of victory out of your regrettable circumstance."
lance @sad2eyes sadeyebrows talkingmouth "It was a mistake on Janine's part not to sign you all up in separate districts, but... as advisor... it was my mistake to not remind her to."
lance @closedbrow talkingmouth "Foolishness on my part. I was distracted by my grudge against you."

pause 1.0

red @confused "Yeah... what's that about?"

lance @shadow angrybrow talkingmouth "I have {i}told{/i} you. You exist here through the kindness of others and luck. And you fritter this opportunity away through self-sabotage."

red @talking2mouth "You mean [pika_name]."

lance @talkingmouth "I do."

pause 1.0

lance @talkingmouth "When you were gone, Ms. Green asked me for the usage of my Dragonite. She wished to use it to retrieve you."
lance @sad2eyes talkingmouth "I denied her, obviously. I believed that your self-pity would not permit you to come back, even if someone made the effort to reach out."
lance @closedbrow talkingmouth "However, given the infinitesimal amount of respect I have for you, the significantly greater amount of respect I have for her, and the immense amount of respect I have for Janine, I have a proposal."

red @happy "Oh, that's great! Who's the lucky woman?"

pause 1.0

lance @confusedeyebrows playfuleyes talkingmouth "Do you think you're {i}charming,{/i} child?"

red @closedbrow talkingmouth "Sometimes."

lance @talkingmouth "Enough nonsense. As I denied Leaf the usage of my Dragonite before, I am willing to loan a different one to you, for the purpose of this one battle."

pause 1.0

red @surprised "What?"

lance @talkingmouth "I have talked with Dawn. I do not agree with Janine's insistence that she {i}not{/i} drop out, but as Janine is Captain, that is her call to make."
lance @closedbrow talkingmouth "The only way we preserve the Battle Team's reputation, then, is if you beat Dawn fairly, and she retires from the Battle Team before the final blow is dealt."

pause 1.0

lance @closedbrow talkingmouth "This, she has agreed to do."

red @sadbrow talkingmouth "That doesn't seem... fair."

lance @sad2eyes "All that matters is the {i}letter{/i} of the law. This is the ideal outcome for everyone. Most importantly, Janine."

red @angrybrow talking2mouth "Janine doesn't {i}want{/i} Dawn to drop out."

lance @angrybrow talkingmouth "Janine doesn't want to {i}have to ask Dawn{/i} to drop out."
...
lance @angrybrow "For as much as you sabotage yourself, she has sabotaged herself even harder by recruiting {i}you{/i}!"
...
lance @shadow sad2eyes talkingmouth "Shut up, rat."

red @shadow angrybrow talking2mouth "So that's how it is."

lance @talkingmouth "This drama is unnecessary. I am not asking for your opinion on this solution. I am telling you to take it."

pause 1.0

lance @talkingmouth "You will take my Dragonite. You will agree with Dawn to fight a one-on-one battle. You will use my Tera Orb to Terastalize my Dragonite into a Normal Type." 
lance @talkingmouth "You will command her to use Extreme Speed. Dawn's Altaria will faint. Dawn will deny ever being part of the Battle Team."
lance @closedbrow talkingmouth "And everyone will come out of this situation with the minimal amount of damage."

redmind @closedbrow frownmouth "This sounds... like a plan that is {i}likely{/i} to be successful. But..."

lance @talkingmouth "I have already talked with Dawn. She will agree to the one-on-one. She also knows that it is her role to lose. There will be no difficulty here."

pause 1.0

lance @shadow angrybrow talkingmouth "What's taking you so long? I am {i}giving{/i} you your victory. Once again, another is pulling you out of the fire. This {i}cannot{/i} be an unusual circumstance for you."
...
menu:
    ">Follow Lance's plan.":
        lance @sad2eyes talkingmouth "Thank you for showing a modicum of sense."
        lance @angrybrow talkingmouth "There is one condition for the use of my Dragonite, however."
        lance @talkingmouth "You will leave your Pikachu with me."

        red @surprised "What?"

        lance @talkingmouth "I do not trust that you will not attempt to sneak your Pikachu into your team in some way or another. Only when I have it on my belt can I be certain you will follow the plan."

        red @angry "You want a {i}hostage.{/i}"

        lance @angrybrow talkingmouth "I want {i}certainty.{/i}"
        ...
        menu:
            ">Follow Lance's plan.":
                ...
                lance @talking2mouth "Well done. Perhaps we'll make a champion out of you, after all."

                red @angrybrow talking2mouth "Your Dragonite?"

                lance -happymouth -playfuleyes @closedbrow talkingmouth "Yes, yes. Don't be impatient."
                ...
                if (lancedragonite1obj.Item != "Heavy-Duty Boots"):
                ...
                lance @talkingmouth "With this one action, your victory has been guaranteed. As has the preservation of Janine's reputation."

                pause 2.0

                lance sad2eyes talkingmouth "Therefore, we have no reason to remain here. I take my leave of you."
    ...
    ">Reject Lance's plan.":
        ...
        label rejectlance:
            ...
            lance @talkingmouth "You, {w=0.5}stupid, {w=0.5}stupid, {i}child.{/i}"

            pause 2.0

            red @confused "That seemed uncalled for."

            lance @talkingmouth "This is selfishness. Selfishness and pride."

            pause 1.0

            lance @talkingmouth "Damn you."

            hide lance with dis

            narrator "You stand alone in the battle hall for while."
...
show oak surprised with vpunch
...
show oak -closedbrow sadbrow with dis
...
red @sad2eyes "Leaf... actually came and got me on Tuesday. I just got back on Wednesday, two days ago."
...
narrator "...But Old Man Oak has never been a good liar."
...
if (not lanceplan):
    ...
    oak @sadbrow "[first_name]. Please. You must--"
...
if (lanceplan):
    ...
    redmind @sadbrow "Sorry, Leaf, Tia, Blue, Ethan, Yellow... I know you tried really hard to get me back here on time."
...
if (lanceplan):
    ...
    python:
        ...
        trainer1 = Trainer("red", TrainerType.Ally, [lancedragonite1obj])
        trainer2 = Trainer("dawn", TrainerType.Enemy, dawnparty)

    call Battle([trainer1, trainer2], gainexp=False, specialmusic="Audio/Music/legendary.mp3", dialogfunc=dawndragonitedialog, custombrain=dawndragonitebrain) from _call_Battle_116
    $ gymbattles["Dawn1"] = _return
    ...
    dawn @sadbrow "Um... if you want it to be a bit more equal, you can use two Pokémon at once... I think, technically, you have to, actually..."
    ...
    if (GetRelationshipRank("Dawn") == 1):
        ...
        dawn @sadbrow "I... I don't think you were mind-controlling anyone anymore."
    ...
    call Battle([trainer1, trainer2], gainexp=False, specialmusic="Audio/Music/legendary.mp3", dialogfunc=dawnpikachudialog, custombrain=dawnpikachubrain) from _call_Battle_117
    $ gymbattles["Dawn1"] = _return
    $ dawnbattle = False
...
redmind @angrybrow "But I'm a nobody who just beat a girl who battled {i}Cynthia.{/i}"
...
lisia closedbrow frownmouth "Hmm..."
...
calem surprised "Er? Obvious I'm a professor?"
...
calem "{size=30}I'm... I'm eighteen...{/size}"
...
janine @talkingmouth "I'll clean up the body."

pause 2.0

dawn -surprised sadbrow frownmouth @sad "Oh... J-Janine... sorry, I f-forgot about the Battle Team... um... I'm sorry, I should have asked you, and... I can change my mind... I know I'm not allowed to leave... and I'm sorry about ruining the Battle Team's reputation..."

janine @talkingmouth "...Dawn. You shouldn't apologize."

pause 1.0

janine @sadbrow talkingmouth "...I should apologize."

dawn @surprised "Wh-- no, no, you totally shouldn't! You didn't do anything wrong!"

janine @sadbrow talkingmouth "I put you in this situation by forcing you into the Battle Team. And then I put you in {i}this{/i} situation by being too cocky."

pause 1.0

janine @closedbrow talkingmouth "I want to say I planned this whole thing so you'd learn how to resist when people try to push you into things, but... no. It was just a couple of dumb mistakes."
janine @talkingmouth "I'm sorry."
...
janine @talkingmouth "You have no idea what just happened?"

red @talkingmouth "Nope."

janine @closedbrow talkingmouth "When you do, tell me. For now..."
...
janine @closedbrow talkingmouth "You know what to do."

if (GetRelationship("Janine") == "Good Boy"):
    pause 1.0

    janine @talkingmouth "You're brave. Use that bravery."

else:
    janine @talkingmouth "Tell the truth."
