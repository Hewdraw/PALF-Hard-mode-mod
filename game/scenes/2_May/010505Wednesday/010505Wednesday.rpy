...
python:
    renpy.music.queue("Audio/music/runawayfugitives.mp3", channel='music', loop=True, fadein=1.0)

    playercharacter = "Ethan"

    money = oldmoney - 1

    ethanparty = [Pokemon("Pichu", level=max(1, mon.Level - 1), ivs=[1, 1, 1, 1, 1, 1], evs=[0, 0, 0, 0, 0, 0], gender=Genders.Female, ability="Small World", nature=Natures.Lonely)]
    for mon in oldparty:
    ...
    persondex[first_name] = {"Named" : True, "Value" : oldpersondex["Ethan"]["Value"] * 3, "Contact": False, "ClassesKnown": ["All"], "Sex": Genders.Male, "Relationship": "Wannabe", "RelationshipRank": 0, "Events": [] }
    persondex["Professor Cherry"] = {"Named" : True, "Value" : 247, "Contact": False, "ClassesKnown": ["Homeroom"], "Sex": Genders.Female, "Relationship": "Student", "RelationshipRank": 0, "Events": [] }
...
ethan @closedbrow "Oh, nothing important."
...
if (mayhaslarvesta):
    ...
    brendan @closedbrow talkingmouth "Man, I dunno about his freaky powers or anything like that. Maybe they're real, maybe they're not. But I know for a fact that he's a good dude. Of course I'd want him back."

else:
    brendan @talkingmouth "...He seemed like a nice dude, but I just can't get over that time he took that Larvesta egg. It's my fault for not bein' strong enough to stop him, I guess, but..."
...
brendan @sadbrow talkingmouth "Damn. I didn't know how to say this, but... I was also planning on leaving the dorm, guys."

calem surprised "Hm?"

brendan @talkingmouth "Yeah, uh, I really think I should spend more time with May. She's been pretty broken up about... a couple things... ever since the election, and she needs me."
...
hilbert @sad "You... you all dragged me into your lives. I... don't want to be a part of them. You don't want me to be a part of them. Just focus on graduating on time. Live your small dreams."
...
ethan @thinking "Oh, you think there might be some tough Pokémon there, huh?"
...
ethan @closedbrow "Alright. Classes are on pause for the Quarter Qlashes, so... I guess I might as well start now. It'll be a long walk."
...
queue music "audio/music/palletpiano.mp3"
...
python:
    ...
    persondex = copy.deepcopy(defaultpersondex)
    persondex[first_name] = {"Named" : True, "Value" : oldpersondex["Blue"]["Value"], "Contact": False, "ClassesKnown": knownclasses, "Sex": Genders.Male, "Relationship": ("Rival" if oldpersondex["Blue"]["RelationshipRank"] == 0 else "Talker"), "RelationshipRank": 0, "Events": [] }
    persondex["Gramps"] = {"Named" : True, "Value" : 82, "Contact": True, "ClassesKnown": ["Homeroom"], "Sex": Genders.Male, "Relationship": "Grandson", "RelationshipRank": 0, "Events": [] }
    persondex["Leaf"] = {"Named" : True, "Value" : 7, "Contact": True, "ClassesKnown": ["Dragon"], "Sex": Genders.Female, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    persondex["Sonia"] = {"Named" : True, "Value" : 4, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Female, "Relationship": "Underclassman", "RelationshipRank": 0, "Events": [] }
    persondex["Hilbert"] = {"Named" : True, "Value" : 9, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Male, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    persondex["Silver"] = {"Named" : True, "Value" : 14, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Male, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    persondex["Bea"] = {"Named" : True, "Value" : 23, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Female, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    persondex["Erika"] = {"Named" : True, "Value" : 4, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Female, "Relationship": "Enemy", "RelationshipRank": 0, "Events": [] }
    persondex["Janine"] = {"Named" : True, "Value" : 31, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Female, "Relationship": "Mentee", "RelationshipRank": 0, "Events": [] }
    persondex["Nate"] = {"Named" : True, "Value" : 58, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Male, "Relationship": "Dormmate", "RelationshipRank": 0, "Events": [] }
    persondex["Cheren"] = {"Named" : True, "Value" : 1, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Male, "Relationship": "Dormmate", "RelationshipRank": 0, "Events": [] }
    persondex["Ethan"] = {"Named" : True, "Value" : 1, "Contact": True, "ClassesKnown": knownclasses, "Sex": Genders.Male, "Relationship": "He's there?", "RelationshipRank": 0, "Events": [] }
    persondex["Yellow"] = {"Named" : True, "Value" : 12, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Female, "Relationship": "Partner", "RelationshipRank": 0, "Events": [] }
    persondex["Dawn"] = {"Named" : True, "Value" : 5, "Contact": True, "ClassesKnown": ["Dragon"], "Sex": Genders.Female, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    persondex["Instructor Winona"] = {"Named" : True, "Value" : 0, "Contact": True, "ClassesKnown": ["Flying"], "Sex": Genders.Female, "Relationship": "Student", "RelationshipRank": 0, "Events": [] }
    ...
    persondex["Skyla"] = {"Named" : True, "Value" : 2, "Contact": True, "ClassesKnown": ["Flying"], "Sex": Genders.Male, "Relationship": "Antihero", "RelationshipRank": 0, "Events": [] }
    persondex["Misty"] = {"Named" : True, "Value" : 2, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Male, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    persondex["Flannery"] = {"Named" : True, "Value" : 4, "Contact": True, "ClassesKnown": ["None"], "Sex": Genders.Male, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    persondex["Tia"] = {"Named" : True, "Value" : 9, "Contact": True, "ClassesKnown": ["Dragon"], "Sex": Genders.Male, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    ...
    persondex["Calem"] = {"Named" : True, "Value" : 7, "Contact": True, "ClassesKnown": ["Flying"], "Sex": Genders.Male, "Relationship": "Rival", "RelationshipRank": 0, "Events": [] }
    ...
    blueeeveeobj.Item = "Soothe Bell"
    bluemagikarpobj.Item = "Experience Share"
...
yellow @thinking "Hm... I don't know."
...
if ("RejectedConfession" in oldpersondex["Leaf"]["Events"]):
    ...
    leaf @flirt "We {i}definitely were{/i} in the dream I was having."
...
leaf @talkingmouth "Huh. That makes two people I know who can speak Pokémon."

red @confused "Two? Who's the second?"

leaf @talkingmouth "Really? She's Blue's friend, so I figured you'd know her."

red @confused "I'm just baffled that [blue_name] has friends."

leaf @talkingmouth "...You know, he's not {i}that{/i} bad."
...
leaf @talkingmouth "Whatever. Anyway, his friend's name is Yellow."
...
leaf @talkingmouth "It's fine, my Dad used to sing this song all the time when we went boating!"
...
ethan @shadow closedbrow frownmouth "...Geez."
...
$ PlaySound("pokemon/cries/38.wav")
...
$ renpy.music.queue("Audio/Music/RivalChill.mp3", channel='music', loop=True, tight=None)
...
lace "Hm... hello, young man. You must be a student here. Is the Battle Hall this way?"
...
lace "Oh! Well then, thank you very--"

blue @angry "And you ain't gettin' it!"
...
mace "Good day, my fellow Student! I hope--"
...
blue "It's fine. I know you don't like battling. I got this."
...
bluemind @angrybrow "But, for the first time in my life, I'm {i}not{/i} outmatched."

show yellow surprised -blush with dis

blue @happy "Ha.{w=0.5} Haha.{w=0.5} Hahaha!{w=0.5} Hahahahaha!{w=0.5} Ahahahahaha!"

yellow "B-blue? What happened?"
...
leaf @sadbrow talkingmouth "Hey... sweetheart? Not that this isn't {i}really{/i} fun, but... can I stop now? {size=30}Please?{/size}"

latias @angrybrow poutmouth "Titita!"

leaf @sadbrow "Oh... okay..."
...
leaf @talkingmouth "Yeah, but it's not legal, is it?"
...
leaf @sadbrow talkingmouth "Do you mind if... if we don't talk about it while we're flying over the ocean?"

red @surprised "Oh, yeah, of course! My bad."

leaf @blush sadbrow talking2mouth "Thanks."
...
leaf @closedbrow "Oh, right, you're terrible at geography... Argent Mountain is the mountain right near Kobukan!"
...
leaf @talkingmouth "Oh... oh, crap."

red @surprised "What?"

leaf @sadbrow talkingmouth "It's noon. It's all up to Blue, now."

red @sad2eyes talking2mouth "Great."

pause 1.0

leaf @talkingmouth closedbrow "You could try to be nicer to him."
...
leaf @embarrassed "Ah... let's not say the 'f-word', please."
...
stop music fadeout 1.5
queue music "audio/arctic.mp3" loop channel "crowd"
...
ethan @closedbrow "It's probably just a folktale... but I'm not going to risk it."
...
"Hapless Officeworker" "\"This guy's crazy!\""

"Irritated Man" "\"Move out of the way, dude! I'm going to be late for my match!\""

"Confused Student" "\"But if we can't even beat him all together, do we even have a chance in the Quarter Qlashes...?\""
...
yellow surprised "{size=30}Blue! Don't provoke her!{/size}"
...
dawn "You want to know why I'm part of the Battle Team? I'll show you!"
...
stop music fadeout 1.5
$ renpy.music.queue("Audio/Music/legendary.mp3", channel='music', loop=True, tight=None)
...
yellow @closedbrow talkingmouth "Heal."

dawn surprised "Huh?"

blue sad "Huh?"

yellow @closedbrow talkingmouth "...You have another shot."
...
yellow @sadbrow talkingmouth "Heal."
...
yellow sad "Heal... {size=30}Blue, I'm... I'm getting really tired...{/size}"
...
yellow @sad "{size=30}H-heal...{/size}"
...
dawn -surprised frownmouth @sad "Wait. He... he just left...?"

"Hapless Officeworker" "\"Thanks, Miss! You got that guy out of our way!\""

"Irritated Man" "\"Thank goodness! I was going to be late for my match!\""

"Confused Student" "\"Good job, Dawn! I didn't realize you were such a good battler!\""
...
stop music fadeout 1.5
$ renpy.music.queue("Audio/Music/Dreams and Adventures.mp3", channel='music', loop=True, tight=None)
...
leaf @talkingmouth "Blue, did the Disciplinary Committee hassle you?"

blue @talkingmouth "Nope. Guess Ethan succeeded."

leaf @closedbrow talkingmouth "When we were flying over the grounds, we saw a small blizzard near Pledge Hall."
...
yellow surprised "Hm? You don't recognize me?"
...
lance @confusedeyebrows talkingmouth "What?"
...
lance -anger -shadow @closedbrow talkingmouth "...How long will that chain remain unbroken, I wonder?"

drayden @angry "Watch yourself, Lance."

lance @closedbrow talkingmouth "I am not blind to the dissatisfaction of the board. Though they are vulturous opportunists, I happen to agree with this particular complaint."
lance @talkingmouth "You have too much faith in the students. The fiasco last Saturday was because you believed the children to be capable of self-governance."
lance @angrybrow talkingmouth "I fail to see how what is happening {i}right now{/i} is any different."

drayden @sadbrow "I know you do, Lance.{w=0.5} I {i}know{/i} you do."

pause 1.0

lance @confusedeyebrows talkingmouth "What is that noise...?"

show drayden surprised:
    ease 0.5 xpos 0.1
...
leaf -surprised @happy blush "Hey! Are we late?"
...
drayden -surprised @happybrow "No, it would appear that you are perfectly on-time."
...
lance @closedbrow talkingmouth "Yes. I was the one who convinced Dean Drayden, after a good amount of debate, of the importance of letting Sonia back in."
lance @sad2eyes talkingmouth "The irony of my own argument being used to let {i}you{/i} back in is not lost on me."

leaf @angry "Hey! What's up with this? You said that if [first_name] came back, you'd respect him!"

lance @angrybrow shadow talkingmouth "You may notice I am not investigating too closely why the beginning of the Quarter Qlashes has been delayed {i}two whole hours.{/i}"
lance @sad2eyes talkingmouth "You may interpret my reasoning for that however you wish."
...
lance closedbrow talkingmouth "Tch. I take my leave of this."
...
leaf @talkingmouth "I'm going to go change. I've been wearing this uniform for, like, twenty-four hours straight, and it is starting to {i}stank.{/i}"
...
blue @closedbrow "Yeah, here you go."

narrator "Blue passes Leaf a Poké Ball."

$ blueparty.remove(leafdratiniobj)
$ leafparty.append(leafdratiniobj)

if (leafdratiniobj.Gender == Genders.Female):
...
oldman @angrybrow "Mrrgrr... just my luck!"
oldman @happybrow happymouth "Oh, well! I figured I'd get smacked down by some whippersnapper sooner or later."
oldman @sadbrow "Still, coming here all the way from Viridian, just to be eliminated in the opening round of battles..."
...
lisia "{size=30}No, Io, this won't work! You {i}promised{/i} we'd co-host! My crew delayed for as long as we could, but the event's about to begin, and if you're still not here, then--!{/size}"
...
oldman @sadbrow "Eh-heh-heh. She's always like this before a show. But the moment the spotlight shines, it's all class and control with her."

$ BecomeNamed("Lisia")

oldman @surprisedbrow "Now, ain't you happy to learn a bit of celebrity gossip about {i}the{/i} Lisia?"
...
oldman @surprisedbrow "Eh? Don'tcha watch {i}any{/i} TV, young man? She's the Contest Champion!"

red @talkingmouth "Oh. Of Kobukan?"

oldman @sadbrow "No, young man! Of the world! She's the niece of Wallace, the previous Contest Champion!"
...
oldman @surprisedbrow "So cavalier..."
...
show janine surprised at leftside with vpunch
...
janine closedbrow @talkingmouth "I thought that you were... gone."
...
janine -closedbrow @talkingmouth "No. I'm just... processing. I had to change a bunch of plans based on your leaving the team, and I'd just gotten used to the new paradigm."
janine @closedbrow talkingmouth "So now I need to figure out if I can just seamlessly revert to the previous plan."
...
janine @closedbrow talkingmouth "I figured you were our best shot at placing in the national tournament."
janine @sadbrow talkingmouth "When you left, I signed myself up."
...
janine @talkingmouth "Just a coincidence, though. It's random. At least, it's meant to be."

red @talkingmouth "Damn. I guess that means you'll be beating me in a Quarter Qlash somewhere down the road, then?"

janine @closedbrow talkingmouth "...Maybe."

pause 1.0

red @sadbrow talkingmouth "Um... I {i}just{/i} got back here... how's the school?"

janine @sadbrow talkingmouth "I'll be real--things have been better."
janine @talkingmouth "A lot of people are still mad at you. But most people are too wrapped up in their own secrets being exposed."
janine @sadbrow talkingmouth "Still, you shouldn't expect to be winning any popularity contests any time soon."

red @sweat talkingmouth "Damn."

janine @talkingmouth "...I still have your back, though."

red @surprised "Huh?"

janine @closedbrow talkingmouth "It was a dumb move, to try and keep this power of yours secret. Obviously, it made you look suspicious as hell."
...
janine @talkingmouth "Just out of curiosity, though, {i}do{/i} you have mind control powers?"
...
if (GetRelationshipRank("Janine") == 1 and janinedomming):
    ...
    janine @closedbrow "Anyway, that's actually a bit disappointing."

else:
    janine @closedbrow "That's actually a bit disappointing."

janine @talkingmouth "If you {i}did{/i} have those powers, I bet they would help you out in your battles a bunch."
...
red @sadbrow "Well... I'll still do my best."
...
janine @sadbrow talkingmouth "You should focus on talking to the other team members. A lot of them are on the fence about you--they're not sure what to think." 
janine @closedbrow talkingmouth "They've had enough time to calm down, but they're still in a position where they can be easily swayed one way or the other."

pause 1.0

janine @closedbrow talkingmouth "Winning your battles would be a good start, but after that, you'll need to give a hell of a speech. We're having an emergency meeting tomorrow to discuss... well, everything. Have it ready by then."
...
janine @sadbrow "Good. I don't want to think that making the Battle Team smaller--more personal--was a mistake, even if it means we're more easily sidetracked by stuff like this, so prove to me that wasn't a poor decision."
...
lance @talkingmouth "[last_name]. I would have a word with you."

red @sweat closedbrow talking2mouth "I'm about to go have my first battle..."

lance @sad2eyes talkingmouth "This will take only a minute."
lance @closedbrow talkingmouth "Besides which, as I am the regional Champion of two regions, I would hope my position affords me at least a couple minutes of delay, coming off the three hour delay we've already endured."
lance @sad2eyes talkingmouth "God knows it conveys no other benefits."

red @talking2mouth "...Right."

lance @talkingmouth "I see you have tasted defeat. And you have come back to try again, in spite of it."

red @sadbrow talking2mouth "...Yeah."

lance @closedeyes talkingmouth "The drama of running away from the school, then coming back at the last possible minute, notwithstanding, it appears I may have misjudged you."

red @angrybrow frownmouth "{w=0.5}.{w=0.5}.{w=0.5}."

lance @talkingmouth "So I offer this advice with the full sincerity of a person in my position, attempting to do well."
lance @angrybrow shadow talkingmouth "{color=#ff0000}Some defeats you cannot come back from.{/color}"

red @talking2mouth "Huh?"

lance @talkingmouth "There will be consequences for failure from now on, [last_name]. Once defeat has its claws in you, every fresh defeat draws more blood."
lance @sad2eyes sadeyebrows talkingmouth "...Every battle you have had up to this point has been one that can be won, or lost, with little effect on your sheltered life."
lance @talkingmouth "But make no mistake, if you fail to win this first round of the Quarter Qlashes..."
lance @angrybrow shadow talkingmouth "No matter how much shame you may have felt before, it will {i}pale{/i} in comparison to the infamy of being the first Battle Team member to lose in the first round." 

red @closedbrow sweat talkingmouth "This sincere advice sounds a lot like a threat."

lance @closedbrow talkingmouth "Take it as you will. Now, I--"
...
lance shadow sad2eyes angryeyebrows talkingmouth "I was going to say 'I must go.'"
...
show lisia surprised with dis

janine @talkingmouth "Technically. I'm the Captain of the Battle Team."
...
lisia "That's amazing! She {i}really is{/i} #1, folks!"

janine -surprisedbrow @sadbrow blush talkingmouth "Yeah. It's not... that big a deal..."

redmind @confusedeyebrows "Huh. Janine actually looks a tiny bit sheepish in front of all these people."
...
python:
    trainer1 = MakeRed()
    trainer2 = Trainer("oldman", TrainerType.Enemy, [Pokemon("Milotic", level=7, moves=[GetMove("Water Pulse"), GetMove("Disarming Voice"), GetMove("Twister"), GetMove("Water Gun")], ivs=[31, 31, 31, 31, 31, 31], nature=Natures.Modest, gender=Genders.Female), Pokemon("Kakuna", level=7, moves=[GetMove("Poison Sting"), GetMove("Harden")], ivs=[24, 24, 24, 24, 24, 24])], number=2)

call Battle([trainer1, trainer2], customexpressions=["red", "red angrybrow happymouth", "oldman milotic", "oldman angrybrow happymouth milotic"], specialmusic=("audio/music/swordshieldgym-intro.mp3", "audio/music/swordshieldgym-loop.mp3"), dialogfunc=oldmandialog) from _call_Battle_113 
$ gymbattles["OldMan1"] = _return
...
janine @angrybrow talkingmouth "What, like those girls who wear skirts and dance with their Pokémon?"

red @talking2mouth "Apparently, there's actually a lot more to it than that. You don't have to be a girl, for one."

janine @closedbrow talkingmouth "Weird. I don't get why anyone would want to be a coordinator when you could just battle, but I guess it's just not for me."
...
janine @talkingmouth "Go talk to your friends."

red @surprised "Huh?"

janine @closedbrow talkingmouth "Classes are out for the rest of the week, because of the Quarter Qlashes. So this is the perfect opportunity to talk to some of the people who were hurt last Saturday, and patch things over with them."

red @talkingmouth "...I'm surprised you care about... well, my friends."

janine @surprisedbrow "Really?"

pause 1.0

janine @sadbrow "That... actually makes me a bit sad. I'm not heartless, you know. I mean, sure, I'm strict, but I've always said that working together is the best way to succeed as a team..."
...
janine @closedbrow talkingmouth "...Okay, I see where you're coming from."
...
janine @closedbrow talkingmouth "Anyway, go on. I'll keep an eye on the next battles in the first round, in case I see anything interesting."
...
janine @talkingmouth "I--{w=0.5} I don't--"

pause 1.0

janine @closedbrow talkingmouth "I don't... 'believe in' people. I don't 'have faith.' I look at the evidence, and figure out from that if they're a person worth having in my team."
janine @sadbrow talkingmouth "...Not everyone does that. A lot of people who {i}do{/i} 'believe in' others are going to be really hurt by this. And they'll take that out on you. So..."

pause 1.0

janine closedbrow @talkingmouth "Harden your heart, [first_name]."
...
janine @sadbrow talkingmouth "Mmm..."

scene blank2 with splitfade

pause 2.0

scene academyold with splitfade
...
python:
    ...
    persondex["Leaf"]["Mood"] = (10 if "AcceptedConfession" in persondex["Leaf"]["Events"] else 5)
    ...
    persondex["Gardenia"]["Mood"] = (0 if investment > 0 else 5)
...
if (investment > 0):
    ...
    show gardenia surprised with dis
    ...
    gardenia @happy "Oh, by the way, here's your dividends. I was saving 'em for you."

    $ investmentbulk = math.floor(investment * 0.05 * 3)
    ...
    $ persondex["Gardenia"]["Events"].append("Makeup")
...
if (_return == "Outside"):
    ...
    if (makeupbaseballfield):
        ...
        stop music fadeout 1.5
        $ renpy.music.queue("Audio/Music/goldenrod.mp3", channel='music', loop=True, tight=None)
        ...
        flannery @talkingmouth "I'm sorry I was a bit of a bitch."

        whitney @talkingmouth "I'm sorry I was even bitchier."
        whitney @sad "But I promise I didn't {i}really{/i} think of you as a project, okay? It's... it was a defense mechanism."

        flannery @talkingmouth "A defense mechanism?"

        whitney @talkingmouth "Look... I like you. And, you know, I'm a lesbian..."

        flannery @talkingmouth "I'm not gay, Whit."
        ...
        whitney @sadbrow talkingmouth "So if I thought of you as someone I was helping {i}as well as a friend{/i}... instead of {i}just{/i} a friend... I could live with that."
        whitney @closedbrow talkingmouth "Besides, it wouldn't be right. I'm trying to help you with your... 'condition.' I can't be thinking about dating you at the same time."
        whitney @talkingmouth "That'd be, like, totally unethical. As a future nurse, I can't be doing stuff like that."

        pause 1.0

        flannery @talkingmouth "...I was scared, Whit."
        flannery @closedbrow talkingmouth "I was scared that... your patience would run out. I know it's not easy to get along with me."
        ...
        if (GetRelationshipRank("Flannery") == 1):
            whitney @talkingmouth "What about [first_name]?"

            flannery frownmouth @surprisedbrow talkingmouth "Huh?"

            whitney @talkingmouth "Aren't you pretty good friends with him?"
            whitney @happy "Like, you've been hanging out a lot after school, and stuff, right?"

        else:
            whitney @talkingmouth "What about Tia?"

            flannery frownmouth @surprisedbrow talkingmouth "Huh?"

            whitney @talkingmouth "Aren't you pretty good friends with her?"
            whitney @happy "Like, you've been reading your fanfics to her, right?"

        flannery @talkingmouth "...So, you know about that..."
        ...
        flannery @talkingmouth "I... thanks."

        pause 1.0

        flannery @talkingmouth "When... when I heard Sabrina say that you called me a project... that scared me."

        whitney frownmouth "{w=0.5}.{w=0.5}.{w=0.5}."

        flannery @talkingmouth "I haven't really been able to... you know, do the normal teenage stuff. I was too busy with the Lavaridge gym. So I thought that you... I mean..."
        flannery @happy "You're friends with everyone, Whit. You collect friends like most people collect clothes."
        flannery @talkingmouth "So I thought that... you'd be easy to be friends with. You'd be easy to {i}be normal{/i} with."
        ...
        whitney @talkingmouth "Nope."

        flannery @surprised "Huh?"

        whitney @talkingmouth "I didn't hear any of that."

        flannery @surprised "Uh... really?"

        whitney @talkingmouth "Yup. I just heard a bunch of secrets about who was cheating on who."
        whitney @closedbrow talkingmouth "Turns out there are a {i}lot{/i} of scumbags in this school."

        flannery @talkingmouth "Oh."

        pause 1.0

        flannery @talkingmouth "I guess we all heard different things, then."

        pause 1.0

        flannery @talkingmouth "But you heard the bit about [first_name], right?"

        whitney @surprised "Oh, yeah, what was that about? Mind control? Say {i}whaaaaat?{/i}"

        flannery @talkingmouth "I don't know why [first_name] freaked out up there, but personally, I think Cheren's full of it."

        if (GetRelationshipRank("Flannery") == 1):
            flannery @angry "Mind control? Get real! [first_name]'s an awesome dude who's just trying to help me figure out why I'm so weird in the mornings! If he really had mind control, he could just {i}make{/i} me normal, right?"
        ...
        flannery @talkingmouth "Besides, I don't think mind control is even a real psychic power. Moving stuff with your mind, I get. Reading minds? Makes sense. But controlling minds? I don't think that's a real thing."

        show flannery surprisedbrow frownmouth with dis

        whitney @talkingmouth "Oh. Um... it is, actually. It's in the Diagnostic and Statistical Manual of Esper Powers. It's extremely uncommon, even amongst powerful Espers, but... yeah."

        flannery -surprisedbrow @surprised "Oh."
        flannery @sadbrow talkingmouth "Does that mean he... {i}does{/i} have powers, then?"

        whitney @talkingmouth "Oh, n-no! No way. Well, yeah? A little bit. Tia told me about it."

        if (IsDate(5, 5, 2004)):
            flannery @surprised "What, Tia's here?! She's been missing for, like, a whole day!"

            whitney @surprisedbrow talkingmouth "Oh. Yeah. She just got back."

            flannery @tiredbrow talkingmouth "From what?"

            whitney @talkingmouth "I think she said she went to a water park? There was a lot of water, anyway."

        flannery @closedbrow talkingmouth "Why am I always the last to learn these things...?"

        whitney @talkingmouth "Because you spent your childhood memorizing the ship names of every single character on Galarian television instead of learning sign language?"

        flannery @closedbrow talkingmouth "That's a very clinical answer, Nurse Whitney."

        pause 2.0
        
        flannery @closedbrow talkingmouth "Alright. Well, what power {i}does{/i} [first_name] have?"

        whitney @talkingmouth "Okay. So, what Tia told me was..."
        ...
        flannery @talkingmouth "Wow. Didn't see that coming."
        ...
        if (WonBattle("FlanneryGardenia1")):
            ...
            flannery @tiredbrow tiredmouth "...That guy owes me $5,000."
        ...
        whitney @surprisedbrow talkingmouth "That's what you're getting from this?"

        flannery @happy "Whit, I turn into an entirely different person every afternoon. Making people understand your feelings a bit better isn't that weird."

        flannery @closedbrow talkingmouth "Though I'll admit I'm a bit jealous that he can just get Pokémon to listen to him. It's whatever."

        pause 1.0

        whitney @closedbrow talkingmouth "You don't turn into a different person, Flannery."

        flannery @surprised "Huh?"

        whitney @talkingmouth "It's always the same you. I can feel the anger you've buried in the afternoon. And I can feel your happiness in the morning, too."
        whitney @talkingmouth "It's {i}all{/i} one Flan. And I'm friends with all of you."

        pause 1.0

        flannery -surprised @closedbrow talkingmouth "...Thanks, Whit. No hard feelings about earlier?"
    ...
    if (makeupaurahall):
        ...
        hilda @sadbrow "Are you sure that you want to dorm with Hilbert, though? You're kinda setting yourself up for... a {i}really{/i} tough time."
    ...
    if (makeuprelichall):
        ...
        brendan @talkingmouth "...Bye, then."

        hilbert @closedbrow talkingmouth "Don't be so dramatic. We'll still see each other at lunch."

        brendan @closedbrow talkingmouth "Whatever, man. I'm still going to miss you, even if you want to be all moody about it."
        ...
        brendan @sadbrow talkingmouth "...I wish Ethan wasn't mad at us."
        ...
        calem @thinking "I wonder where he'll be dorming."

        brendan @talkingmouth "I wonder if he's really got mind-control powers."
        ...
        hilbert @closedbrow "Anything else is just overcomplicating the issue."
        ...
        brendan @talkingmouth "You should, man. I was lyin' to May, and I nearly ruined things for us."
        ...
        brendan @talkingmouth "...Hey, man. Can I ask you somethin'?"

        calem @talkingmouth "Of course."

        show calem surprisedbrow with dis

        brendan sadbrow @talkingmouth "How do I... get smart?"
        ...
        brendan @closedbrow "Nah, man. I'm not asking about any of that. It's, like... you. How do I be more like you?"
        ...
        brendan @talkingmouth "...Dude, just listen to how you talk. This is your second language, but you speak like a... like a freakin' politician."
        ...
        brendan @talkingmouth "I..."

        pause 1.0

        brendan @closedbrow talkingmouth "Let's talk about this later, bro."
    ...
    if (makeuppledgehall):
        ...
        $ renpy.music.queue("Audio/Music/MistraltonCity.mp3", channel='music', loop=True, fadein=1.5, tight=None)
        ...
        cheren shadow @sad2eyes "May I suggest that you leave this fight to us for a moment, and go fetch your stronger Pokémon?"

        silver @sadbrow "You guys can't hold this thing here for a whole half an hour by yourself!"
        ...
        silver @sadbrow "{size=25}...Great, he wants to test 'how quickly can I die?'{/size}"
        ...
        silver @surprised "What? My Pokéball worked on it... before it broke out, though."
        ...
        skyla @sadbrow "Um... what are you talking about?"
        ...
        python:
            ...
            ninetalesobj = Pokemon(38.1, level=24, moves=[GetMove("Blizzard"), GetMove("Dazzling Gleam"), GetMove("Extrasensory"), GetMove("Aurora Veil")], ability="Snow Warning")
        ...
        $ gymbattles["Ninetales1"]  = _return

        if (ninetalesobj in (playerparty + box)):
            python:
                ninetalesobj.UpdateLevel(12, False)
    ...
    if (makeupinspira):
        ...
        $ renpy.music.queue("Audio/Music/montenevera.mp3", channel='music', loop=True, tight=None)
        ...
        show grusha tired angryeyes angryeyebrows frownmouth hospitalpale noscarf:
            xpos 0.66
        ...
        grusha @closedbrow talking2mouth "What if I start trying to live again? What if I have hope? And then someone plays a Halloween prank on me that puts me in the hospital permanently?"
        ...
        show jasmine surprised with dis

        grusha @confusedeyebrows talking2mouth "Kinda, yeah."

        jasmine -surprised frownmouth @angrybrow poutmouth "Well, I don't think it does."

        jasmine @closedbrow "It's disappointing to hear he was keeping that secret from us, but... I can understand why he would."
    ...
    if (makeuprecreationcenter):
        ...
        stop music fadeout 1.5
        $ renpy.music.queue("Audio/Music/LoFiMaxRaidBattle.mp3", channel='music', loop=True, tight=None)
        ...
        if (GetRelationshipRank("Nessa") == 1):
            if (IsDate(5, 5, 2004)):
        ...
        nessa @closedbrow "No going to clubs, no posting swimsuit pics online, no drinking, no stuff like that."
        ...
        nessa @closedbrow talking2mouth "No. But, god, wouldn't {i}that{/i} be a headline? 'Movie Star Rosa and Model Nessa found making out in college pool!'"
        ...
        nessa @sadbrow "Yeah... I see what you mean."
        ...
        nessa @closedbrow angrymouth "{size=25}Oh, God. I just made another Raihan.{/size}"
    ...
    if (makeupresearchcenter):
        ...
        bea @closedbrow "I try to cultivate power, but I cannot imagine what it must be like for her, to live with this unwanted power for so long."
        ...
        nate @thinking "But... that's not what that situation called for. Maybe? Maybe it should have! I don't know."
        ...
        bea -surprised @talkingmouth "I, too, wear a mask."
        ...
        nate @closedbrow angrymouth "No, I should {i}have to{/i} deal stuff like that. I signed up for it. But you're just... {w=0.5}just a girl."
        ...
        bea -surprised @closedbrow talkingmouth "How do {i}you{/i} know this?"
        ...
        bea @closedbrow "I would like to submit a change-of-nickname request."
        ...
        nate @talkingmouth "I've already got a 'B', and so that's kinda confusing, to be honest, but..."
...
ethan @closedbrow "Wherever I am, I guess."
...
ethan @sadbrow talkingmouth "Come on. You can't {i}really{/i} believe that stuff Cheren said?"
...
roxanne "Wait. Falkner. That paperwork... you didn't?"
...
show screen songsplash("A Rival Appears!", "Zame")
$ renpy.music.queue("Audio/Music/RivalChill.mp3", channel='music', loop=True, tight=None, fadein=30.0)
...
leaf "Heya, new roomies! I'm Leaf, and I--"

leaf sarcastic "Wait, I know you nerds."

yellow @sadbrow happymouth "{size=25}I... didn't hear {i}you{/i} knock, either...?{/size}"
...
blue "{size=60}ARE YOU DOING.{/size}"
