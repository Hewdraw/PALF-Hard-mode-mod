...
calem surprised "Oh! Er..."

pause 0.5

calem -surprised @closedbrow talking2mouth "Well, yes. But, as I say, you have no obligation to answer the question. Especially as I have not, in actuality, asked it."
...
if (mayhaslarvesta):
    brendan @talkingmouth "Yeah! You two super-deserve to be up there. I'm sure you'll make all kinds of cool choices."
else:
...
leaf -happy @talkingmouth "Are you excited? Ready to march on in to that auditorium and claim your role as the rightful dictator of Kobukan?"
...
leaf @flirt "{size=30}Don't worry. I've got an inside man in the rebellion. We'll be ready for these schoolboys. They'll wet themselves with blood.{/size}"
...
calem -surprised @talkingmouth "I might have guessed."
...
leaf @closedbrow talking2mouth "I am {i}shocked{/i} and {i}offended{/i}, good Sir."
...
leaf -angrybrow -happymouth @talkingmouth "I really never would've pegged you as a politician, y'know."
...
leaf @closedbrow talkingmouth "Right. I know people have asked this before, but--what, again, are you going to help people with?"

red @happy "I'm just kinda hoping I figure that one out if I get elected."

leaf @talking2mouth "{i}When{/i} you get elected."
...
leaf @talkingmouth "So. Hug for luck?"
...
if ("RejectedConfession" in persondex["Leaf"]["Events"]):
    ...
    leaf @flirt "A totally chaste, pre-date hug, with absolutely no expectations or handsiness?"
...
show leaf closedbrow -bigblush fullblush talking2mouth with dis
...
show leaf -closedbrow -fullblush blush -talking2mouth with dis:
    ease 0.5 ypos 1.0 zoom 1.0

leaf @talking2mouth "I thought you'd be soft and huggable. But your chest is hard."

red @talkingmouth "Oh, yeah, I work out, sometimes. Maybe you've noticed?"

leaf @talking2mouth "You were totally tensing your muscles."
...
leaf @talkingmouth "Yeah, no, I'm serious."
...
leaf @talking2mouth "Well. That's it. A little bit."
...
leaf @talkingmouth "I'll take your word for it."
...
leaf @talkingmouth "Uh, I'm wishing [first_name] good luck before he gets elected Student Council President."
...
leaf @angrybrow talkingmouth "Yeah, and what do you mean 'no-one will vote for him'? You realize he's, like, really popular, right?"
...
blue "Wh-what? I--{w=0.5} no, I don't, I--{w=0.5} {i}what?{/i}"
...
blue -surprised closedbrow angrymouth "Just... Just get out of here."

leaf @talkingmouth "Uh, no. Kinda thought I told you that one. Do I need to explain the concept of taking 'no' for an answer?"

if ("RejectedConfession" in persondex["Leaf"]["Events"]):
    pause 0.5

    leaf @closedbrow talkingmouth "Yes, [first_name], I'm aware of the hypocrisy."

else:
    leaf @sadbrow talkingmouth "If I do, I really feel sorry for your first boyfriend."

blue @angry "Just... I need to talk to [first_name] {i}privately{/i}! Just get out of here!"

leaf "No! I'm here to {i}support{/i} [first_name]. That means I have dibs on his company, as opposed to you, who's just here to tear him down!"

blue "You idiot! I'm trying to {i}protect{/i} him!"

leaf "Protect him from what? Having a sense of self-esteem?!"

blue "You don't know a damn thing about him! You only met him a month ago!"

leaf "I know him well enough to know that he can't {i}stand{/i} you! So why don't {i}you{/i} 'smell us later' and get out of here?!"

narrator "You suddenly become aware that you are no longer a part of this conversation about you."

blue "Please! He's probably sick to death of you constantly hanging around him, he's just too much of a wimp to say anything!"
...
blue "You don't...{w=0.5} You...{w=0.5} Look,{w=0.25} {i}I'm trying to--{/i}"
...
python:
    ...
    bluepidgeottoobj.UpdateLevel(30)
    bluepidgeottoobj.UpdateMoves(["Gust", "Quick Attack", "Twister", "Pursuit"])
    bluepidgeottoobj.Item = "Sharp Beak"
    blueeeveeobj.UpdateLevel(17, updateMoves=False)
    bluemagikarpobj.Item = "Experience Share"
    bluecharmanderobj.UpdateLevel(17)
    bluecharmanderobj.Id = 5
    bluecharmanderobj.UpdateMoves(["Fire Fang", "Dragon Breath", "Dragon Rage", "Steady Flame"])
    bluecharmanderobj.Evs = [0, 1, 0, 1, 0, 1]
    bluecharmanderobj.Item = "Charcoal"
    bluemagikarpobj = Pokemon("Magikarp", level=15, moves=[GetMove("Bounce"), GetMove("Tackle")], ivs=[24, 24, 24, 24, 24, 24], item="Soothe Bell", nature=Natures.Adamant, gender=Genders.Male)
    blueexeggcuteobj = Pokemon("Exeggcute", level=17, moves=[GetMove("Bark Up"), GetMove("Leech Seed"), GetMove("Mega Drain"), GetMove("Confusion")], ivs=[24, 24, 24, 24, 24, 24], evs=[1, 0, 1, 0, 1, 0], item="Miracle Seed", nature=Natures.Bold, gender=Genders.Female, intelligence=1)
    blueparty = [bluepidgeottoobj, blueeeveeobj, bluecharmanderobj, blueexeggcuteobj, bluemagikarpobj]
    trainer2 = Trainer("blue", TrainerType.Enemy, blueparty)

    leafhelioptileobj.Item = "Magnet"
    leafdratiniobj.Item = "Dragon Fang"
    leafbulbasaurobj.Item = "Miracle Seed"
    leafdrampaobj = Pokemon("Drampa", level=13, moves=[GetMove("Glare"), GetMove("Protect"), GetMove("Twister"), GetMove("Echoed Voice")], ivs=[24, 24, 24, 24, 24, 24], item="Dragon Fang", nature=Natures.Modest, ability="Berserk")
    leafparty = [leafhelioptileobj, leafdratiniobj, leafbulbasaurobj, leafdrampaobj]
    trainer3 = Trainer("leaf", TrainerType.Ally, leafparty)

call Battle([trainer1, trainer2, trainer3]) from _call_Battle_70
$ gymbattles["Blue4"] = _return
...
if (WonBattle("Blue4")):
    ...
    leaf @closedbrow talking2mouth "Hm. When {i}will{/i} you learn?"
...
leaf @talkingmouth "...Hey. Are you okay?"

red @closedbrow talking2mouth "Yeah. It'd take more than [blue_name] being a jerk to get me off my game."

leaf -frownmouth @talkingmouth "Right? If that was all it took, you never would've left Pallet Town."

red @closedbrow "Right. ...Oh, hey, I just remembered. What did Janine want to talk to you about yesterday?"

leaf @talkingmouth "Oh, nothing serious. Just a weird little thing about my Dratini. I'll tell you about it tomorrow, in the city. You're busy now, right?"

red @talkingmouth "Yeah, I should be going to the auditorium now."

leaf @talking2mouth "Alright. See you later?"

red @happy "You sure will. Don't forget to vote."

leaf @talkingmouth "Mmm, maaaaybe. Can't say I'll vote for {i}you{/i} though."
...
grusha @confusedeyebrows "Cheren, you've been pretty silent."
...
grusha @confusedeyebrows "...Not that I really care, but why are you all interested in the Student Council?"

jasmine @angrybrow poutmouth "Grusha!"

grusha @angrybrow "What? I'm trying to start a conversation! We've got a couple hours to kill, and I don't want to spend that time just going in circles about how we're going to get elected."
grusha @closedbrow "Literally all we have to do is go up there and not fall off the stage, and we'll be fine."
...
grusha @closedbrow "Things definitely aren't flying along."

pause 1.0

redmind @confusedeyebrows "Was that a type pun?"
...
grusha @closedbrow "Hm."

jasmine @talkingmouth "I think everyone knows why I'm here. I just want to make sure the people who get into this school in the future recieve the same kindness and support I have."
...
grusha @closedbrow "Personal reasons."
...
grusha @closedbrow "Good turnout."
...
show jasmine surprised:
    ease 0.5 xpos 5.0/7.0
show grusha surprised:
    ease 0.5 xpos 6.0/7.0

gardenia "Hey! Happy election day, you guys! Want to show your support for the candidates? Just buy these unoffical candidate badges!"
...
gardenia "So, I've taken the liberty of creating official unofficial badges supporting you guys, basically acting as a {i}pro bono{/i} campaign manager."
...
grusha @closedbrow "Yeah, sure, go ahead. Need me to sign anything?"
...
grusha @confusedeyebrows "Stop being so serious. It's free money, and this is a school's Student Council. We're not going to break the democratic system by endorsing some badges with our faces on them."
...
gardenia "{size=30}Orrrr... if you've got the guts and brains to think {i}really{/i} long-term... I'll consider your endorsement worth a $1,000 dollar investment in my side projects."
gardenia @talkingmouth "You can do the math on that, right? It pays itself back in just ten {size=20}business{/size} days! Sounds like a deal to me, buddy."
...
menu:
    ...
    "At $300 a badge, I think you can afford to pay a bit more.":
        ...
        gardenia -surprised @angrybrow talkingmouth "I don't like savvy customers, y'know. But I respect that. So, sure, I'll double my offer. $1000 right now, or a $2000 investment."
...
calem "I've no objections. Council?"

serena uniform @talkingmouth "{i}Je vous en prie.{/i} Please, go ahead."
grusha uniform @closedbrow "Yeah, fine."
...
grusha uniform @closedbrow "Dibs on an aisle seat. {size=30}Seriously, girl, chill.{/size}"
...
silver "{size=20}Hah... hah... there's... hah...{/size}"
...
brawly @talking2mouth "...Like, how you can be sure she's a dude, then?"

falkner @talking2mouth "I can't, but based on the evidence, I--"

silver "Outside! There's... you need to... get strong battlers, and..."
...
grusha @confusedeyebrows "{size=30}What're we standing around for? Let's go.{/size}"

jasmine @surprised "{size=30}Hm? What do you mean?{/size}"

grusha @closedbrow "{size=30}C'mon. Some people are attacking the school. We're trying to prove to the school we'll fight for them.{/size}"
grusha @angrybrow "{size=30}Let's go out there, kick their asses, come back in and bask in the applause.{/size}" 

cheren @surprised "{size=30}Oh... shouldn't we leave that to the teachers?{/size}"

grusha @confusedeyebrows "{size=30}Of all of us, I kinda figured you could do with the boost most.{/size}"
...
grusha @confusedeyebrows "{size=30}Uh... I mean, the whole reason I suggested we go out and handle this was because he already ran out. So, yeah.{/size}"
...
roughneck surprised "Hey! What're you doing here?!"
...
roughneck "Yeah, that was it! Well, I've been {i}real{/i} mad about that ever since, so I think I'm gonna give you a little what-for! How'd you like that, huh?"
...
show serena -surprised angrybrow frownmouth
show cheren angrybrow
show calem angrybrow
show jasmine sweat angrybrow frownmouth
show grusha angrybrow

grusha @confusedeyebrows "Alright, boss-man. What's the plan? Where are we going?"
...
cheren @disappointedbrow "I'll wait until [first_name] is done with his battle, then join him."
...
python:
    ...
    trainer2 = Trainer("roughneck", TrainerType.Enemy, [silverskorupiobj, silverstunkyobj], number=2)
    HealParty(trainer2)
...
$ gymbattles["Roughneck2"] = _return

if (WonBattle("Roughneck2")):
    show roughneck surprised with dis

else:
    show roughneck angry with dis

redmind uniform @talkingmouth "Right, I forgot that these guys don't play fair... another ambush double battle, huh?"
...
roughneck "Heh heh! With a handful of these Oran Berries, our salad tonight is going to be delish!"
...
roughneck "Heh, I'll battle {i}and{/i} eat berries at the same time! No rules!"


python:
    trainer1 = MakeRed()
    
    cherenpurrloinobj.UpdateLevel(10)
    cherenpurrloinobj.UpdateMoves(["Fake Out", "Assist", "Growl", "Scratch"])
    cherenpidoveobj = Pokemon("Pidove", level=8, moves=[GetMove("Fly")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, gender=Genders.Male, ability="Rivalry")
    cherenlillipupobj = Pokemon("Lillipup", level=6, moves=[GetMove("Dig")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, gender=Genders.Male, ability="Vital Spirit")
    cherencarvanhaobj = Pokemon("Carvanha", level=6, moves=[GetMove("Dive")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, gender=Genders.Female, ability="Rough Skin")
    cherenparty = [cherenpurrloinobj, cherenpidoveobj, cherenlillipupobj, cherencarvanhaobj]
    trainer2 = Trainer("cheren", TrainerType.Ally, cherenparty)
    HealParty(trainer2)

    silvergrimerobj.Item = "Oran Berry"
    silverscraggyobj.Item = "Oran Berry"
    silvercroagunkobj.Item = "Oran Berry"
    silversneaselobj.Item = "Oran Berry"
    trainer3 = Trainer("roughneck", TrainerType.Enemy, [silvergrimerobj, silverscraggyobj])
    HealParty(trainer3)

    trainer4 = Trainer("roughneck", TrainerType.Enemy, [silvercroagunkobj, silversneaselobj])
    HealParty(trainer4)
...
$ gymbattles["Roughnecks2"] = _return

if (WonBattle("Roughnecks2")):
    show roughneck surprised at leftside with dis
    ...
    cheren -surprised @closedbrow disappointedmouth "...I... No. No, thank you, I'm good."

    narrator "You gained $327!"

    red @closedbrow "Alright. Where to, next?"
...
janine @talkingmouth "I'm struggling to find the words to explain how much shit you're in."
...
roughneck surprised "I'm kinda thinking that maybe we should, like, go..."

redmind @confusedeyebrows frownmouth "Huh, so she does that too."

janine @closedbrow talkingmouth "{i}Sigh.{/i} Look, attacking the school like this is a massive, idiotic, mistake."
janine @sadbrow "But I still want to be able to go to the alley to blow off steam every once in a while, and I can't do that if you guys get arrested."
janine @closedbrow talkingmouth "So I'm going to close my eyes, and when I open them, [first_name] and his friend over there will have kicked your ass, and you'll be gone. Got it?"
...
roughneck "Hey! The scary lady told us ta fight you instead of her, so... uh... yeah!"
...
python:
    ...
    trainer3 = Trainer("roughneck", TrainerType.Enemy, [Pokemon("Beedrill", level=14, moves=[GetMove("Fury Attack"), GetMove("Twineedle"), GetMove("Poison Sting")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, ability="Swarm")])

    trainer4 = Trainer("roughneck", TrainerType.Enemy, [Pokemon("Mightyena", level=18, moves=[GetMove("Howl"), GetMove("Bite"), GetMove("Roar"), GetMove("Snarl")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, ability="Intimidate")])

    trainer5 = Trainer("roughneck", TrainerType.Enemy, [Pokemon("Dustox", level=14, moves=[GetMove("Gust"), GetMove("Confusion"), GetMove("Poison Sting"), GetMove("Bug Bite")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Timid, ability="Shield Dust")])
...
$ gymbattles["Roughnecks3"] = _return

if (WonBattle("Roughnecks3")):
    show janine uniform closedbrow:
        xpos 0.2
    show roughneck surprised:
        xpos 0.4
    ...
    janine @talkingmouth "Alright. Are they gone?"
...
janine -closedbrow @talkingmouth "Good. Hopefully they ran off and told their buddies that they were in over their heads."
...
if (WonBattle("Roughneck2") and WonBattle("Roughnecks2") and WonBattle("Roughnecks3")):
    ...
    if (GetRelationshipRank("Janine") > 0):
        if (janinedomming):
            ...
            janine @talkingmouth "Exactly what I expected of my precious battler."
    else:
        janine @smirkmouth "Well done."

pause 1.0

janine @angrybrow talkingmouth "...I should probably get a little bit involved. Damn it, I was meant to be having a meeting with the Dean in a couple minutes, though..."

pause 0.5

janine @talkingmouth "Alright. Scram. I'll clean up here. You're doing that election, right? Go back to that, I've got the 'invasion' covered."

red @confused "You aren't going to vote?"

janine @talkingmouth "Sorry. I saw your posters, but none of that stuff affects me."
...
janine @talkingmouth "Yeah, I don't think I'm going to go for that, this year. You guys seem to have it covered. Hopefully I can appoint one of you Captain and finally launch my own attempt next year."
...
janine @talkingmouth "Not a Ma'am. And yes, don't worry. Just go."

cheren @sadbrow disappointedmouth "Well... if you say so."

pause 1.0

janine @talkingmouth "Wait. You, the one who's not [first_name]."
...
redmind @confused "Hm. What was that about?"
...
grusha @confusedeyebrows "Yeah, and we heard Cheren went out 'like a punk'. That's an exact quote."

pause 0.5

grusha @closedbrow "We also heard he 'didn't {i}do{/i} shit.' Another direct quote there."
...
grusha @closedeyes "Not every day that the people trying to get sworn in as the student body's fighters and defenders actually prove they can do it."

pause 0.5

grusha @confusedeyebrows "Though it does look like they're mostly looking at you, [first_name]. Seems rumors spread quickly."
...
show roxanne surprised uniform with dis

roxanne "You're back. Thank goodness! What happened? I looked away for half a second, and you were all gone, and Brawly had bent a skinhead into the shape of a pretzel."

grusha @closedbrow "Minor invasion of school grounds by some punks from the city. Must've known that, for a couple minutes, there wasn't going to be a Student Council, so they were hoping to capitalize on our moment of weakness."

show serena uniform surprised with vpunch:
    xpos 0.6

serena "Are you suggesting there's a {i}mole{/i} in Kobukan? {i}Another{/i} imposter? How thrilling!"

grusha @closedbrow "Eh."
...
jasmine "Say, shouldn't we get on with the election? I think we've held it off long enough at this point."

calem @talkingmouth "Right you are."
calem @talking2mouth "Roxanne, thank you for the lovely introduction."

roxanne -surprised "Mm. Remember: {w=0.5}Thank you. {w=0.5}Carry on. {w=0.5}Stay true."
...
calem @closedbrow talking2mouth "We all owe the Battle Team a great debt of gratitude, of course. It is internationally famous, and with famous champions such as Lance, Cynthia, and Steven Stone graduating from it, its reputation is clearly well-deserved."
...
redmind @confused "Really? I haven't even said anything yet."
...
narrator "Upon further inspection, Calem and Serena are, too. It seems the overly-enthusiastic response your tepid speech recieved did not escape your fellow council hopefuls."

redmind @thinking "Sorry, guys. Frienergy. Not much I can do about it."

pause 1.0

redmind @closedbrow "But, hey, this could be a good thing. At least I can use it to help people."
...
play music "audio/music/drought.mp3"
...
cheren @disappointedbrow "I recuse myself."
...
cheren @disappointedbrow "Your arguments are weak and thin! I can tell you doubt him yourself! There's nothing else to prove!" 
...
cheren @sad2brow "[first_name]. Any comments?"
...
$ renpy.music.queue("Audio/Music/lavenderintense.mp3", channel='music', loop=True, fadein=0.0, tight=None)
...
mace @closedbrow "It might be more accurate to say... we know how to {i}take{/i} it."
...
face "Come on! Get up here, witch!"
...
if (GetRelationship("Sabrina") == "Friend"):
    ...
    redmind @sad "[sabrinacolor]{size=30}Help me.{/size}"

    narrator "You cannot speak."

cheren @surprisedbrow surprised3mouth "Wait. What are you--what are you two doing?"

mace "Oh, it's quite simple! This lovely lady here is an Esper, who has a bad habit of reading our minds!"

face "Yes, she's like a wonderful piñata of secrets."

mace "Now, what do you suppose will come out if we break this piñata, hm?"
...
mace "Well? Tell us about [first_name]! Tell us about his powers!"

face "Don't spare {i}any{/i} details, or we'll know you're working with him!"

sabrina "Y-you're... you're crazy, I don't know... he doesn't have anything..."
...
mace "Quit that bullshit!"

face "Yeah, we know you're covering for him!"
...
sabrina @talkingmouth "N-no! Don't fight! Please, just... leave me alone, and..."
...
face "Tell us about the freak, or you're next!"

sabrina @talkingmouth "N-no, I... no, just..."
...
show sabrina neutralpowered poweredbrow talkingmouth with dis:
        ypos 1.0
        ease 2.0 ypos 0.8
        parallel:
            ease 2.0 ypos 0.85
...
sabrina "Leave me [sabrinacolor]{i}ALONE!{/i}{/color}"
...
mace -surprised @talkingmouth "Well. There you have it."

face -surprised @talkingmouth "Undeniable proof that [first_name] has a power that he's been hiding from us."

show sabrina -neutralpowered sadbrow sadmouth:
    ease 0.5 xpos 0.5 ypos 1.0

sabrina "...Why? Why did you...? How could you be so cruel...?"
...
sabrina "...Yes. Yes, this was foolish of me. To think I could have a life."
...
sabrina @talkingmouth "My mentor would tell me not to do this."

show mace surprised
show face surprised
with dis

sabrina @closedbrow "He would say... that this is revenge. That I'm proving myself the witch you think I am."
sabrina "I suppose I no longer have a reason not to cast my spells."
sabrina @talkingmouth "...So, here is my curse. Your secret."
...
sabrina "They are siblings. {w=1.0}{i}And{/i} lovers."
...
$ AnimateArrow(random.randint(-10, -1), random.uniform(0.1, 0.9))
$ AnimateArrow(random.randint(-10, -1), random.uniform(0.1, 0.9))
$ AnimateArrow(random.randint(-10, -1), random.uniform(0.1, 0.9))
...
face angry "{i}Shut up, you idiot!{/s} Let's get out of here!"
...
serena "You are a... a... fuckin' shithead, you know that, Cheren? You {i}ASSHOLE!{/i}"

$ AnimateArrow(random.randint(-10, -1), random.uniform(0.1, 0.9))

show calem uniform surprised with dis

calem surprised "S-Serena? Why are you... what happened to your accent...?"
...
erika "...How very disappointing. If you wish to preserve what little dignity you have left, I trust you know what to do, [first_name]."
...
if (charname == "Leaf"):
    ...
    dawn "Please tell me that you can explain this... that's there's something Cheren overlooked..."
