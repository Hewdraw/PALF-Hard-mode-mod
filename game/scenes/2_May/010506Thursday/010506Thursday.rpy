...
menu: 
    ...
    "Wake her up.":
        ...
        leaf @closedbrow talkingmouth "{size=30}...No, [first_name]... That's too much salad...{/size}"
    ...
    "Splash some water on her.":
        $ persondex["Leaf"]["Events"].append("Splashed")
...
blue "No way in hell am I letting you dorm here! This is {i}my{/i} suite, and I {i}just{/i} got rid of those other losers!"

show leaf angrybrow talkingmouth at rightside, sepia behind flashback with dis

pause 2.0

blue "Fine, but there's no way I'm letting you sleep in one of the bedrooms! Gramps paid extra for this suite, and I'm using the whole damn thing! You can take the couch!"

show yellow angrybrow talkingmouth at leftside, sepia behind flashback with dis

pause 2.0

blue "Fine, but if you think I'm going to {i}schlep{/i} my way over to your smelly old dorm in the morning and pick up {i}your{/i} crap, then--"
...
if ("Splashed" not in persondex["Leaf"]["Events"]):
    ...
    leaftease @angry template bigblush "I'm getting changed! Don't come barging in here!"
...
if ("Splashed" not in persondex["Leaf"]["Events"]):
    leaf @closedbrow talkingmouth "{i}Yawwwwwwn...{/i}"
    leaf @talkingmouth "Mmmorning. Mmrmph. I need coffee..."
else:
    leaf @angrybrow frownmouth "..."
...
if ("AcceptedConfession" in persondex["Leaf"]["Events"]):
    ...
    leaf @talkingmouth "I've got my reasons."
...
leaf @embarrassed "Sorry, Ethan, but I'm kinda behind on my schoolwork... missing an evening's worth of classes is seriously tough at Kobukan."
...
ethan @thinking "We'll probably have time to do one thing before that match, and one thing after, before we have to go to that Battle Team meeting."
...
leaf @closedbrow talkingmouth "Phew. That was {i}not{/i} a moral dilemma I wanted to sign up for at this time in the morning."
    ...
    ">Study a type.":
        ...
        menu:
            "That's fine.":
                ...
                $ ValueChange("Ethan", 1, 0.6, False)
                $ ValueChange("Yellow", 1, 0.8)
...
wally judgingeyebrows judgingeyes surprisedmouth  "I mean, am I on camera right now?"
...
wally "Sorry, I'm not good with cameras. It's, uh, it's against my religion. To be onscreen."
...
lisia -surprised @sadbrow happymouth "Hah hah... okay, well, absolutely no offense intended! Perhaps we can find someone else around here, then?"

show brock surprised at rightside behind beam1 with dis:
    xzoom -1
...
brock "Yup, sorry, sis. Same deal, with me. Actually, I'm not even allowed to show my face."

lisia -surprised @angry ".{w=0.5}.{w=0.5}.{w=0.5}Okay."
...
lace "Hello, young man. How pleasant it is to see that not all Kobukanian students are utterly lacking in manners."
...
python:
    trainer1 = MakeRed(2)
    trainer2 = Trainer("lace", TrainerType.Enemy, [Pokemon("Qwilfish", moves=[GetMove("Flip Turn"), GetMove("Poison Tail")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], nature=Natures.Timid, ability="Intimidate", level=14, intelligence=1),
        Pokemon("Lombre", moves=[GetMove("Fake Out"), GetMove("Mega Drain"), GetMove("Bubble")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], nature=Natures.Modest, ability="Own Tempo", level=14, intelligence=1),
        Pokemon("Chinchou", moves=[GetMove("Bubble"), GetMove("Electro Ball")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], nature=Natures.Timid, ability="Volt Absorb", level=14, intelligence=1),
        Pokemon("Spheal", moves=[GetMove("Icy Wind"), GetMove("Water Pulse")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], nature=Natures.Modest, ability="Ice Body", level=14, intelligence=1),
        Pokemon("Basculin", moves=[GetMove("Aqua Jet"), GetMove("Bite")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], nature=Natures.Adamant, ability="Adaptability", level=14, intelligence=1),], number=2)

call Battle([trainer1, trainer2], specialmusic=("audio/music/swordshieldgym-intro.mp3", "audio/music/swordshieldgym-loop.mp3"), customexpressions=["red", "red angrybrow happymouth", "lace", "lace angry"]) from _call_Battle_115 
$ gymbattles["Lace1"] = _return
...
lace "Yes, quite so. Seems I got swept away in this battle, though... Ah, well."
...
queue music "audio/music/newfriends.ogg"
...
blue @closedbrow "Some rando with trash Pokémon. I don't even remember what they were."

ethan @closedbrow talking2mouth "Yeah, I was fine, too."

leaf @talkingmouth "No problems here."
...
blue -frownmouth @closedbrow "Psh. The only win that matters is the one where you completely beat your opponent."
...
leaf @talkingmouth "Hey, [first_name], you..."

pause 1.0

leaf @closedbrow talking2mouth "Uh, maybe I'll leave this one to Ethan. I'm going to the Battle Hall."
...
janine @closedbrow talkingmouth "Line up."
...
janine @talkingmouth "I'm not a madam. I'm only a couple years older than you."
janine @talkingmouth "And I believe I told you what I expect of you right now."
...
janine @talkingmouth "...I'm going to check in with all of you, now. {i}Then{/i}, I'll open the floor to other discussion."

janine @closedbrow talkingmouth "I saw most of your matches. You're all still in, right?"

$ PlaySound("short_crowd_talking.mp3")

pause 1.0

narrator "There are a few muttered words of assent."

janine @talkingmouth "Good. I'm not going to be the first Battle Team Captain who had a Battle Team member lose in round one."

hilbert @sad "{size=30}...It's not going to be up to you...{/size}"

janine @talkingmouth "Alright. Now, anyone who wants to say something, you can."
...
janine @talkingmouth "Everyone, get out a piece of paper. Write on it 'eject' or 'keep'."

hide bea with dis

leaf @surprised "What?!"

janine @talkingmouth "Do it now. You have two minutes to pass them in."
...
if (truevotes == 5):
    janine @talkingmouth "It's split evenly."
elif (truevotes == 4):
    janine @talkingmouth "Four ejects to six keeps."
elif (truevotes == 3):
    janine @talkingmouth "Three ejects to seven keeps."
elif (truevotes == 2):
    janine @talkingmouth "Two ejects to eight keeps."

pause 1.0

$ PlaySound("paperrip.mp3")

janine -sadbrow @talkingmouth "And it doesn't matter. This is not a democracy. I have made a decision, and my decision is that [first_name] is staying on the team."

erika @surprised "But... you said... that the togetherness of the team was your priority?"

janine @angrybrow talkingmouth "I do. And by trying to eject another team member, you're the one who is causing problems. Not him."

erika @sadmouth "But... his powers..."

hide erika with dis

janine @talkingmouth "Let's put these rumors to rest. [first_name], give an explanation of your powers. Now."

pause 1.0

red @talking2mouth "{w=0.5}.{w=0.5}.{w=0.5}."

pause 1.0

narrator "You open your mouth to speak... but you find that you can't."

janine @surprisedbrow talkingmouth "[first_name]? What's wrong? You told me before..."

red @sadbrow "{w=0.5}.{w=0.5}.{w=0.5}."

janine @closedbrow "Okay. I didn't expect this. Change of plans, then."

pause 1.0

janine @talkingmouth "The point is that he's staying, and his powers aren't mind control. They're, like... mind influence. We don't feel our own feelings, we feel--"
janine @closedbrow talkingmouth "No, wait, that just makes it sound worse. Okay, his power makes Pokémon do whatever he says, which is--"
...
janine @angrybrow talkingmouth "What?"

hilbert @closedbrow "He's going to be out of the Quarter Qlashes tomorrow anyway."
...
hilbert @sad "He's in the second bracket of eight. That means he's in competition with everyone with numbers nine through sixteen."
...
queue music "audio/music/legendary.mp3" fadein 5.0
...
hilbert @sad "This whole vote was pointless. We already know the outcome."
hilbert @thinking "There are two hundred and forty groups of eight battling at this location. With nine of us, the odds of any two of us ending up in the same group was 14.08%%."

stop music fadeout 1.5

janine surprised "...I should've split us up into different areas."
...
janine -surprised @closedbrow talkingmouth "Quiet."

pause 1.0

janine @talkingmouth "I need to think about what to do."

dawn @sadmouth "I... I can just... drop ou--"

janine @talkingmouth "No, you can't."

pause 1.0

dawn @sadmouth "I {i}could{/i}, though." 

janine @closedbrow talkingmouth "I will not permit you to." 

dawn "I'm... I'm {i}really{/i} sorry, but I don't think you can actually stop me."
...
janine @closedbrow talkingmouth "That's better."

pause 1.0

janine @talkingmouth "[first_name]."

pause 1.0

janine @talkingmouth "Can I trust that you won't quit, either?"
...
red @thinking "I think you drew blood..."
...
janine @talkingmouth "You're talking again."
...
janine @closedbrow talkingmouth "...I don't want to be the first Captain to have a Battle Team member lose in the first round."
janine @talkingmouth "But it looks like that's already happened. God damn it. This was {i}so{/i} avoidable, if I just hadn't been lazy... I separated our signups the past two years, but with a smaller team this year, I thought... {i}ugh.{/i}"
...
janine @talkingmouth "But [first_name] would still need to beat you. If we were trying to avoid damaging the Battle Team's reputation, then... [first_name] leaving the Battle Team, and being beaten by you, would solve most of our issues..."
...
janine @talkingmouth "Okay. I need some more time to think about what we should do."

erika @angrybrow sadmouth "Perhaps my suggestion seems more attractive, in light of this new information?"

janine @talkingmouth "...Enough. Pick a training partner. I need to have a talk with Lance."
...
menu:
    ...
    ">Train with Leaf":
        ...
        leaf @talking2mouth "Of course."
        leaf @sadbrow talkingmouth "And... sorry about Erika. I take grass classes with her, but I've never seen her {i}like that{/i} before..."
    ...
    ">Train with Bea":
        ...
        bea @closedbrow "Very well. Let us commence."
    ...
    ">Train with Sonia":
        ...
        sonia @talkingmouth "Right-o. I remember a few techniques Janine taught us at the end of last year. If you wouldn't overly mind skipping a head a bit...?"

    ">Train with Silver" if seensilver:
...
lance @talkingmouth "Do you have a plan to prevail over Dawn tomorrow?" 

red @closedbrow talking2mouth "No."

lance @sad2eyes talkingmouth "So it falls to me. Unsurprising."

red @surprised "Well... I'm surprised. Why-- I mean--"
red @confused "Do you {i}want{/i} me to win?"

lance @shadow talkingmouth "Dawn does not even {i}want{/i} to be a member of the Battle Team." 
lance @sad2eyes talkingmouth "Between someone who insists on self-sabotage and someone who does not even want to compete, I find you, regrettably, being my favored victor."

red @happy "Aw. We're warming up to each other."

lance @shadow talkingmouth "As long as that damnable Pikachu is in your party, my feelings for you will never be warmer than a Baxcalibur's scales."

red @closedbrow talking2mouth "...Great."

lance @talkingmouth "I will talk with you tomorrow morning about possible solutions to this inconvenience."
lance @talkingmouth "For now, I am willing to remind one of your Pokémon of a move."
...
if (_return == 'back'):
    ...
    menu:
        "I don't want to teach any of my Pokémon one of their old moves.":
            lance @closedbrow talkingmouth "Fine."
    ...
    lance @talkingmouth "You wish me to teach your [tutormonname]... not what I would do, but fine."
    
    $ rememberablemoves = GetRememberableMoves(tutormon)

    if (len(rememberablemoves) == 0):
        lance @talkingmouth "This Pokémon has no moves it can remember."

        jump movetutor506

    else:        
        lance @talkingmouth "What do you want me to re-teach this Pokémon?"

        $ learnmove = renpy.call_screen("rememberablemoves", tutormon)

        if (learnmove == "Back"):
            lance @talkingmouth "You will have to battle Dawn, one of the strongest battlers this Battle Team has ever seen, in approximately fourteen hours."
            lance @sad2eyes talkingmouth "I wouldn't waste these precious moments with indecision."
...
lance @sadbrow talkingmouth "I have done all I can for now."
lance @talkingmouth "I will be expecting you here, tomorrow, at eight o'clock. If you are to have the slightest chance of victory, then you will attend."

pause 1.0

lance closedbrow talkingmouth "For now, I..."

pause 1.0

lance @shadow sad2eyes talkingmouth "Am going."
...
janine @talkingmouth "Everyone, head back to your dorms. Tomorrow is going to be a big day. Everyone focus on winning your own matches. Lance and I will figure out what to do about Dawn and [first_name]'s match."

pause 0.5

janine @closedbrow talkingmouth "[first_name], stay here a moment."

pause 1.0

janine @talkingmouth "...The Team comes first."

red @sadbrow frownmouth "{w=0.5}.{w=0.5}.{w=0.5}."

janine @angrybrow talkingmouth "You get what I mean, right? More than my reputation. More than anyone's pride. The reputation of the Team needs to come first."

red @sadbrow talking2mouth "I'm not dropping out."

janine @smirkmouth "...Good. But there's more."
janine @talkingmouth "I need you to explain your powers to everyone."

red @sadbrow frownmouth "{w=0.5}.{w=0.5}.{w=0.5}."

janine @talkingmouth "Only someone with your powers can explain it in a way that {i}doesn't{/i} make it sound insane. Or evil."

red @sadbrow "I... I tried."
...
janine @talkingmouth "I don't need you to try. I need you to {i}succeed.{/i}"
...
blue "You {i}can't{/i} 'figure something out' with her! She's a dragon! She's a dragon, and one of my classmates is a literal dragon, so I know what I'm talking about!"
...
red @confusedeyebrows frownmouth "Well... that's not a good sign."
...
redmind @closedbrow "Well... I guess they hadn't finished moving out yet. I'll tell Ethan about his stuff in the morning, and if the other guys ever talk with me again, then..."
...
red night @swimsuithatless happyeyes happyhatlesseyebrows happymouth "Don't come in. I'm indecent."

$ hideside = True

pause 1.0

leaf "So am I, but you don't hear me bragging about it."

pause 1.0

leaf "On a serious note, though, I... I wanted to tell you something."
leaf "When you froze during the Battle Team meeting today..."
leaf "Are you scared of telling people about... Frienergy? Telling people the truth?"

pause 1.0

$ hideside = False 

red @sadeyes sadhatlesseyebrows talking2mouth swimsuithatless "...Yes. More than anything else."
red @sadmouth sadeyes sadhatlesseyebrows swimsuithatless "I don't want people thinking that they were only ever my friends because of a power."
red @sad2eyes neutralhatlesseyebrows talking2mouth swimsuithatless "Of course, I don't want people thinking that I'm mind-controlling them, either..."

$ hideside = True

pause 1.0

leaf "Professor Surge said something to me that... um... I think you should hear."

pause 1.0

leaf "He said that sometimes, there are things that only you can do. No matter who you look to for help, they won't be able to help you."
leaf "If I could wave a magic wand and make your problems go away, I would. I believe in you. But my belief isn't enough, here."

pause 1.0

leaf "You can speak, [first_name]. I trust you. But it has to be {i}you{/i} who speaks."

pause 1.0

leaf @talkingmouth "'Aight. That was all. {size=30}G'night.{/size}"
