...
oak "...And that concludes our lesson for today."

redmind uniform @thinking "Finally! Old Man Oak's always fun to listen to, but my head starts swimming after just twenty minutes of lecture, never mind four hours."
redmind @surprised "Wait. We were supposed to have a quiz, weren't we?"
...
oak "Not so fast! I haven't dismissed you yet.{w=0.5} I hope you all haven't forgotten about the {color=#0048ff}quizzes every Monday and Thursday.{/color}"

show flannery uniform:
    alpha 0.0 xpos 1200 zoom 1.35
    ease 0.5 alpha 1.0
...
show whitney uniform:
    alpha 0.0 xpos 685 zoom 1.3
    ease 0.5 alpha 1.0

whitney @talkingmouth "Oops, did I really?{w=0.6}{nw}"
...
oak "Okay, class. Clear your desks and take out your pencils." 
oak "Today's quiz is pretty simple. Still, make sure you look at the status of the field, your opponent, and yourself, before you commit to any moves!"
oak "Remember, {color=#0048ff}this is graded!{/color}"
...
oak "That's it for today, class.{w=0.5} Now, you're all dismissed."
...
redmind @thinking "Finally, I'm about ready to drop. For the first time, I don't even care about talking to Old Man Oak, I just want to get out of here."
...
leaf "Use. The. Brochure. It's got a map on it!"
...
redmind @thinking ".{w=0.25}.{w=0.25}."
...
menu:
    ">Invite Leaf.":        
        ...
        red @talkingmouth "I'm dropping by the Research Center. I was going to take a look around, then have a chat with Old Man Oak."
        ...
        leaf @happy "Aw, I'd love to go!{w=0.5}{nw}"
        ...
        extend @happy " Mostly marine biology, but I bet the other 'ologies' are just as cool!"
        ...
        leaf @embarrassed "I would be, buuut, just not today.{w=0.5}{nw}"
        
        extend @blush embarrassed " May asked me to study with her after she bombed the quiz. I'm really sorry!"
        show leaf
        
        red @talkingmouth "Hey, no problem. We'll do it another time."
        
        leaf @flirt "Yeah we will.{w=0.5} I'll come next time, I promise!"
        ...
        leaf @flirt blush "Aren't you a lucky guy?{w=0.5} See you later, [first_name]!"
        
        show leaf:
            xpos 700 alpha 1.0
            ease 0.75 alpha 0.0 xpos 550
    ...
    ">On second thought...":        
        redmind @thinking "Nah. I'm going to be talking with Old Man Oak about serious stuff. Like, how I even got into this school."
...
$ renpy.music.queue("Audio/Music/Power Plant.ogg", channel='music', loop=True, fadein=1.0, tight=None)
...
bianca "[first_name]!{w=0.5} Is that you?"

show bianca happy:
    xpos 700 zoom 1.2 alpha 1.0
    
red "The one and only.{w=0.5} I didn't expect to see you here."
...
if (natenamed):
    ...
    bianca "He's a friend from Unova.{w=0.5} He's real smart!"
...
red "Well, Old Man Oak asked me to come here to talk about something. Uh, Professor Oak, I mean."
...
show bianca happybrow talkingmouth:
    ...
    block:
        ease 0.12 ypos 1.12 xpos 720
        ease 0.1 ypos 1.0
        repeat

extend " {cps=140}{size=30}I'm here 'cause today the Research Center brought in Magnemite and Voltorb and we're gonna see how much energy they can store in a light bulb, oh, but we're not gonna use them for slave labor or anything, gosh, no, that'd be awful--{/size}{/cps}"

redmind ".{w=0.25}.{w=0.25}."

bianca "{cps=140}{size=30}You can think of this as like some kind of conditioning or workout routine for Pokémon like Magnemite or Voltorb and I heard somewhere that since they technically don't have any muscle fibers or whatever, using up their electricity builds up their natural affinity to their--{/size}{/cps}"
...
nate @surprised "You're part-time." 
nate @thinking "Much as I'd love to have all your attention to myself, I know you've got a thing going on with Cheren."
nate @happy "Now, {i}I{/i} don't mind sharing, but I think Cheren might."

pause 2.0

show bianca surprised
show nate surprised
with dis
...
red @thinking "Yeah, Bianca's grabbed me a couple times for Cheren."
...
show nate surprised with dis
red @angrybrow happymouth "Well, which of those categories are you in?"

pause 2.0

nate -surprised @thinking "Observant, huh? Yeah, I'm here just to, uh... use the computers, basically. Networking stuff."
...
bianca "Yeah! Nate's a super genius!{w=0.5} He knows how to code and hack and slash and debug and defrag and defibrillate and defenestrate and--"

nate sweat @angrybrow talking2mouth "B, let's not talk too much more, alright?"

bianca happy "O-kay!~"

nate -sweat @talkingmouth "Sorry about that, [name_fragment]. Really, I'm just a simple tech guy. So if you have a toaster that needs fixing, {i}that's{/i} the kind of stuff I can do."
...
nate @thinking "{size=35}Yes? {size=32}Of, {size=29}course, {size=26}Sir, {size=23}it's {size=20}all {size=17}on..."
...
red @thinking "Hm. Well, uh, {w=0.5}{nw}" 
...
oak "Ah, [first_name].{w=0.5} Good, you're here."
...
red @thinking "Okay. Here are the facts. I'm in Kobukan Academy. And you teach here. You didn't tell me, even though you would've had plenty of time to."
red @thinking "So you didn't {i}want{/i} me to know. However, you knew how much getting into Kobukan Academy meant to me."
red @thinking "And you knew that if I knew you were working here, I'd ask for your help getting in."
red @thinking "So, you didn't want me to ask for your help. That means you either didn't want to help me, or... you didn't want me to ask for help."
...
oak -surprised @closedeyes talkingmouth "...Completely wrong, actually."
...
red @closedeyes talking2mouth ".{w=0.25}.{w=0.25}.{w=0.25}You could be a bit more empathetic."
...
red @talkingmouth "I'm here because you recommended me. But, wait..." 
red @thinking "Kobukan is prepared to teach a complete newbie to Pokémon training, but it still demands that you have high grades when it comes to math, science, literature... and a life outside school, too."
...
red @surprisedeyes "Oh! It's my memory, right? Being able to memorize every Pokémon, and all their stats and moves and stuff?"
...
redmind @thinking "This conversation could have been an email."
...
oak @closedeyes "Some have been known to talk to Pokémon, or heal their injuries with a touch."
...
red @closedeyes "...I'm sorry, Professor. I don't think you're right about this. I don't have some kind of... superpower. Some kind of aura. I just go up to people, introduce myself, then ask their name. It's really that simple."
...
red @confusedeyebrows "The data? What do you--"
...
redmind "Woah, there. Slow down, [first_name]. You know you need to be patient with Sam."
...
oak -sad @angrybrow angrymouth ".{w=0.25}.{w=0.25}.{w=0.25}"
...
oak @angry "I repeat, this is not mind control, nor does it {i}make{/i} people like you. It just means your intentions won't be misunderstood. And when you tell the truth, people believe it."
...
red @thinking "I guess... it still feels kinda uncomfortable, though. Like I'm getting an unfair advantage in life."
...
oak -surprised @surprisedeyes surprisedeyebrows talking2mouth "Yes, lad?"
...
red @thinking "There's Lance.{w=0.5} Uh,{w=0.25} Mr. Lance,{w=0.25} I guess? He got seriously angry at me."
...
redmind @thinking "...Guess Old Man Oak wasn't there for the Battle Exhibition, then."
...
redmind uniform @thinking "Good, no-one's back yet.{w=0.5} I want to talk to [pika_name] about my.{w=0.25}.{w=0.25}.{w=0.25} condition."

$ renpy.music.play("Audio/Pokemon/pikachu_excite2.ogg", channel="altcry", loop=None)

pikachu neutral_2 "Pika! Pika pi!"
...
pikachu angry_3 "Chuuu...!"

red @talkingmouth "Aw, come on, lighten up!"
...
red @thinking "Yeah, I got some news. Really big news. Just give me a second to sit down.{w=0.5} It's been a long day."
...
redmind @thinking "I feel like I could just sink right through this bed right now..."
red @thinking "{i}*Sigh*...{/i}"
...
red @talkingmouth "Look... Old Man Oak thinks that I have some kind of 'ability' that makes people... {i}like{/i} me."
...
pikachu happy_2 "Pi-ka!"

red @thinking ".{w=0.25}.{w=0.25}."

red @happy "Yeah. Okay. I trust you, buddy. And if Old Man Oak's right... and I've never known him to be wrong... then there's nothing shady or evil about this." 
red @talking2mouth "...Maybe the best strategy is really to just assume he's wrong and carry on as I was before."

red "Hmm..."
red "Say, [pika_name]. You haven't spent much time with [starter_name], right?{w=0.5} Would you like to?"

pikachu neutral_2b "Pi Pikachu!"

red "All right, come on out, [starter_name]!"
...
starter "[starter_fragment]! [starter_species_name]!"
