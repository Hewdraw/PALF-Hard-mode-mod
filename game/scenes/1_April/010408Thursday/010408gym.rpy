...
red @thinking "Oh. Well... how do I make [startergenderpronoun] stronger, then?"
...
blue @happybrow talkingmouth "HAH! What kind of idiot doesn't know how to train a Pokémon? You don't deserve to be in this school!"

pause 2.0

show bruno norm with dis
alder angry2 "...Mr. Oak. We don't tolerate that sort of talk in this class. {w=1.0}{nw}"
extend happy2 "Besides, what's Kobukan for if not to teach people how to train Pokémon? Seems Mr. [last_name] here is getting the most bang for his buck!"

pause 1.0

blue closedbrow frownmouth "Psh, whatever. I'll be over here {i}not{/i} wasting faculty time."

redmind "Kinda feels like if he already knows everything, he's just wasting his own time, then...?"
...
alder "You need to let your Pokémon know when they're doing poorly, and when they're doing well. Otherwise, they'll just keep doing the same thing over and over, and never gain any experience."
...
red @thinking "Well... what should I do, then, Sir?"
...
red @thinking "How will I know what they're capable of, though?"
...
red @thinking "I see... I'm jumping between electives, but if I focus really hard on one elective, could I make my Pokémon super-strong right away?"
...
red @thinking "I see...{nw}" 
extend @surprised " Wait, what happens if I train a Pokémon in battle before I've taken enough electives to know what it's capable of?"
...
red "Yeah. It'll happen for me and [pika_name]. And, if you want it, for you, too."
...
$ trainer2 = Trainer("silver", TrainerType.Enemy, [Pokemon(451, level=6, gender=Genders.Male, ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, moves=[GetMove("Knock Off"), GetMove("Poison Fang"), GetMove("Fell Stinger"), GetMove("Hone Claws")], ability="Battle Armor")])#Skorupi

call Battle([trainer1, trainer2], uniforms=[True, True]) from _call_Battle_3
$ gymbattles["Silver1"]  = _return
