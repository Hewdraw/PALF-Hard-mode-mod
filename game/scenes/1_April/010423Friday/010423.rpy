...
oak "I tell you, these meteorite fragments are truly something! There appears to be biological residue embedded within the very stone."
oak "My new assistant is an utter godsend, I tell you. With her experience, we could be moments--moments, I say--from discovering the Kobukanian equivalent of Wishing Stars."

pause 1.0

oak "But... I suppose that won't be on the test, so your interest being limited is understandable, if disheartening."
oak "{i}Sigh.{/i}"
oak "Very well. You're dismissed."
...
menu:
    "{color=#66b77d}[[Knowledge] >Approach Professor Oak as a student.":
    ...
    "{color=#e226a6}[[Patience] >Approach Old Man Oak as a friend.":
...
oak -surprised @happy "Well, lad, I'd be more than happy to tell you!"
...
red @thinking "What the hell could that be? I don't know of any Pokémon like that..."

oak @happy "Oh? Don't you?"

red @thinking "Uh... well, I can't really think of one..."
...
red @thinking "Since the genetic material is embedded into rock, it doesn't seem likely that the original Pokémon was alive, even before it blew through the atmosphere and crashed into the planet?"
...
oak @closedeyes "A Poké-homo Psychosociologist."
