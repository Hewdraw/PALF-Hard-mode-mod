...
oak "...So I suppose you could say that things are really becoming exciting. Who could have guessed that extraterrestrial rock would contain such a fascinating energy?"
oak "The implications are wondrous. Or, as my new Galarian assistant might say, 'right brilliant!' Hoho."

pause 1.0

oak "That reminds me. Who here thinks they can name the legendary Pokémon of Galarian myth? Hm... how about you, Miss Birch?"

may surprised uniform "Me? Shoot. I don't know much about myths... {size=25}Psst. [first_name], a little help?{/size}"

menu:
    "{color=#66b77d}[[Knowledge] >Tell her straight-out.":
        red uniform @closedeyes talking2mouth "{size=25}Zacian and Zamazenta. The Warrior Pokémon.{/size}"
