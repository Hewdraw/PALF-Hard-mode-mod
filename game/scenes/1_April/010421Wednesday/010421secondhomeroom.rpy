...
oak "And that about wraps up this lesson! Remember--the ability Sturdy not only prevents a Pokémon from being knocked out at full health, but also grants full immunity to One-Hit KO moves."
oak "This rarely comes up, but it's worth remembering. Another thing worth remembering is that if a Pokémon with Sturdy loses health, then is restored to full health again, Sturdy will {i}still{/i} work."
...
oak "Keep that in mind! And as long as you do, you're all dismissed."
...
if (wins > 4 and falinksobj in playerparty):
    ...
    red @thinking "I didn't do great at the battle tryouts, so I should train up before our meeting on Friday."
...
cheren @thinking "I thought nothing of it. Sharp words from an unpleasant pair of jealous fools."
...
red @sad "...But Old Man Oak told you to stop looking into me."
...
cheren @sad "Amusingly, the only other person I can be certain didn't {i}bend{/i} the rules is myself, and my own dormmate, Professor Oak's own grandson."
...
red @thinking "Right. I was just wondering... are you sure that's a good idea?"

show cheren surprised with dis

cheren "{w=0.5}.{w=0.5}.{w=0.5}.What?"
...
cheren -surprised @angry "...I was under the impression that repealing curfew was a cornerstone of your campaign, as well."

red @thinking "I mean... I'm not sure I ever established what the cornerstones of my campaign were."
...
cheren @thinking "Perhaps Blue will know."
