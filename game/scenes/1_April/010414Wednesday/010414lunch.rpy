...
show whitney sad uniform with vpunch

whitney "[first_name]! I need you to bail me out {i}right now!{/i}"

red @surprised "Huh? What is it?"

whitney "Tia's driving me absolutely {i}crazy.{/i} Every free moment I have, she's been yelling at me about wanting to see you!"
...
whitney "Just sit at our table, and take some of her heat off of me. You don't even have to talk to her, just {i}be{/i} there. I'm begging you."
...
if (not tablevalid):
    ...
    red @thinking "I have to consider the possible desolation of my social standing, you know. Anything could happen when you sit at an unsecured table."
