...
oak "...So, it's important to remember that Pokémon seem to have an innate desire toward cooperation." 
oak "There are exceptions in both directions, of course, such as the incredibly cooperative Passimian, or endlessly {i}un{/i}cooperative Zweilous."
oak "Still, a wild Pokémon that asks another wild Pokémon to assist is likely to receive its desired assistance."
oak "Perhaps it's the universality of the Pokémon 'language'? Or perhaps Pokémon simply do not regard each other with suspicion, as humans do?"
oak "The answer to this is unlikely to be learned during my lifetime."
...
oak "Still, we can hope.{w=0.5} Dismissed!"
...
red @thinking "I can't imagine your clientele is too expansive in that field?"
...
red @thinking "Uh... I can't say, I'm afraid. I mean, I don't even know, but..."
...
red @thinking "It's a bunch of people queueing for a bowl full of fruit juices and spices, but that's not important right now."
...
leaf @talkingmouth "Can't help you with Skyla, though. Don't even know her."

leaf @thinking "Try talking to Whitney? She knows everyone."
...
flannery @talkingmouth "...Again? Aw. That's twice she's ditched me..."

leaf @surprised "Wait, she ditched you?"

flannery @talkingmouth "Yeah... we were supposed to go shopping yesterday, but she cancelled last-minute, so it was going to happen today, instead..."
flannery sadbrow @sad "But I guess that's not happening either."

leaf sad "Oh no... that's so sad!"
...
flannery @talkingmouth "Nah, Bianca, {i}our{/i} roommate."

leaf @thinking "That'll get confusing."
...
red @thinking "Uh... even me? I was kinda planning on getting started on this Student Council thing..."

leaf -angry @talkingmouth "{i}Especially{/i} you! You still need to learn how to use the city properly!"

red @thinking "I'm... pretty sure I just go into a store and buy something..."
...
skyla @talkingmouth "Oh? What is it? And who's this cute lil' guy?"
...
red @thinking "Uh... not sure that's a completely accurate assessment of the situation, but close enough."

skyla @smirkmouth "Yeah, what about it?"

red @talkingmouth "Would you mind not telling anyone about it?"

skyla surprised "Woah! How come? Is the meteor actually something big? Did someone find something?"

red @thinking "No, I just... uh..."
...
skyla -surprised @angrybrow happymouth "Well, if it's to protect someone, say no more!" 
...
red "Alright, [pika_name], let's--"

show skyla surprised with vpunch

skyla "Wait!"

skyla sad "Uh... I just remembered. I actually did already tell someone. About the meteor, the girl, you and Brendan. Everything."

red @thinking "Hm. Just one person?"
...
skyla "Er... yeah. Sorry about my slip-up."

red @talkingmouth "It's cool. You didn't know."

hide skyla with dis

red "Alright, guys, let's go to bed."
