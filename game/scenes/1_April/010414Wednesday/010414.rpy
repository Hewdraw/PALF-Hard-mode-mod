...
red @talkingmouth "Morning, Calem. What's up? You look tired."

calem @surprised "Ah! You're awake?" 
calem thinking "Oh, of course you are, you go for your runs every morning."
...
calem @thinking "Of course, I simply {i}must{/i}, for my future career interests."

red @sad "Can't you slow down?"

calem @happy "Not while Cheren is out there. I think he got some bad news yesterday, because he's seemed to redouble his efforts."
...
calem @thinking "He wants sweeping reforms. But the polls show, overwhelmingly, that the students would rather just... well, have the Student Council organize a couple inter-school tournaments and leave it at that."
...
calem @thinking "No, not quite yet. The voters simply decide who they want to be on the council. We're not directly competing for seats." 
...
if (council_campaigning):
    ...
    red @thinking "...But from what I've heard, it sounds like I'm becoming kinda well-known already. Though I'm not sure what people think my positions are."
    ...
    red @angrybrow frownmouth "{size=25}Damn my inoffensive charisma...{/size}"
    ...
    red @thinking "Still, I don't know how I'm going to have time for this. My days are so busy, I haven't really had any time to sit down and really {i}focus{/i} on reaching out, even if I'd wanted to before now."
...
red @thinking "So you're saying I can continue to goof off until Saturday?"
...
redmind uniform "...Damn. From the lecture, I can tell that I missed some pretty key information in yesterday morning's homeroom. I really gotta be careful not to miss another homeroom like that again."

oak "Now, can someone summarize what the Cortondo incident was?"

oak "{w=0.5}.{w=0.5}.{w=0.5}."

oak "No-one? Remember, two Pokémon were attracted to a woman who had suffered a mental breakdown. [first_name], how about you?"

redmind @surprised "What?! I wasn't here for morning homeroom yesterday! Give me a break, Sam..."

menu:
    "{color=#66b77d}[[Knowledge] >Try to recall what you know about Cortondo.":
    ...
    "{color=#60c2f8}[[Wit] >Figure it out based on what the Pokémon might be.":
...
oak "Yes, correct! A woman having a mental breakdown attracted a Blissey and a Hatterene simultaneously."

oak "As you may recall, Blissey will travel many miles to comfort a person who they perceive to be distressed, and are capable of sensing upset people from an equally far distance."
oak "Hatterene will similarly travel many miles to find a distressed person... but, rather, to 'quiet' them."
oak "The Blissey and Hatterene in this situation were equally matched." 
oak "Given they both had access to recovery moves and many wild Leppa berries, they were able to wage a guerilla war on each other for weeks, terrorizing the town."
oak "Of course, the townspeople's terror just attracted {i}more{/i} Blissey and Hatterene. Eventually, the hordes were dispersed through the efforts of elite trainers from the local Naranjuva Academy."
