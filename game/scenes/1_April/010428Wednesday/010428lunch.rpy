...
whitney @talkingmouth "Hilda was just asking me if I knew who the pineapple-haired guy hanging out with Hilbert all the time is."

red @confused "Pineapple-haired?"

hilda @talkingmouth "Yeah, Whitney told me his name is Nathan. So who {i}is{/i} this guy?"

redmind @confused "{i}Nathan?{/i}"
red @talkingmouth "Um... he's just another student, as far as I know."

hilda @thinking "You're Hilbert's roommate. Do you know why he's spending time with someone else?"
...
whitney @talkingmouth "So... just out of curiosity, since I did that little favor for you, would you mind doing a favor for me?"
...
hilda @thinking "Your fingers? You've gotta have way smaller fingers than me, at your size. But, hell yeah, that'd be a piece of cake. Just a bit of darning."
...
whitney @talkingmouth "It was the weirdest thing. We were just in Inspira, walking by the seaport, when--"
...
hilda @thinking "I mean... one of those Pokémon-rights organizations in Unova said that, but most people wouldn't agree."
...
menu:
    "{color=#66b77d}[[Knowledge] I should investigate.":
        $ TraitChange("Knowledge")

    "{color=#ff8412}[[Courage] I should fight it!":
        $ TraitChange("Courage")
...
redmind @thinking "Hm. Maybe I should talk to Old Man Oak about these frenzied Pokémon. If he figures out what's happening, and this hasn't happened before, maybe I could be the one to name them!"
