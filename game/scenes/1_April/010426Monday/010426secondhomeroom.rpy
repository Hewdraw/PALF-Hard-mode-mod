...
oak "How has your Monday been, ladies and gentlemen?" 
oak "I hope you've been thinking about this upcoming quiz! After last Thursday's one-versus-three affair, we're going back to basics." 
oak "Though it {i}should{/i} be noted that this is the first battle that will make use of held items!"
oak "{color=#0048ff}As such, your opponent will be equipped with one 'Oran Berry,' which restores 10 HP to a Pokémon in distress.{/color} Do keep this in mind."

pause 0.5

oak "Now, take out your pencils! Remember, this is graded!"
...
call Battle([trainer1, trainer2], gainexp=False, healParty=False, clearstats=False, uniforms=[True, False], lockbag=True) from _call_Battle_64
$ gymbattles["Oak6"] = _return
...
if (WonBattle("Oak6")):
    if (trainer1.GetTeam()[0].GetMoves()[3].PP != trainer1.GetTeam()[0].GetMoves()[3].MaxPP):
        ...
        redmind @confused "Pokémon morality is weird."
else:
    red uniform @sad "Uh-oh. I don't have a good feeling about this one."

    if (trainer1.GetTeam()[0].GetMoves()[3].PP != trainer1.GetTeam()[0].GetMoves()[3].MaxPP):
        red @thinking "I probably shouldn't have used Metronome..."
...
oak "Item usage is an important facet of battles. Study their effects, and when it's most advantageous to use them!"
oak "Not only could this save your victory in a battle, it could save your wallet!"
...
oak "Well, that seems to be the end of our class, then. Have a nice rest of your day! And make sure to brush up on item usage. It will be relevant for your next quiz, I promise."
...
red @thinking "...So. Where would I be, if I was a Student Council?"

show leaf uniform at rightside with dis

pause 1.0

leaf @talkingmouth "Standing around in a classroom, talking to yourself?"

red @thinking "Hm... no, that doesn't sound like me."
...
red @thinking "I need to track down the old Student Council. A bunch of us Student Council guys are trying to put together a meeting before the elections."
...
leaf @closedbrow talking2mouth "Or... maybe it totally {i}is{/i} you, and I just don't know you as much as I thought I did?"

menu:
    "{color=#e226a6}[[Patience] No, you're right.":

        $ TraitChange("Patience")

        leaf @happy "Oh, for real? Phew. I was wondering if I'd totally misjudged you."

    "{color=#66b77d}[[Knowledge] It wasn't me before, but it is now.":

        $ TraitChange("Knowledge")

        leaf @thinking "Oh, okay. I get it. I guess you're, like, still getting used to this, huh?"
...
leaf @thinking "I'm pretty sure that's not how the phrase goes."
...
leaf @flirt "Well, aren't you forward?"
...
leaf @closedbrow talkingmouth "Yeah, well... I did. Do you have a problem with it?"
...
extend "and, uh, failed totally at it."
...
red @thinking "I mean, have you tried counting shoulders? That one always works."
...
leaf @closedbrow talking2mouth "Okay. Newsflash, buster. I'm trying to be serious here. And...{w=0.5} um...{w=0.5}"
...
leaf @closedbrow talking2mouth "Sorry, Skippy. You might be the second-best on the Battle Team, and kind and fit and hilarious, but I guess that {i}just isn't enough{/i} for me."
...
leaf @talking2mouth "Please. I can afford to have any standards I want.{w=0.5}{nw}" 
extend  -blush @happy " Have you seen me? I'm a catch."

red @confused "{size=25}So is a Magikarp.{/size}"

red @thinking "Anyway, what, then, would be enough for your standards? Maybe if I was a rocket scientist?"

leaf @closedbrow talking2mouth "Nah, that don't impress me much."
...
leaf @talking2mouth "C'mon, you dork. Let's go."
...
leaf @talkingmouth "Hey, Sonia."

sonia @talkingmouth "Oh, hi there, you two. Were you after me, then?"

red @confused "Apparently?"

leaf @talking2mouth "Yeah, we wanted to rely on your expertise, as our Senior."

sonia @surprised "I'm not sure if my experience will be of any use, really, but I'll give it my best shot."

leaf @talkingmouth "Well, we're trying to find the Student Council. [first_name] is going to tell them to clear out their offices."

red @happy "That's not {i}exactly{/i} what I'm doing."

leaf @thinking "Thing is, though, we're not really sure where they are. We don't know if there's, like a club room or meeting place or something."

sonia @thinking "Oh, so because I was here last year, you reckon I know where they might be? Right, I see..."
...
leaf @flirt "You sure about that, navigator?"
...
sonia @thinking "I've been to Hammerlocke a couple of times, and just looking up at the castle's ramparts gave me vertigo something awful."

leaf @talkingmouth "...Hey, Sonia. Mind if I ask you a question?"

sonia @surprisedbrow happymouth "{i}Another{/i} one, you mean. But of course, go off."

leaf @talkingmouth "I don't mean to pry, but from what we heard from Janine, it sounds like you were in the Battle Team last year, but you just quit. Not just the Battle Team, but the school itself."

pause 0.5

sonia @sadmouth "Right."

leaf @talkingmouth "...Um. Why?"

show leaf frownmouth with dis

sonia @talkingmouth "...If you don't mind, I'd rather keep a lid on that for now."
...
sonia @thinking "Last year... {w=0.5}isn't exactly something I'm proud of."
...
leaf -frownmouth @talkingmouth "Thank you."

red @thinking "Anything we can do for you?"
...
sonia @talkingmouth "Good luck, you two!"
...
leaf @talkingmouth "I do. By not running."
...
leaf @talking2mouth "...I'll speedwalk with you."
...
red @thinking "Calem's organizing a meeting of the Student Council hopefuls tomorrow morning, in the cafeteria. He's hoping we can all compare our positions, align our goals, then come up with a united campaign to get people to vote."
...
red @thinking "What about Serena?"
...
red @thinking "Damn. I'm not sure how to tell Cheren this myself."
...
leaf @talkingmouth "What about [first_name]? Why couldn't he be a president candidate?"
...
leaf uniform @thinking "...His options, huh?"
...
janine @talkingmouth "Good, you're all here."
janine @closedbrow talkingmouth "We need to talk about--"
...
janine @talkingmouth "Wait. One of you {i}is{/i} missing. Where's Erika?"
...
janine @closedbrow talkingmouth "Unbelievable. Our second meeting, and the girl's late."
...
janine -surprisedbrow @thinking "I don't want you thinking that you can buy your way into my good books."
...
erika "Hello, my fellow teammates!"

ethan "Hey, Harlacher!"

erika surprised "I... my name is Erika."

ethan @thinking "What, didn't I say that?"

pause 1.0

janine @talkingmouth "Erika, continue. Ethan, until you've sorted out your issues, just stay quiet."

ethan @surprised "Eh? ...Er, okay."

erika -surprised @talkingmouth "Well, right. I believe many of us have recently come into the possession of baby Pokémon hatched from the Springsday eggs, yes?"
...
leaf @talkingmouth "You know how, in battles, your Pokémon can hold berries, or wear Heavy-Duty Boots, or Rocky Helmets, or something?"

ethan @talkingmouth "Yeah, sure.{w=0.5}{nw}" 
extend @happy " I mean, some of 'em. I don't know how you'd put boots on a Hoppip."

janine @talkingmouth "That's exactly what Battle Bags are for. They're a multi-purpose item-holding equipment that can let pretty much any body type use any item they want."
...
red @thinking "Sounds like a win for accessibility, but a loss for small business, then."
...
janine @talkingmouth "Nope, that's enough. You get three chances to spit it out. If it takes four tries, we don't have time for it."

janine @angrybrow talkingmouth "Erika, does everyone have one?"
...
janine @talkingmouth "You know how to use all these, right?"
...
leaf @talkingmouth "Yeah, that's pretty much it."

sonia @surprisedbrow happymouth "That's what I did last year."

silver @surprisedbrow "{w=0.5}.{w=0.5}.{w=0.5}.{w=0.5}{nw}"
extend @surprisedbrow talkingmouth "Uh?"

pause 0.5

janine @talkingmouth "Equip those Experience Shares to your lowest-leveled Pokémon. If you don't, you're just wasting experience."

pause 0.5

janine @talkingmouth closedbrow "Speaking of experience."

janine @talkingmouth "What levels are all your Pokémon right now? They should be around level 12. By the end of Sunday, you should have a team of level 14s."

blue @happy "Hah! All my Pokémon are {i}way{/i} higher levels than that!"

janine @talkingmouth "Good job."

pause 0.5

blue @surprised "What?"

janine @talkingmouth "I said good job, Blue. I hate repeating myself."

blue @surprised "But-- you-- I didn't... what?"

leaf @talkingmouth "What's [blue_name] stuttering about?"

red @thinking "I think this might be the first person who's ever actually said 'good job' to him."
red @happy "Probably doesn't know how to handle it!"

leaf @sadbrow talkingmouth "...Right."

janine @talkingmouth "I'll keep you updated on what levels your team should be at any given moment. [bluecolor]If you ever want a reminder, visit me in your free time in the Battle Hall.{/color}"

dawn @talkingmouth "Um... if we're below that level, where should we train?"

janine @talkingmouth "Besides the battles you have in class, the wild is an option."
...
janine @closedbrow talkingmouth "Right. The school's almost done securing the forest after that fire, so I think you should probably be able to go into the forest soon."
janine @talkingmouth "The Pokémon there tend to be a bit stronger than the ones you might find in the city. Until the forest opens up, though, your best option is just to get in whatever practice you can on-campus."

pause 0.5

janine @thinking "Speaking of. It's time we do some practice battles. Normally we'll do these every Friday, but I wanted to get a head start, since the first Quarter Qlash is soon."
...
janine @talkingmouth "That's right. I {i}don't{/i} anticipate that. Which is why we need to prepare for it."

red @surprisedeyebrows frownmouth "Intense."

janine @talkingmouth "Pair up. I want everyone to focus on training their Pokémon beneath level 12 right now."

janine @talkingmouth "[bluecolor]Battle Team training will always provide an extra boost to Pokémon beneath the recommended level.{/color}"

pause 0.5

bea @talkingmouth "Are you going to assign partners?"

janine @talkingmouth "No. You'll eventually learn who your best training partner is. Until then, just pick someone."
...
leaf @talkingmouth "Hey. Figured I'd better grab you before someone else did."
