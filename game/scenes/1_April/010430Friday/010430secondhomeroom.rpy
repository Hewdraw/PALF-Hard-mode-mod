...
oak "...And that seems to wrap up the lecture! I hope to see you all in Relic Hall's auditorium on Saturday, yes?"
...
janine @talkingmouth "Alright. Let's talk movesets."

janine @closedbrow talkingmouth "Who here has heard of the 'Flareon Theorem?'"
...
bea "{i}Hai.{/i} Flareon was a Pokémon who, for many years, was not thought to be able to learn a number of key moves."
...
janine @closedbrow talkingmouth "Damn shame. They're insanely fluffy. I would have liked to use one."
...
janine @closedbrow talkingmouth "My dad, the Indigo Elite Four Koga, would say that debuffing status moves are the most important kind."

lance @closedbrow talkingmouth "I would say that powerful moves are the most important kind."

janine @talkingmouth "Yes. And I would say that buffing status moves are the most important."

hilbert @closedbrow talkingmouth "You don't agree?"

janine @talkingmouth "It's not about agreeing or disagreeing. Different moves serve different battle strategies more or less effectively."

janine @smirkmouth "I look forward to seeing how all of you develop your battle strategies."

janine @talkingmouth "Anyway, for this lesson, Lance and I are going to teach your Pokémon how to remember moves they've forgotten."
...
lance @talkingmouth "It is a valuable skill. If you are not powerful enough to overcome a foe with raw strength, you may consider altering your strategy to best them."

show lance:
    ease 2.0 xpos 0.5 ypos 1.2 zoom 1.3

lance @angrybrow talkingmouth "You may also consider dropping moves from your repertoire that are useless, or provide nothing but a burden."

show lance with dis:
    ease 2.0 ypos 1.0 zoom 1.0 xpos 0.875

lance @talkingmouth "Finally, you might elect to learn moves that are able to hit a foe's weakness, whether it be their types, or the flaws in their strategies."

show lance:
    ease 2.0 xpos 0.5

lance @closedbrow talkingmouth "There is no set of Pokémon moves that can beat every other Pokémon. It follows that there is no team that can beat every other team."

lance @angry "In lieu of perfection, the only guarantee is {i}strength{/i}."

pause 1.0

lance @sadbrow talkingmouth "You'd do well to remember this."

janine @talkingmouth "Lance and I will be providing this service every Friday, during our Battle Team meetings."

janine @closedbrow "We have a limited amount of time, though. Even though there's only about a dozen of you, this year, we don't have time to go over {i}every{/i} Pokémon you have on hand. We'll teach one move, and that's it."

janine @thinking "Maybe, later on in the year, if some of you start dropping due to the Quarter Qlashes, we'll be able to focus more attention on those who are left. So we could teach more moves at one club meeting."

lance @closedbrow talkingmouth "Do not count on that. It is the Battle Team's aim to get everyone through the fourth Quarter Qlash, and into the national tournament."

pause 1.0

lance @angrybrow talkingmouth "{i}Almost{/i} everyone."
...
janine @talkingmouth "Every meeting, yeah. We might hold meetings on non-Fridays, if we're in a rush. Like last Monday."

lance @sadbrow talkingmouth "My apologies for my absence then. I had an engagement with the Dean.{w=0.5} And his daughter."
...
janine @talkingmouth "I'll take the trainers on the right side of the arena. Lance?"

lance @closedbrow "I will take the left."
...
lance @sadbrow talkingmouth "How wonderful. You are capable of recognizing obvious truths before your nose. I had started to think otherwise."

redmind @closedbrow sweat talking2mouth "Oops. I said that out loud, didn't I?"

pause 0.5

janine @talkingmouth "While you're waiting for us to get around to you, start training."
...
menu:
    ...
    ">Train with Silver":
        ...
        silver @surprisedbrow "Huh? What brought this up?"
    ...
    ">Train with Hilbert":
        ...
        hilbert @closedbrow "Fine. Just don't slow me down."
...
lance @talkingmouth "It appears that you are the last person I need to teach these valuable skills to."

pause 1.0

red @talkingmouth "Yeah."

lance @closedbrow talkingmouth "And the Battle Team meeting is still ongoing."
...
lance @angrybrow talkingmouth "Tch."

lance @talkingmouth "Fine, then. Pick a Pokémon that could stand to learn a new move. Once you've selected a Pokémon, I'll tell you what it's capable of relearning."
...
if (_return == 'back'):
    ...
    menu:
        "I don't want to teach any of my Pokémon one of their old moves.":
            lance @closedbrow talkingmouth "Foolishness."
    ...
    lance @talkingmouth "Oh, you want me to teach your [tutormonname]?"
    lance @sadbrow talkingmouth "Why am I not surprised?"
    
    $ rememberablemoves = GetRememberableMoves(tutormon)

    if (len(rememberablemoves) == 0):
        lance @talkingmouth "This Pokémon has no moves it can remember. Avoid wasting my time, if you are capable of such a thing."

        jump movetutor430

    else:        
        lance @talkingmouth "Fine. What do you want me to re-teach this Pokémon?"

        $ learnmove = renpy.call_screen("rememberablemoves", tutormon)

        if (learnmove == "Back"):
            lance @talkingmouth "You have a scant few days before the first Quarter Qlash, where you will doubtlessly be the first Kobukan Battle Team member to ever be eliminated."
            lance @sadbrow talkingmouth "I wouldn't waste these precious moments with indecision."
...
lance @sadbrow talkingmouth "Well, this has been a dreadful experience for everyone. I hope you and your team learned something valuable today. Such as, perhaps, the fights you cannot win."
...
janine @angrybrow talkingmouth "Lance."

lance @closedbrow talkingmouth "I think it's about time we wrap this meeting up, don't you? You know where to find me."

hide lance with dis

pause 1.0

janine @talkingmouth "Yeah, he's right. Everyone head home. Go {i}straight{/i} to your dorms. If you abuse our nighttime exception, the school might revoke our privileges."

pause 0.5

janine @talkingmouth "...Except you. Leaf, you stay."

show leaf at leftside with dis

leaf frownmouth @surprised "Huh?"

janine @closedbrow talkingmouth "You heard me, and I don't like repeating myself. I just want a quick chat. Everyone else can go."
