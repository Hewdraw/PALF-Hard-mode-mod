...
oak "And with that, you should all be ready to handle today's lesson! We're doing things a bit differently for this one."
oak "In this test, you'll have multiple opponents. Your victory condition is the same as it always is--simply knock your foes out before you're knocked out."
oak "Don't forget to look over the battlefield {i}very{/i} carefully before committing to any moves! A real battle doesn't give you the luxury of sitting back and planning out your moves, but these tests do, so take advantage of it."

redmind uniform @thinking "Funny, I always feel like I have enough time to think through my moves in {i}my{/i} battles..."

oak "Finally, there's one piece of information that's very vital. {color=#0048ff}It is not possible for you to faint on your first turn.{/color} As long as you remember that, you should easily be able to handle this challenge!"
...
call Battle([trainer1, trainer2], clearstats=False, gainexp=False, healParty=False, uniforms=[True, False], currentWeather=("hail", 5), lockbag=True) from _call_Battle_50
$ gymbattles["Oak5"] = _return
...
oak "Remember, weather conditions often have many effects that aren't explicit. Blizzard will never miss in hail or snow. Rock-types get a Special Defense boost in sandstorms."
oak "There are many abilities that trigger under the effect of sun or rain, as well. Keep these in mind!"
...
red @thinking "Oh, yeah? What're you talking about?"

calem @talkingmouth "Well, Cheren has been surveying people across the school about the curfew issue."

calem @thinking "We've come to some different conclusions."
...
menu:
    "{color=#ff8412}[[Courage] They're no trouble.":
    ...
    "{color=#60c2f8}[[Wit] Probably better safe than sorry.":
        ...
        if (WonBattle("Hilbert2")):
            hilbert @sad "Tch. You beat me in the tryouts, [first_name]. You should know that, with your strength, there's nothing to fear."
        else:
            hilbert @angry "Your opinion is obviously influenced by your loss against me in the tryouts, [first_name]."

            hilbert @sad "If you can't even beat me, no wonder you're afraid of some shiftless societal rejects living in the gutters."
