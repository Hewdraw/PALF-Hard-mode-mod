...
oak "And that's the end of the lecture! If you have any questions, feel free to drop into the Research Lab during my office hours!"
...
oak "Oh! Oh, yes, you did seem to indicate that you thought that might be some sort of problem."

oak -surprised @closedbrow talkingmouth "Well, I'm glad you've satisfied your concerns on the matter."
...
blue "So, you got into the Battle Team too?"

red @confused "Were you listening to our conversation?"

blue "Ex-{i}cuse{/i} me for not being able to ignore Gramps yelling 'oh, [first_name]'s so great, I love [first_name]' across the classroom."
...
blue "What, do you have hiccups or something?"

leaf @thinking "Hm... okay, I can't decide what to do."
...
if (wins > 4):
    ...
    blue @closedbrow "I repeat. What-ever."
...
blue "This isn't going to last forever. I'll be happy as hell when you finally crash and burn."
...
leaf blush -surprised @sadbrow talking2mouth "...You're a great guy, you know that, [first_name]?"
...
leaf @talking2mouth "Oh, I'm sure she has Battle Team minions for that."

red @happy "What do you think the Battle Team meeting will be about?"

leaf @closedbrow talkingmouth "Going to go out on a limb here and say we're probably going to battle."
...
leaf -blush @closedbrow talkingmouth "On a serious note, though, I hope they're going to tell us more about how the Quarter Qlashes work. And I want to know what part Janine's playing in this."
leaf @thinking "She's pretty badass, but I don't think she has any influence over how people in the QQs are matched up. She probably wants to avoid knocking out any of her own team, you know, but it's kinda unavoidable."

red @thinking "Right. I've got a few questions I want to ask about tournaments, personally."
...
leaf @thinking "...Like how her Venomoth had five moves. I didn't imagine that, right?"
