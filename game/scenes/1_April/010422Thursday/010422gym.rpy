...
$ trainer2 = Trainer("sideportraitfull", TrainerType.Enemy, [Pokemon(54, level=16, moves=[GetMove("Surf"), GetMove("Calm Mind"), GetMove("Healing Spring"), GetMove("Confusion")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Modest, gender=Genders.Male, ability="Swift Swim")])
...
misty "Um... my Psyduck is kinda... disobedient. He just never listens to me, and when I try to send out one of my Pokémon, he'll jump out instead."
...
misty -surprised @talkingmouth "My Staryu isn't like that, though. And I train them the same way."
