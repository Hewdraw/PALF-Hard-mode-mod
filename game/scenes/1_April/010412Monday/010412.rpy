...
red @thinking "{cps=*0.2}Morning already? Geez...{/cps} Why have I been so tired recently?"
...
menu:
    "{color=#ff8412}[[Courage] >Just run like the wind! You can do it!":
        ...
        red uniform @confusedeyebrows talking2mouth "What's up with the constant fitness cracks? I run, like, every day. There's no insecurity there."

        hide blue
        hide leaf
        with dis

    "{color=#b7669e}[[Charm] >Ask one of your friends to bring food to homeroom.":
        ...
        if (GetRelationshipRank("Sabrina") > 0):
            ...
            redmind @thinking "{w=0.25}.{w=0.25}.{w=0.25}."
...
oak "Happy Monday, everyone!"

play sound "audio/class_groan.ogg"

pause 2.0

oak "Yes, well, I suppose no-one's {i}really{/i} a fan of Mondays. In any case, your first week is over, and I shan't be coddling you any further! I expect everyone to be prepared for the test this afternoon."

oak "For now, though, it's about time we address the Copperajah in the room of symbiotic evolutions. Magneton, Wugtrio, and Metagross are examples. In order to..."
