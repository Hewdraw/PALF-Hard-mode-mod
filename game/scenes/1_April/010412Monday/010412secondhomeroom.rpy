...
oak "...And that's why we use 'levels' as a general demarcator of a Pokémon's strength!" 
oak "With mass amounts of education and memorization, very educated individuals are able to just tell what a Pokémon's level is at a glance, but most people use Pokédexes for that task."

redmind uniform @thinking "I mean, I would have, if you let me..."

oak "Now, I hope no-one's forgotten about the quiz I promised all of you! Let's get right into it."
...
whitney @surprised "I mean... I've sat in front of you for, like, a week now."
...
oak "There's one important thing to remember for this quiz: {color=#0048ff}your opponent has the ability 'Dry Skin!'{/color} Now, with that information, you have everything you need to succeed."
...
if (WonBattle("Oak2")):
    ...
    oak "I recommend everyone brush up on the immunities a Pokemon may possess. If all your other moves will have no effect, even a move that is resisted twice is your best option."

oak "Remember, immunities can come from more than just a Pokemon's type." 
oak "Grass-types are immune to many grass-based status moves, Dark-types are immune to the status moves of Pokémon with Prankster, and other types are immune to status conditions outright."
...
if (not persondex["Leaf"]["Contact"]):
    ...
    red @thinking "Alright, it's pretty much time to head back to bed, I reckon."
    ...
    red @confusedeyebrows frownmouth "..."

    pause 1.0

    leaf @talkingmouth "You're no fun.{w=0.5}{nw}" 
    leaf @talking2mouth " Anyway, I just wanted to give you my phone number. Can't believe I haven't already, actually."
    ...
    leaf @flirt "It's cool. My ninja skills mean I won't get caught."
