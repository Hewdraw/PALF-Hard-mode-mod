...
red @thinking "Man, being an actress sounds complicated. And you're a trainer on top of that?"
...
$ trainer2 = Trainer("rosa", TrainerType.Enemy, [Pokemon(25, level=7, nature=Natures.Timid, gender=Genders.Female, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Nuzzle"), GetMove("Thunder Shock"), GetMove("Quick Attack"), GetMove("Thunder Wave")], ability="Static")])#Pikachu

call Battle([trainer1, trainer2], uniforms=[True, True]) from _call_Battle_12 
$ gymbattles["Rosa1"]  = _return
...
rosa @happy "Oh, really? That's weird, but it's a good gimmick! Audiences love those. Anyway, yeah, I got this sweetie when I was touring Alola to promote {i}Hot, Wet Bikini Summer{/i}."
...
red @thinking "So your Pikachu isn't your school-assigned starter?"
...
red @thinking "...You did come here to learn how to be a Pokémon trainer, right? Not to promote a film?"
