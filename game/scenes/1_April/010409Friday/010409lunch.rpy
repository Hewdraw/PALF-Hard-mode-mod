...
show brendan uniform at dissolvein:
    xpos 1.0/7.0
show may uniform at dissolvein:
    xpos 2.0/7.0
show ethan uniform at dissolvein:
    xpos 3.0/7.0
show leaf uniform at dissolvein:
    xpos 4.0/7.0
show serena uniform at dissolvein:
    xpos 5.0/7.0
show calem uniform at dissolvein:
    xpos 6.0/7.0
...
leaf @talkingmouth "So, how're classes treating you, [first_name]?{w=0.6}{nw}"

extend @flirt " Ready to crack yet?"
...
menu:
    "It's all right.":
        ...
        leaf @flirtbrow talking2mouth "...That was so cliché. Spoken like a real square."
        ...
        leaf @happybrow talkingmouth "I can, and I will.{w=0.5} Everyone has opinions, [first_name], but some are more fun to listen to than others!"
    ...
    "I can't take it anymore!":            
        ...
        leaf @talkingmouth "Uh, aren't you being just a little melodramatic?"
        ...
        leaf @closedbrow talkingmouth "You three are a real piece of work."
    ...
    ">Flatter Leaf to dodge the question.":            
        ...
        leaf @talking2mouth "Aw, I had no idea you thought of me like that!{w=0.5}{nw}"
        
        extend -surprisedbrow @happy " You really think so?"
        
        brendan @angrybrow talkingmouth "Hey! You can't just dish out compliments like that!{w=0.5} That's just...{w=0.25} weird!{w=0.25} You're weird, man!"

        may @sadbrow happymouth "I wouldn't mind if you did that to me every once in a while."

        brendan @surprised "Really?{w=0.5}{nw}"
        extend @thinking " Then...{w=0.25} I guess it's fine."
        
        serena @sadbrow happymouth "Ah... Brendan, you can be a bit clueless, can't you?"

        calem @thinking "So... did anyone actually catch how [first_name] felt about his classes, or...?"
    ...
    "This school is too easy for a genius like me!" if getGrade() >= 1:
        ...
        leaf @surprisedbrow talking2mouth "You're serious?"

        calem -surprised @closedbrow talkingmouth "Oh, yes, he's quite serious. I can vouch for him. His ability to memorize is impressive."
        ...
        serena -surprised @surprisedbrow talkingmouth "Oh! [first_name], I did not realize that you were so studious. I'm quite glad."
        leaf @talking2mouth "Wow, I'm impressed.{w=0.5}{nw}"
        extend @flirt " I never took you for a bookworm, [first_name]."
        ...
        leaf @flirtbrow talkingmouth "Let's not get too ahead of ourselves, skippy."
...
leaf sad "{cps=15}You... you have other friends?{/size}"
...
leaf angrysmilemouth "Other friends! Really. Really! My-- oh, geez--"
leaf happy "Ah, sorry, hahaha! I can't keep that up! God, I'm hilarious!"

red @thinking "A real knee-slapper you are."
...
if (persondex["Skyla"]["Value"] > 0):
    $ morefriends += "Skyla, "
if (persondex["Brawly"]["Value"] > 0):
    $ morefriends += "Brawly, "

show leaf surprised with dis

red @thinking "Hm... well, there's Hilda, Bianca, Hilbert, Whitney, Flannery, Nate[morefriends]and Rosa. Oh, and Silver."

ethan "Dude. You've been here five days."

brendan @thinking "I mean... maybe he's just bein' a bit loose with his definition of friend?"
...
leaf -surprised @happy "Oh, yeah, that's it, duh! I mean, have any of those, like, {i}dozens{/i} of names made an Official Friendship Pact{font=fonts/consola_0.ttf}™{/font}?"

red @thinking "...Nnnno?"

leaf @flirt "Then they don't count. Not friends, sorry. Those are the rules."

red @thinking "Damn. Guess I've never had any friends, ever, then."
...
leaf @angrybrow angrysmilemouth "We'll see about that."
...
brendan @talking2mouth "Huh? Yeah, Ethan?"

ethan "Do you know how he's doing that?"

brendan @surprisedbrow talking2mouth "Doin' what?"

ethan "Like... all those people. He makes friends so easily. And we've got a lot in common, y'know? So I should be able to do it, too." 
ethan -sad @talking2mouth "But... I dunno. It kinda feels like he's got something I don't."
...
brendan @talkingmouth "Are you callin' me 'big man' because you forgot my name?"

ethan @thinking "Yes, absolutely. Sorry."
...
ethan thinking "It can't just be a coincidence, right?"
...
show leaf uniform:
    alpha 0.0 xpos 0
    pause 0.2
    ease 1.25 alpha 1.0 xpos 4.0/7.0

show serena uniform happy behind leaf:
    alpha 0.0 xpos 0
    ease 0.5 alpha 1.0 xpos 3.0/7.0

show ethan uniform happy behind leaf:
    alpha 0.0 xpos 0
    pause 0.25
    ease 1.0 alpha 1.0 xpos 1.0/7.0

show brendan uniform behind leaf:
    alpha 0.0 xpos 0
    pause 0.3
    ease 1.5 alpha 1.0 xpos 2.0/7.0

show may uniform behind leaf:
    alpha 0.0 xpos 0
    pause 0.5
    ease 1.25 alpha 1.0 xpos 5.0/7.0
    
show calem uniform behind leaf:
    alpha 0.0 xpos 0
    ease 3.0 alpha 1.0 xpos 6.0/7.0
...
red "What about you, May?{w=0.5} Is Hoenn anything like Kobukan?"

may @thinking "Hmmm...{w=0.5}{nw}"
...
leaf "All right then, let's take advantage of the green Kobukan {i}does{/i} have and find a nice picnic spot!"

brendan @thinking "Yeah... about that."
...
brendan @talkingmouth "Most of the good spots are already taken, from the looks of it."
...
leaf @happybrow talking2mouth "Fwohohoho. There's an easy solution to this."
...
leaf "[first_name], try not to make any new friends while you're--"
...
ethan "Uh... I think he's going to be the one."

serena "Yes, the speed at which he ran was... astounding."
...
calem @thinking "Hm. Well, perhaps we should also fan out... but with slightly less enthusiasm."

may @happy "Yeah! I mean, clearly, he needs it more than us! Wonder what he's going to buy?"

brendan @thinking "New running shoes, maybe? The ones he wears everywhere are all old and have holes in 'em."
...
redmind ".{w=0.25}.{w=0.25}.{w=0.25}.{w=0.25}."
...
menu:
    ">Give Calem a call." if persondex["Calem"]["Contact"]:
        ...
        extend " And I see some of the benches. Made of wood, I think."

        calem @thinking "{i}Um, that... doesn't help.{/i}"
        
        calem @talkingmouth "{i}Which section are you in?{/i}"
        
        red @thinking "{size=28}{i}...Maybe I should've brought a map with me.{/i}{/size}"
    ...
    ">Give Brendan a call." if persondex["Brendan"]["Contact"]:
        ...
        brendan "{i}Yo, no way, [first_name]!{w=0.5} You're calling me up? Thanks! Guess you found a spot?{/i}"
        
        red "Yeah, it's nice and quiet here.{w=0.5} Let's get everyone here quick before lunch period ends."
        ...
        brendan @talkingmouth "{i}Uh, y'know...{w=0.5} you pretty much just described the garden.{/i}"
        
        brendan @talkingmouth "{i}You know which section?{/i}"
        
        red "{size=28}...Maybe I should've brought a map with me.{/size}"
    ...
    ">Give May a call." if persondex["May"]["Contact"]:
        ...
        may "{i}Oh, you're calling me, [first_name]?{w=0.5} Right, I forgot that you have this number! Then that means you found a spot?{/i}"
    ...
    ">Give Serena a call." if persondex["Serena"]["Contact"]:
        ...
        serena "{i}Oh, you're calling me, [first_name]?{w=0.5} Of course. I remember now, we exchanged information a while ago. Then, do I understand that you've found a spot?{/i}"
        ...
        red "{size=28}Man, my sense of direction is so poor I barely know which region I'm in.{/size}"
    ...
    ">Give Leaf a call." if persondex["Leaf"]["Contact"]:
        ...
        leaf "{i}Hehehe. You're calling me on my phone.{/i}"
        ...
        red "{size=28}I mean, I know I'm in the garden...{/size}"
...
erika sad "Please, stay away! I promise I have nothing worth stealing!{w=0.5} D-don't hurt me! It's too public here!"
...
erika sad "S-stay back! There's a professor right around the corner! And I have Pokémon!"
...
erika "You... {i}fell asleep{/i} reading {i}Pride's Pariah{/i}? One of the great romance novels of our time?"

red @happy "I mean, it's a great book, but, uh, doesn't have anything to do with Pokémon, y'know? I wasn't the best at school."

red @thinking "I was at the bottom of my class in Pallet, actually. So... yeah, I haven't done a whole lot of book-learnin'."

erika -surprised @sad "Oh, you're from Pallet Town? In Kanto?"

red @surprised "You know Pallet Town?"
...
redmind @thinking ".{w=0.25}.{w=0.25}.{w=0.25}I think I may have found my complete opposite. I'm from a tiny town, she's from the second-biggest city in Kanto." 
...
erika sad "Yes, you're right. I jumped to conclusions, and thought you were acting with wicked intent. I apologize."
...
red @thinking "Yeah. Like, the section we're in, or maybe how to get here from the main area?"

erika @sad "Oh... I'm afraid I don't know. I simply told the Professor I'd like a nap, and she brought me here."
...
kris "Sure is! How can I help you, kiddo?"

red @confusedeyebrows ".{w=0.25}.{w=0.25}.{w=0.25}{nw}"
extend @talking2mouth "Very funny. Where's the {i}actual{/i} Professor?"

show erika surprised
show kris surprised
with dis

pause 2.0

kris angry "Ex-{i}cuse{/i} me?"
...
kris @angrybrow talking2mouth "No, but my {i}doctorate{/i} does! Would you like me to bring you to my office and show it to you?!"
...
erika -surprised @talkingmouth "Er... this is Professor Cherry, my mentor."
...
kris -closedbrow "Alright, I'm over it. Yes, I'm a professor, and yes, I'm the youngest professor that Kobukan's ever had."
...
red @thinking "Ah... damn. Sorry, Doctor, I'd love to hear more about Ethan, but I've gotta find a place for the rest of my friends to eat."
...
red @surprised "Uh... despite my accent, I'm not actually a farmer. I don't know what those are."

kris @surprised "Oh. Right. 'Oran Berry' trees."

red @thinking "Oh, okay. I think I saw some signs pointing to the 'Oran Grove' a while back, so everyone else should be able to find their way here."

red @happy "Thank you very much, Doctor!"

kris @happy "Just 'Professor' is fine."

erika @sad "I'd like to, um, apologize again for jumping to conclusions."
...
red @surprisedeyes "I... guess that's one way to put it."
...
$ renpy.music.play("Audio/Pokemon/Cries/48.wav", channel="altcry", loop=None)

pause 1.0

ethan "Woah, what was that?"
...
may @thinking "Wait, wait, I know this one..."

brendan @happy "That's my girl!"

may @happy "Yeah, that's right! It's Venonat! I knew it had to be a bug type!"

brendan angrybrow happymouth "Race you to get it, babe?"

may angrybrow happymouth "You're on!"
...
leaf @talkingmouth "So, completely unrelated, you think the National Tournament this year's going to be an Academy sweep?{w=0.5}{nw}"
...
red @thinking "You're sounding a bit like Lance, there."

calem @surprised ".{w=0.25}.{w=0.25}.{w=0.25}Oh, dear, I am. Please excuse me. Old habits."
...
leaf @angrybrow angrysmilemouth "What, just 'cause she's young? The National Champion of Unova is, like, six."

ethan @talkingmouth "Twelve, actually."

leaf sarcastic "Oh, you {i}would{/i} know, wouldn't you?"

ethan @angry "Hey! What's that supposed to mean?"

show leaf -sarcastic with dis

red @thinking "Guys, focus up. What's this about a National Tournament?"
...
leaf @thinking "Basically, the Kobukan region isn't large enough to support a traditional eight-gym challenge. Four times a year, roughly every three months, everyone in Kobukan has a week to compete in the Quarter Qlashes."

red @thinking "Quarter Qlashes?"
...
leaf @talking2mouth "Yeah, so if you're a finalist in all four Quarter Qlashes in a year, you're allowed to participate in the National Tournament at the end of the year."

red @thinking "And the winner of that gets to fight the Champion for the title?"

calem @thinking "This year, the winner will just {i}become{/i} Champion. Kobukan's current Champion abdicated around this time last year."

red @thinking "Hm... just spitballing here, but has an academy student ever become Champion?"
...
leaf -blush flirtbrow bigblush @talkingmouth  "And, well, I know you've been waiting for this. That you {i}need{/i} this. So..."

redmind surprised "Wait, holy shit, what's she--"
...
red -surprised @thinking "Wait, no, Leaf, you didn't need to... I mean, I could tell you were joking."

pause 1.0

leaf sadbrow @talking2mouth "Hey.{w=0.5} It's alright. Just take it, okay?"

red @sad "...How? I mean, how did you...?"

pause 1.0

leaf @talking2mouth "Only someone who really needs it would have run {i}that{/i} fast."
leaf @talkingmouth "Besides... you never answered me when I asked if you could afford to evolve [pika_name] now."

red @sad "...I'm not too proud to reject this, but..."
red @thinking "I have to figure this out by myself. I rely on my friends too much already."

leaf @surprised "What? No, you don't."

red @sadeyes sadeyebrows frownmouth "I really do. You've never seen it before, but if I don't have someone backing me up, I just...{nw}" 
extend @thinking " shut down."
...
leaf @flirt "Well, I think you're probably safe. The only thing that could wipe out all your friends now would be, like, a meteor."

red @happy "I'll keep an eye on the forecast."

leaf @talkingmouth "Alright. So what are you going to spend that money on? Maybe you could get some new running shoes?"
