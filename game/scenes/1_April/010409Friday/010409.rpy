...
redmind uniform @thinking "Despite the bombshell yesterday, Old Man Oak seems as casual as ever. I guess he figures his part in this is done, now. He's just waiting for the data to roll in... "
oak "Now, does anyone remember what the reading said about the origins of Fairy-type Pokémon? [first_name], it looks like you're paying attention! Why don't you give it a stab?"
redmind @surprised "Oh, crap! What did he just say? Something about the reading, and Fairy-types? Ugh, what should {i}I{/i} say?"

menu:
    "{color=#66b77d}[[Knowledge] >Just recite the entire reading.":
    ...
    "{color=#60c2f8}[[Wit] >Give a vague, but correct, answer.":
