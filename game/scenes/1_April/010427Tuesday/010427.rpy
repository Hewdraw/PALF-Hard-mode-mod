...
calem @closedbrow "Voters simply won't get excited over values, or... {w=0.5}{nw}"
...
grusha @sadbrow "Seems like a lot of work. We'll all get voted in, anyway, even without trying to raise awareness of the election. What's the point of bringing in more people who might vote against us?"
...
grusha @closedbrow "Can we {i}move on{/i}? Thanks."
...
grusha @closedbrow "Yeah. What Jasmine said."
...
grusha @closedbrow "...Sounds like a lot of fuss.{w=0.5}{nw}" 
...
menu:
    ...
    "Grusha.":
        ...
        grusha @closedbrow "...Yeah, Calem's way of pitching it as an international tournament sounds pretty cool."
...
menu:
    "{color=#b7669e}[[Charm] If you're not, I'll hang them up for you two.":
        $ TraitChange("Charm")

    "{color=#60c2f8}[[Wit] If you're not, we can hang them.":
        $ TraitChange("Wit")
...
cheren @sadbrow "I'm withdrawing my presidential candidacy. The positions I held before anyone else have either been cannibalized by my future council mates, or forbidden by the administration."
...
cheren @sad "What, then, can I possibly do? Is my legacy to Kobukan to increase the toilet paper to four-ply and nothing else?"
...
hilbert @closedbrow "Two-thirds. The opposite of three halves."
