...
oak "...Seems I'll have to cut this lecture short. Remember! Positive changes go on the numerator. Negative on the denominator. Dismissed!"
...
leaf @closedbrow talkingmouth "Yeah. Um... look. I've got a question for you."

red @talkingmouth "Shoot."

leaf @talking2mouth "...Well, uh, maybe we could go somewhere else to discuss this?"

red @confusedeyebrows frownmouth "{w=0.5}.{w=0.5}.{w=0.5}."
red @happy "Yeah, sure, I get ya. How's the garden?"

leaf @talkingmouth "Yeah. Okay. Let's go."
...
leaf @talkingmouth "Hah, no. Not this time. I mean, unless you ask for it?"
...
leaf -surprised @closedbrow talking2mouth "Yeah... okay. Okay, I'm doing this."

pause 1.0

leaf @talking2mouth "So, like, are you dating anyone?"

if (GetRelationship("Nessa") == "Friend"):
    red @talkingmouth "Yeah, actually. Nessa. Maybe you've heard of her?"

    leaf @thinking "Yeah, I've heard of her. She's a model, right? Galarian, so she's got that sexy accent? {i}And{/i} she's rich?"

    red @talkingmouth "Yep, that's the one."

    leaf @talkingmouth "Great. Well, she's an option, then. Um, is it serious?"
    ...
    leaf @thinking "Okay, great. Because that was going to make this conversation way more awkward."
...
leaf @talkingmouth "So, uh, you probably noticed, because I haven't exactly been subtle about it...{w=0.5} but, um...{w=0.5} I kinda like you, and, uh..."
...
red @thinking "Sorry. Just thinking about what to say."
...
menu:
    "Yes. Let's go on a date.":
        ...
        leaf @talkingmouth "If I'd known how easy you were going to make this, I would've asked way earlier."

        pause 1.0

        leaf @closedbrow "I mean, I was hinting pretty heavily... but I guess you can't help being a guy."

        red @confusedeyebrows talking2mouth "Leaf, I totally got your hints. I was returning fire the entire time."

        leaf @talkingmouth "Yeah... well...{w=0.5}{nw}"
        extend @closedbrow talking2mouth " I don't have a comeback for that."

        red @thinking "Who says we need a comeback?"

        pause 1.0

        red @talkingmouth "So what does this make us?"

        leaf @thinking "Um. Dating. Just dating, I think."

        leaf @talkingmouth "It might become something more, later, but, like, we don't even know what each other's dealbreakers are."

        red @confusedeyebrows "Uh, yeah, I'm going to need to know which way you put the toilet paper before we do anything serious."

        leaf @talking2mouth "Yeah, and you better close the toilet lids before you leave the bathroom."

        red @talkingmouth "Do you take decaf or full-caff coffee?"

        leaf @thinking "Are you going to want a motorcycle? Guys always want motorcycles."
        ...
        if (hascyclizar):
            ...
            leaf @talkingmouth "Alright. As long as I get a minivan."

        leaf @talking2mouth "Well... that's, um... that's great. I'm really happy that you think I'm cool enough to hang out with."
        ...
        leaf @talkingmouth "Cool. I know you're super busy with your Student Council stuff, and the elections are Saturday, so Sunday should be a nice break from all that."

        leaf @flirt "I'll be expecting you to plan our future dates, though."

        red @surprised "Woah. You're already planning future dates? What if I totally blow the first one?"

        leaf fullblush @talkingmouth "Confession time. I, uh... I actually considered that trip into the fields our first date. And the shopping trip, too."

        red @confused "Huh."

        leaf @talkingmouth "You should try going on dates with people who don't know you're going on a date with them. It's pretty great. All the fun, none of the obligation."

        red @thinking "I think that might be called 'stalking?'"

        leaf @talkingmouth "Well, that's for the jury to decide."

        pause 0.5

        leaf @talking2mouth "Hey. I think this'll be really great. For us, I mean."
    ...
    "No. Sorry.":
        ...
        leaf sadbrow frownmouth -surprised @surprised "Is it... is it the snark? I can tone down the snark. Really. That's {i}not{/i} a mandatory part of my personality."

        red @happy "Nah. I don't want you to change anything about yourself."

        leaf @sadbrow talkingmouth "Well. Um. I... I don't really know what to do."

        leaf @thinking "I've...{w=0.5} I've never gotten rejected before, so...{w=0.5} um...{w=0.5} I just...{w=0.5} I just need to...{w=0.5}"
        ...
        leaf @talkingmouth "Okay, so, obviously, I'm really disappointed. But you're still an awesome guy, and a good friend."

        if (GetRelationship("Leaf") == "Bestie"):
            leaf @talkingmouth "We're besties. {i}Besties.{/i}"

        leaf @talkingmouth "I'm not going to mope around and ruin that. So... yeah."
        ...
        leaf @talkingmouth "So. I accept your rejection. For now."

        red @talkingmouth "Uh... thanks?"

        leaf @thinking "Yeah, you're welcome. But I want you to know I'm going to work on you. And the next time I ask, it won't be {i}your{/i} decision."

        red @thinking "...Well, I can't say I hate the thought of you working so hard on me. But... don't overdo it, alright? Friends {i}is{/i} enough."
        ...
        leaf @talking2mouth "Now, I'm off. Got some plans to make."

        leaf @flirt "And, yes, you're involved in at least half of them. I'm in hot {color=#0048ff}pursuit{/color}."
    ...
    "I'm interested in someone else." if (not someoneelse):
        ...
        leaf @talkingmouth "I figured. I mean, a guy like you, you've got to have tons of options, right? Besides Tia, I'm sure there are other girls who are into you."

        pause 0.5

        leaf @thinking "Probably a few guys, as well."

        pause 0.5

        leaf @talkingmouth "But, look, that doesn't matter to me."

        red @surprised "Huh?"

        leaf @talkingmouth "Look, in fifth grade, I had two boyfriends, okay? I'm used to this. We'll start out with casual dating, and if we decide to move to something more permanent, then... we'll discuss it with the others. Okay?"

        red @thinking "I think you're deciding things for yourself again. Also... I've never even had a partner before. Besides [pika_name], anyway. I'm not sure I want to jump feetfirst into the water like that."
        ...
        red @thinking "I guess. I just always had this mental image that someday I'd marry a girl, buy a house with a white-picket fence, and have four kids."
        ...
        red @thinking "But I guess that mental image has gotten a bit fuzzier ever since I realized I like guys, too. Maybe there's more people in that house than I thought."
