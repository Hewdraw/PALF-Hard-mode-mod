...
brendan @thinking "I dunno, man. I don't think it's {i}that{/i} obvious."

hilbert @angry "That's because you're an imbecile."

brendan @sad "I know, man, but I'm trying..."

ethan @happy "Hey, how come Janine isn't asking me to try out for the Battle Team, then?"
...
hilbert @closedbrow "I'm not sure about that, either."
...
oak "And that's how the Pokémon league of Alola got started! The vacant Champion position has been much desired by many from other regions, but no-one, as of yet, has been able to defeat the Elite Four."
oak "Though the denizens of Alola are likely too busy dealing with their invasive species problem to mount a serious league attempt at this current time."

pause 1.0

oak "The last few years, as a whole, actually have been marked by a notable uptick in strange activity worldwide. Thank goodness none of that has spilled over into our own Kobukan!"
oak "Perhaps it's our isolation, or small size, but the sorts of disasters and cataclysmic events that have been growing more and more common seem as though they intend to leave this place alone."
oak "But perhaps I shouldn't tempt fate. That'll be all for today's lesson!"
