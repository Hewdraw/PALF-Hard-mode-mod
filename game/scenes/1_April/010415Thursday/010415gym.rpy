...
alder "And that's why Dracovish is such a common threat in competitive battling circuits!"
...
red uniform @thinking "Huh, Cheren again, so soon? Alright."
...
cheren @thinking "And Professor Samuel Oak has asked me to visit him in his laboratory after school today, so I'm afraid as to what that might entail."
...
red @sadeyes sadeyebrows talkingmouth "Sounds scary. But I'm sure it's nothing. I actually know Old Man Oak, and he's a great guy. He probably just wants to let you know he supports you."

cheren @disappointed "So fervently do I wish for that to be the case."
cheren @smilemouth "But the time to talk about that is not now. Are you ready to battle, [first_name]?"

red @happy "Born ready!"

$ trainer1 = Trainer("red", TrainerType.Player, playerparty)
$ trainer2 = Trainer("cheren", TrainerType.Enemy, [cherenpurrloinobj])

call Battle([trainer1, trainer2], uniforms=[True, True]) from _call_Battle_17
$ gymbattles["Cheren2"]  = _return
...
if (WonBattle("Cheren2")):
    cheren @thinking "An expected outcome, but a well-deserved victory."
...
cheren @thinking "Certainly. I am amongst the top students for both my electives."
...
cheren sad "That is a fair point."
...
cheren @thinking "Yes, Sir. Apologies for my brusqueness earlier, Sir."
...
cheren @thinking "{size=25}Even so, that's only four days... I doubt even Blue could train hard enough to get me combat-ready in that amount of time... Hm.{/size}"
