...
oak "...And that concludes today's lesson! Now, I hope you all prepared for the quiz. Be ready for this!"
...
oak "It is not my intention to fail any of you. The quizzes will get harder as the school year progresses--if you find them 'too easy' now, take that as a gift."
...
oak "You all know what to do. Take a close look at the battlefield before you commit to {i}anything{/i}!"
...
oak "That's it for today, class.{w=0.5} You're all dismissed."
...
leaf @talking2mouth "Nah, go ahead. I'll get changed too. Meet you at the field?"
...
leaf @thinking "Huh? Complimenting you? All she {i}ever{/i} does is rant about how Dragon-types are the best."
...
red @thinking "Uh... yeah, I can see why there would be some mixed feelings there."
...
flannery @closedbrow talkingmouth "{i}Ahem.{/i}"
...
whitney "Wait... it's that easy for you?"

red @confusedeyebrows happymouth "Uh... yeah, why?"
...
flannery @closedbrow tiredmouth "Whitney..."
...
if (WonBattle("Absol1")):
    red @thinking "It was an Absol, actually."
else:
...
leaf @angrybrow angrysmilemouth "Can it, sweetheart."

tia -happy frownmouth @angry "Hey!"

leaf @talkingmouth "Enough beating around the bush. Who is she?"
...
red @thinking "Her ID said she was."
...
leaf angrybrow angrysmilemouth "Why were you looking at her ID?"

red @thinking "Uh... I was just confused as to her name. I didn't know the whole Bianca-Tia thing she just explained."

leaf thinking "Hrmph. Well, did you come here to tell the meteor maid not to wake up Flannery and Whitney?"
...
red @thinking "Hey, it's alright. Just, y'know, if we could {i}all{/i} do our best to not let anyone else know about her, I think that would be... safest. Especially faculty."
...
red @thinking "Can't do a three-way battle, though."
...
gardenia "Alright, so Flannery and I against you two? Cool. How much are you potting?"
...
gardenia @surprised "Holy-- no, no way, man. I can't do that. Like, I cap out at 5. Gotta be prepared to lose."

leaf @thinking "Oh. Well, we'll both put in $5,000, then."

red @talkingmouth "{size=25}Uh, Leaf? You know I can't afford that.{/size}"

leaf @happy "{size=25}Relax. We won't lose.{/size}"

red @talkingmouth "{size=25}And... if we do...?{/size}"

leaf @thinking "{size=25}I'll cover you. Don't worry about it.{/size}"

red @talking2mouth "{size=25}Look, I don't want to take handouts from my friends...{/size}"

leaf @flirt "{size=25}Then you better not lose!{/size}"
...
$ gardeniabudewobj = Pokemon(pokedexlookupname("Budew", DexMacros.Id), level=12, nature=Natures.Timid, gender=Genders.Female, moves=[GetMove("Mega Drain"), GetMove("Stun Spore")], ivs=[24, 24, 24, 24, 24, 24], ability="Poison Point")
$ gardeniaphantumpobj = Pokemon(pokedexlookupname("Phantump", DexMacros.Id), level=12, nature=Natures.Adamant, gender=Genders.Male, moves=[GetMove("Leech Seed"), GetMove("Confuse Ray"), GetMove("Branch Poke"), GetMove("Astonish")], ivs=[24, 24, 24, 24, 24, 24], ability="Frisk")

$ flannerynumelobj = Pokemon(pokedexlookupname("Numel", DexMacros.Id), level=12, nature=Natures.Modest, gender=Genders.Male, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Growl"), GetMove("Ember"), GetMove("Bulldoze")], ability="Own Tempo")
$ flanneryonixobj = Pokemon(pokedexlookupname("Onix", DexMacros.Id), level=12, nature=Natures.Brave, gender=Genders.Female, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Smack Down"), GetMove("Dragon Breath"), GetMove("Bind"), GetMove("Rock Throw")], ability="Sturdy")
...
$ trainer3 = Trainer("flannery", TrainerType.Enemy, [gardeniabudewobj, gardeniaphantumpobj])
$ trainer4 = Trainer("gardenia", TrainerType.Enemy, [flannerynumelobj, flanneryonixobj])

call Battle([trainer1, trainer2, trainer3, trainer4]) from _call_Battle_19
$ gymbattles["FlanneryGardenia1"] = _return

if (WonBattle("FlanneryGardenia1")):
    show flannery sad at midrightside
    show gardenia sad at rightside behind flannery
    ...
    leaf "Good job, [first_name]! Bringing home the bacon!"

    flannery "Aw... there goes my shopping weekend."

    gardenia "Ugh. I'm going to need to pick up some new clients."

    gardenia -sad @talkingmouth "Fun battle, though. Just don't ask for another one anytime soon. Here's your moolah."
    flannery -sad @tiredmouth closedbrow "Yeah... take this."

    play sound "audio/Get.ogg"

    $ money += 10000

    narrator "You and Leaf both get $10,000!"
    ...
    leaf -sad @talkingmouth "Ugh. Alright. It's only $10,000. I'll be fine. I'll just have to buy a bit less this weekend..."

    red @talkingmouth "{size=25}I really don't mind paying my share, Leaf.{/size}"

    leaf @sarcastic "{size=25}With what money? I'll cover you.{/size}"

    gardenia "Sorry you guys lost, but I had a {i}great{/i} time!"
    flannery "Yeah, this was really fun!"
...
leaf @flirt "I'll talk to you all later!"
