...
oak "Welcome back to class, ladies and gentlemen!" 
oak "I can tell you're all very excited for the upcoming Battle Team tryouts happening later today, but remember that you have to pass a quiz first!"
oak "I hope you all remember what I said during homeroom this morning. 'If it's not 100%%, it's 50%%!" 
oak "You may think your strategy is undefeatable, but even the best trainer can be brought down by something as unlucky as missing Will-O-Wisp five times in a row."
oak "{color=#0048ff}In this upcoming battle, you'll be under the field effect 'Blinding Fog.'{/color}"
oak "That means, if a move has a chance to miss, it {i}will.{/i} Keep that in mind."
...
oak "Now, let's try to complete this test quickly! I don't want to be late to the Battle Team tryouts."
...
oak "Remember, even if a move has 100%% accuracy, if your accuracy has been lowered, you can still miss." 
oak "The same applies if your opponent's evasion has been raised."
...
oak "But I suppose you'll be able to see those maneuvers in battle in a few hours! I hope to see you all at the Battle Team Tryouts shortly! Dismissed!"
...
redmind -uniform @talkingmouth "Huh. Back here again. But now I'm standing in the arena. It looks even bigger from the bottom..."
...
red @thinking "Win? There's no, like, #1 winner, right? Isn't it just a 'you get in or you don't,' kind of thing?"
...
hilbert @sad "If you can't win without it, you don't deserve it."
...
hilbert @thinking "May the man with the most power win."
...
red @thinking "...Lots of people want to get in the Battle Team. I wasn't expecting so many people I recognized, to be honest..."
...
erika "Oh, hello, [first_name]!"

if (persondex["Erika"]["ClassesKnown"] == []):
    ...
    erika @thinking "Yes, it had originally been intended for me to simply attend Kobukan Academy in a provisionary role. I would not attend classes. Rather, I'd just participate in Battle Team activities."
    ...
    red @confusedeyebrows frownmouth "Uh-huh."
    ...
    $ KnowClasses("Erika", ["Grass", "Poison"])
    ...
    erika @thinking "Not so much. Rather, I'm much more interested in Grass-types' natural affinity towards sun-based strategies."
    ...
    erika @sad "I originally considered using Fairy-types myself, to counter dragons, but after seeing that awful Lance's horrid performance, I don't think they're nearly as much of a threat as they used to be."
    ...
    red @thinking "So how come you don't like Lance? I mean, he {i}is{/i} a two-time national Champion."
    ...
    erika @thinking "It would have been one thing if he'd simply tried multiple times to become Kanto Champion, but then he further embarrassed us by failing multiple times to become Johto Champion."
    erika @sad "And now he's set his eyes on failing multiple times to become World Champion, so it doesn't seem he's planning on ending that pattern of behavior any time soon."
    erika @happy "As a noted author once said, 'Is it not better to surrender your ambitions than have them slaughtered?'"

    red @thinking "Hm. I've got my problems with him, but trying over and over to achieve his goals isn't one of them."

    erika @thinking "Oh? Well, I suppose we have different priorities, then."
...
lance "The slate looks promising.{w=0.5} With a few exceptions."

blue "Doubt me all you want! I'm gonna be so good you {i}can't{/i} turn me down!"

lance @talkingmouth "Your ego continues to appoint you the center of attention. I was not thinking of, or referring to you."
...
janine @closedbrow talkingmouth "Enough of this, already. We're about to find out whether I never have to see you again, or whether you're my problem for the next year. Just hold it in 'til then."

pause 1.0

janine @talkingmouth "Shall we go over the rules?"

lance @thinking "Mm."

janine @talkingmouth "Alright, everyone! These will be full-party double battles. Any Pokémon you have on-hand are permitted to be used."

lance @angry "{i}Borrowed Pokémon will not be.{/i}"

janine @talkingmouth "{size=25}Sir, we've already said we're not going to do that.{/size}"

lance @talkingmouth closedbrow "You have gone behind my back once already. You will not do so again."

janine @talkingmouth "Right. Anyway, back to the rules... the use of items, used by trainer or Pokémon, is not permitted."

hilbert surprised "...What? I... my Pokémon only know one move. Choice Items would work so well with that strategy... and I just went to the city, and... so much money..."

show erika surprised with dis

silver surprised "H-huh?! But I've got a ton of berries, and... {i}shit.{/i}"

erika surprised "B-but... my strategy heavily depends on the usage of items..."

janine @talkingmouth "Also, this is going to be a level-equal battle. All your Pokémon will be scaled to level 50."

show leaf surprised with dis

blue surprised "What?! No-one told me about this! That's not fair, my levels are way higher than everyone else here!"

leaf surprised "Wh-what?! But my secret weapon... I was going to use Dragon Rage, and just sweep everyone! You can't do that!"

janine @talkingmouth "Any questions?"
...
blue "Yeah, what the hell's up with this ruleset?"

leaf "You're just banning everything! You've ruined {i}everyone's{/i} battle plans!"

janine @talkingmouth "A serious battle does not give you the luxury of your preferred ruleset."
...
lance @talkingmouth "This tryout will take place as a series of seven round-robin matches. You will be fully healed between battles. Besides the aforementioned rules, no other clauses will be enforced."
lance @closedbrow talkingmouth "Winning all your matches does not guarantee a spot in the Battle Team. Losing all your matches does not guarantee elimination."
lance @angrybrow talkingmouth "Though it does make it {i}far more likely.{/i}"

pause 1.0

lance @talkingmouth "The order of your opponents will be picked randomly."
...
lance @talkingmouth "That's enough. Let's begin. Janine, read out the beginning matches, please."

janine @talkingmouth "Hold on, Sir. I think we should give everyone five minutes, in case they need to make changes to their teams, now that they've heard the rules."
...
janine "Wh-what are you {i}doing{/i} here?! Are you okay? Where have you been? When did you get back? How--"
...
sonia "I know, and I'm {i}so{/i} sorry. But I won't let you down again, I promise!"

janine @angry "Yeah! You won't let me down again, because like {i}hell{/i} I'm letting you back on the team!"

sonia "B-but... I promise I won't lose this time!"

janine "I don't even care that you lost! I care that you ditched us without telling {i}anyone!{/i} How am I supposed to trust that you'll stick with the team this time?"

sonia @sad "Please!"

janine "No!"

sonia @talkingmouth "But... but, then..."
...
sonia "Sir! I'm so sorry for what happened. I panicked, and made an awful mistake, and I... I just want another chance, Sir! I'll do anything!"

lance @thinking "{w=0.5}.{w=0.5}.{w=0.5}."

sonia "A-anything... Sir... Please.{w=0.5} I {i}promise{/i} I won't let you down again."

pause 1.0

lance -closedbrow @talkingmouth "...I have no objections."

show janine angry:
    ypos 0.7
    ease 0.3 xpos .51

janine "Sir! How can you say that?!"

lance @closedbrow talkingmouth "Failure is not the mark of a bad trainer. Giving up is."
...
lance @talkingmouth "Sonia has already demonstrated her worth in battle. I believe she can rejoin the Battle Team at her old rank."
...
janine @thinking "Sir. If I permit Sonia to {i}try out{/i} again... at the same level as everyone else..."

pause 1.0

janine @talkingmouth "You won't interfere with my choices for the Battle Team?" 
...
janine @closedbrow "I'm letting you apply. That's all. To me, you're a brand-new student again. We have no history, and I don't care if you get in or don't."
...
janine @talkingmouth "Alright, let's get this show on the road. We've got hundreds of battles to get through, so we'll be taking these ten at a time." 
janine @thinking "Spread out around the arena, give other battlers some room. Lance and I will be walking between the battles, and keeping an eye on you."

lance @talkingmouth "It goes without saying that if you do not have enough control over your Pokémon to avoid leaving your designated area, that will not reflect favorably on your chances."

janine @talkingmouth "Alright. Let's begin."
...
janine @talkingmouth "Alright. You're up."

python:
    trainerred = Trainer("red", TrainerType.Player, playerparty, number=2)

    #Leaf: A strong, normal team
    leafdratiniobj = Pokemon(pokedexlookupname("Dratini", DexMacros.Id), level=15, moves=[GetMove("Legacy"), GetMove("Dragon Rage"), GetMove("Twister")], nature=Natures.Jolly, ivs=[31, 31, 31, 31, 31, 31], evs=[1, 0, 1, 0, 1, 0], ability="Shed Skin", intelligence=1)
    leafbulbasaurobj.Moves = [GetMove("Bark Up"), GetMove("Sleep Powder"), GetMove("Leech Seed"), GetMove("Razor Leaf")]
    leafbulbasaurobj.Intelligence = 1
    leafbulbasaurobj.EVs = [1, 0, 1, 0, 1, 0]
    leafhelioptileobj.Moves = [GetMove("Energize"), GetMove("Thunder Shock"), GetMove("Quick Attack")]
    leafhelioptileobj.Intelligence = 1
    leafhelioptileobj.EVs = [0, 1, 0, 1, 0, 1]
    trainerleaf = Trainer("leaf", TrainerType.Enemy, [leafbulbasaurobj, leafhelioptileobj, leafdratiniobj], number=2)

    #Silver: A decently strong, normal team
    silverskorupiobj = Pokemon(451, level=13, gender=Genders.Male, moves=[GetMove("Knock Off"), GetMove("Poison Fang"), GetMove("Fell Stinger"), GetMove("Bad Breath")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, ability="Sniper")
    silverstunkyobj = Pokemon(pokedexlookupname("Stunky", DexMacros.Id), level=19, gender=Genders.Male, moves=[GetMove("Poison Gas"), GetMove("Acid Spray"), GetMove("Bite"), GetMove("Screech")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, ability="Aftermath")
    silvernidokingobj = Pokemon(pokedexlookupname("Nidoking", DexMacros.Id), level=16, gender=Genders.Male, moves=[GetMove("Sludge Wave"), GetMove("Earth Power"), GetMove("Megahorn"), GetMove("Double Kick")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Modest, ability="Sheer Force")
    trainersilver = Trainer("silver", TrainerType.Enemy, [silverskorupiobj, silverstunkyobj, silvernidokingobj], number=2)

    #Blue: One intelligent Pokemon
    bluepidgeottoobj.Moves = [GetMove("Wing Attack"), GetMove("Quick Attack"), GetMove("Twister"), GetMove("Pursuit")]
    bluepidgeottoobj.Level = 25
    bluepidgeottoobj.Intelligence = 1
    bluepidgeottoobj.EVs = [0, 1, 0, 1, 0, 1]
    bluepidgeottoobj.RecalculateStats()
    blueeeveeobj.Level = 17
    blueeeveeobj.Moves = [GetMove("Covet"), GetMove("Bite"), GetMove("Quick Attack"), GetMove("Swift")]
    blueeeveeobj.EVs = [0, 1, 0, 1, 0, 1]
    blueeeveeobj.Intelligence = 1
    blueeeveeobj.RecalculateStats()
    bluecharmanderobj = Pokemon(pokedexlookupname("Charmander", DexMacros.Id), level=10, nature=Natures.Timid, gender=Genders.Male, moves=[GetMove("Steady Flame"), GetMove("Dragon Rage"), GetMove("Dragon Breath"), GetMove("Ember")], ivs=[24, 24, 24, 24, 24, 24], evs=[1, 0, 1, 0, 1, 0], ability="Blaze", intelligence=1)
    trainerblue = Trainer("blue", TrainerType.Enemy, [bluepidgeottoobj, blueeeveeobj, bluecharmanderobj], number=2)

    #Erika: A fully intelligent team, but the *dumbest* movesets
    erikanidoqueenaobj = Pokemon(pokedexlookupname("Nidoqueen", DexMacros.Id), level=20, gender=Genders.Female, moves=[GetMove("Bad Breath"), GetMove("Double Team"), GetMove("Stealth Rock"), GetMove("Toxic Spikes")], nature=Natures.Bold, ivs=[24, 24, 24, 24, 24, 24], evs=[1, 0, 1, 0, 1, 0], ability="Poison Point", intelligence=1)
    erikaglimmetobj = Pokemon(pokedexlookupname("Glimmet", DexMacros.Id), level=20, gender=Genders.Female, moves=[GetMove("Bad Breath"), GetMove("Spikes"), GetMove("Stealth Rock"), GetMove("Toxic Spikes")], nature=Natures.Timid, ivs=[24, 24, 24, 24, 24, 24], evs=[1, 0, 1, 0, 1, 0], ability="Toxic Debris", intelligence=1)
    erikavileplumeobj = Pokemon(pokedexlookupname("Vileplume", DexMacros.Id), level=21, gender=Genders.Female, moves=[GetMove("Bark Up"), GetMove("Leech Seed"), GetMove("Bad Breath"), GetMove("Protect")], nature=Natures.Calm, ivs=[24, 24, 24, 24, 24, 24], evs=[1, 0, 1, 0, 1, 0], ability="Effect Spore", intelligence=1)
    trainererika = Trainer("erika", TrainerType.Enemy, [erikanidoqueenaobj, erikavileplumeobj, erikaglimmetobj], number=2)
    ...
    for mon in playerparty:
        if (mon != pikachuobj):
            ...
            ethanteam.append(Pokemon(pokedexlookupname("Pichu", DexMacros.Id), level=mon.Level, ivs=[1, 1, 1, 1, 1, 1], evs=[0, 0, 0, 0, 0, 0], moves=copy.deepcopy(mon.Moves), gender=Genders.Female, ability="Small World", intelligence=1))
    trainerethan = Trainer("ethan", TrainerType.Enemy, ethanteam, number=2)

    #Hilbert: Same gimmick as before
    hilbertsnoruntobj.Moves = [GetMove("Icy Wind")]
    hilberthonedgeobj.Moves = [GetMove("Shadow Claw")]
    trainerhilbert = Trainer("hilbert", TrainerType.Enemy, [hilbertcubchooobj, hilbertsnoruntobj, hilberthonedgeobj], number=2)
    ...
    soniayamperobj = Pokemon(pokedexlookupname("Yamper", DexMacros.Id), level=20, moves=[GetMove("Thunder Fang"), GetMove("Crunch"), GetMove("Nuzzle"), GetMove("Fire Fang")], nature=Natures.Adamant, ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], ability="Rattled", intelligence=1)
    soniadedenneobj = Pokemon(pokedexlookupname("Dedenne", DexMacros.Id), level=14, moves=[GetMove("Charge Beam"), GetMove("Dazzling Gleam"), GetMove("Trailblaze"), GetMove("Parabolic Charge")], nature=Natures.Timid, ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], ability="Cheek Pouch", intelligence=1)
    soniasnubbullobj = Pokemon(pokedexlookupname("Snubbull", DexMacros.Id), level=23, moves=[GetMove("Play Rough"), GetMove("Ice Fang"), GetMove("Wild Charge"), GetMove("Crunch")], nature=Natures.Adamant, ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], ability="Intimidate", intelligence=1)
    trainersonia = Trainer("sonia", TrainerType.Enemy, [soniayamperobj, soniadedenneobj, soniasnubbullobj], number=2)
...
janine @talkingmouth "You'll be facing off against [selectedtrainername]."

if (selectedtrainer == trainerleaf):
    janine @talkingmouth "You should be fine. The level equalizer means her Dragon Rages aren't nearly as much of a threat."

    red @talking2mouth "Good to know."

elif (selectedtrainer == trainerblue):
    janine @talkingmouth "He's full of hot air. Just watch out for that Pidgeotto. He's got it listening to him now."

    red @surprised "Already?!"

elif (selectedtrainer == trainererika):
    janine @talkingmouth "She has no idea how to battle. She obviously spent a fortune on Move Tutors and TMs, but that doesn't make up for her movesets."

    red @thinking "Phew..."

elif (selectedtrainer == trainerhilbert):
    janine @talkingmouth "His Pokémon only have one move each. Without their choice items, they won't hit nearly as hard, but watch out anyway."
    ...
    janine @talkingmouth "Don't have any advice for this one. Just hit harder than he does."

    red @thinking "I'll do my best."
    ...
    janine @talkingmouth "This guy's Pokémon are weak, and so is he, but they all work together perfectly. Don't get careless."
...
call Battle([trainerred, selectedtrainer], gainexp=False, levelscale=50, specialmusic=(("audio/music/swordshieldgym-intro.mp3", "audio/music/swordshieldgym-loop.mp3") if len(potentialtrainers) == 6 else "Nothing"), stopmusic=False) from _call_Battle_46
$ result = _return
...
if (selectedtrainer == trainerleaf):
    $ gymbattles["Leaf1"] = result

elif (selectedtrainer == trainerblue):
    $ gymbattles["Blue3"] = result
    ...
    $ gymbattles["Erika1"] = result

elif (selectedtrainer == trainerhilbert):
    $ gymbattles["Hilbert2"] = result

    if (gymbattles["Hilbert2"]):
    ...
    $ gymbattles["Silver2"] = result

elif (selectedtrainer == trainersonia):
    $ gymbattles["Sonia1"] = result

elif (selectedtrainer == trainerethan):
    $ gymbattles["Ethan1"] = result
...
if (wins == 7):
    ...
    red @thinking "Wow... six out of seven? That {i}really{/i} isn't bad! I bet Lance won't be able to ignore that."
    
elif (wins == 5):
    red @thinking "Five wins? Well, at least I get a prize."
    
elif (wins == 4):
    red @thinking "Only four wins... well, it's more than half... but I need more than that to stand out."
    ...
    red @thinking "Only one win.{w=0.5} ...Damn."
    
elif (wins == 0):
    red @happy "Alright, managed to lose everything, nice! Losing against Erika was actually kinda tricky."
    red @thinking ".{w=0.5}.{w=0.5}.{w=0.5}Wait."
    red @sad "This isn't golf."

lance @talkingmouth "That's enough. We've seen everything we needed to."
...
lance @talkingmouth "Janine and I will make our final decisions shortly. If you are accepted into the Battle Team, we will contact you."
lance @talkingmouth "You may leave."
...
leaf frownmouth @talkingmouth "Sir, what about the prizes for winning?"

lance @talkingmouth "Those will be delivered directly to your dorms in the following days."
...
lance @closedbrow talkingmouth "No. The school insists I let non-Battle Team members watch the tryouts, but I would, personally, greatly prefer to do this entire event behind closed doors."
...
red @closedbrow frownmouth "...That's a bit anticlimatic."

blue "{size=25}Man, this is bullshit...{/size}"
...
janine @talkingmouth "Yeah. But you've got a lot more experience than everyone else."
janine @closedbrow talkingmouth "I wasn't expecting you to lose. I just need to know I can trust you again."

sonia frownmouth @talkingmouth "If you let me join the Team again, I'll prove to you that you can. I {i}promise.{/i}"

janine @closedbrow "{w=0.5}.{w=0.5}.{w=0.5}."

lance @closedbrow talkingmouth "Janine, I recommend you accept her. She was one of our top-performing battlers last year."

janine @talkingmouth "...I promised to let her try out. Nothing more."

lance @talkingmouth "You claimed she would be as a 'brand-new student' to you. Ignore your history."

janine @angry "Why are you pushing so hard to get her in?"

lance @talkingmouth "As I have said before. Her failure does not define her. It shows great courage to try again that which has once defeated you."
lance @angrybrow talkingmouth "I may well ask why you are pushing so hard to get Mr. [last_name] in."

janine @talkingmouth "His natural skill, Sir. I've explained this. If you were to just {i}give{/i} him a Dragonite, he would be practically unstoppable."

lance @talkingmouth "He has no talent. He has no experience. And his success comes not from effort, but from dumb luck."
...
lance @angrybrow talkingmouth ".{w=0.5}.{w=0.5}.{w=0.5}You do not get to speak."
lance @sadbrow talkingmouth "It did not escape my notice you brought your Pikachu to this tryout. You may think you're making some sort of statement, some sort of nonsense about 'fighting with your friends.'"

pause 1.0

lance @angrybrow talkingmouth "All I see is {i}arrogance.{/i} You cripple yourself, and lessen your chances, and for what? To attempt to prove to me the strength of an objectively inferior member of an objectively inferior species?"
...
lance -closedbrow @talkingmouth "Janine, leave us be for a moment."

janine @talkingmouth "Remember what you said, Sir. You wouldn't harass my picks."

lance @talkingmouth "Is this boy getting into the Battle Team, then? Despite my advice?"

if (wins > 5):
    lance @talkingmouth "Even though his performance was only 'acceptable?'"
elif (wins > 3):
    lance @talkingmouth "Even though his performance was poor?"
else:
    lance @talkingmouth "Even though, by all rights, his performance should instantly disqualify him from consideration."

janine @sad "Well... yeah."

janine @talkingmouth "I mean, he's rough, but this skill he has with Pokémon... there's {i}nothing{/i} I wouldn't give to get my hands on that."

lance @talkingmouth "Then let me say one more thing. To him. Alone."

janine sad "Sir..."

pause 1.0

janine @closedbrow talkingmouth "Fine. Just don't be too harsh on him."
...
lance @talkingmouth "So. It would seem I have failed to keep you out of my Battle Team."

red @talking2mouth "It would seem so, Sir."

pause 1.0

lance @closedbrow talkingmouth "People react to failure differently. Some admit they will never succeed. Some believe that success was impossible. Some blame others, or their situation. And some try again."

red @talking2mouth "Given what I know about your league attempts, I'm guessing you're in the 'try again' category?"

lance @talkingmouth "Hear me, [first_name]. You are young, foolish, have had everything handed to you, and have not yet tasted defeat."

red @talkingmouth "Hey, I--"

lance @talkingmouth "{i}True{/i} defeat. Not just 'losing a battle,' or 'failing a test.' But failing to fulfill a long-term goal. A {i}dream.{/i}"
lance @talkingmouth "When you do, it will break you, as a meteor does the earth. It will shatter your hopes and ambitions. You will want to cry, and hide, and separate yourself from anyone who knew your dream."
...
lance @talkingmouth "Then I may finally respect you."
...
hilbert @thinking "Five. Only five. The sixty-sixth percentile."
...
redmind @thinking "I wonder if Old Man Oak..."
