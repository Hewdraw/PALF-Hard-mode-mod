...
if (getElective(getRankStat(0)) < 9):
    $ hadproblem = True
...
if (not hadproblem):
    ...
    red @thinking "Well... what about my classes?"
...
if (GetRelationship("Hilda") == "Caretaker"):
    ...
    hilda @thinking "Yeah, you could say that. Copying my keys? Ironing my uniforms? Putting new de-scenter in my shoes?"
    ...
    hilda @thinking "How do you even know this stuff needs to be done?"
    ...
    hilda -angry @thinking "Oh, it's you..."
...
$ hildapawniardobj = Pokemon(pokedexlookupname("Pawniard", DexMacros.Id), level=12, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Metal Claw"), GetMove("Feint Attack")], item="Sitrus Berry", gender=Genders.Male, nature=Natures.Adamant, ability="Defiant")
$ trainer2 = Trainer("hilda", TrainerType.Enemy, [hildaaronobj, hildapawniardobj], number=2)

call Battle([trainer1, trainer2], uniforms=[True, True]) from _call_Battle_44
$ gymbattles["Hilda1"]  = _return
...
hilda @thinking "Hey, are you going to the Battle Team tryouts?"
