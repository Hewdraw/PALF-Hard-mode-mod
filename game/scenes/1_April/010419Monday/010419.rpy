...
red @thinking "Man. Being at Kobukan's my dream, but I definitely didn't hate Mondays until I got here. Better pull myself out of bed..."
...
calem @thinking "I must say, I'm surprised to see how seriously you took my advice. Very well done."
...
red @thinking "Posters probably would've been a better use of my time, come to think of it..."

calem @thinking "Well... that's odd."
...
calem -surprised @angry "Right, well, I'm not doing it for dramatic tension. I just find it difficult to explain exactly what I saw."
...
serena @thinking "It puts in one's face that you, [first_name], have picked up trash. Such a simple thing. A minor thing, even. But still, a thing."
...
calem @thinking "{i}These{/i} got up here. They're all over the campus."
...
red @thinking "Hm... is this what Silver meant when he said he'd help me get elected, then? I guess I'd better thank him during lunch."

"Befuddled Student" "\"I don't get this. Is this guy running a cleanliness campaign?\""

"Clean Student" "\"It's that guy who's running for Student Council, isn't it?\""
...
"Confused Student" "\"Yeah, wasn't his name [beter] [biffin] or something?\""
...
menu:
    "{color=#e226a6}[[Patience] >Wait to see what happens.":

        $ TraitChange("Patience")

        "Befuddled Student" "\"Well, if this guy {i}is{/i} running for Student Council, I like him more than that Cheren guy.\""
        
        "Clean Student" "\"Yeah. Raises for non-academic staff? I don't want to pay even more for tuition!\""

        "Confused Student" "\"Besides, he looks pretty down-to-Earth. I can dig a guy who isn't afraid to get his hands dirty picking up trash.\""

        stop sound channel "crowd" fadeout 1.0

        pause 1.0

        redmind @sadbrow "I really don't even have to try, huh...?"

    "{color=#b7669e}[[Charm] >Explain yourself to the crowd.":
        ...
        "Befuddled Student" "\"What're you going to do if you get elected then?\""
        
        "Clean Student" "\"Yeah. You're not going to give raises for non-academic staff, are you? I don't want to pay even more for tuition!\""

        red @thinking "I'm not sure that's something a Student Council member can even do, actually."

        red @happy "I'm mostly just running on the co-ed dorms and toilet paper issues."

        "Confused Student" "\"Well, I'd prefer if you paid more attention to the curfew lobby, but you look pretty down-to-Earth. I can dig a guy who isn't afraid to get his hands dirty picking up trash.\""

        "Befuddled Student" "\"Can't imagine Prince Cheren doing that, can you!\""
...
oak "Good morning, ladies and gentlemen! I know better now than to extoll the virtues of a 'happy Monday,' so I'll simply remind you all that you have a quiz this evening!"

play sound "audio/class_groan.ogg"

pause 2.0

oak "{size=25}Hm... so the students aren't fans of Mondays {i}or{/i} quizzes. Good to know. I should start a book on the matter...{size=25}"

pause 1.0

oak "Well, fan or not, it's time to begin class! We've got a lot of material to cover if we want you to be fully prepared for this evening's quiz." 
oak "The first thing we should discuss is {i}accuracy.{/i} Remember the old adage--if it's not 100%% accurate, it's 50%% accurate!"
