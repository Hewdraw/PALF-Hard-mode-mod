...
whitney "{cps=20}{size=26}W{/size}{size=28}W{/size}{size=30}W{/size}{size=32}A{/size}{size=34}A{/size}{size=36}AA{/size}{size=38}AA{/size}{size=40}AI{size=42}I{/size}{size=38}I{/size}{size=46}I{/size}{size=48}I{/size}{size=50}T{/size}{size=52}T!!{/size}{/cps}"
...
whitney "Sorry I'm late!" 
whitney -surprised @happy "Tia actually let us sleep last night, so I ended up catching up on three days' worth of beauty rest."
...
flannery "I... {w=0.5}hate... {w=0.5}mornings..."

leaf surprised "Geez, you're not looking so good, Flan. Do you want some coffee?"
...
whitney frownmouth @angry "Flan! Chill out! You're going to ruin a fun day if you can't keep your morning temper under control!"

pause 1.0

flannery "{w=0.25}.{w=0.25}.{w=0.25}."

show leaf -sad frownmouth with dis

flannery @sad "I... yeah. Sorry. I just woke up, and... I know that's not an excuse, but..."

flannery @closedbrow tiredmouth "Sorry."
...
red @thinking "Maybe I should get {i}him{/i} some coffee for the mornings..."

flannery tiredbrow tiredmouth "Mm."
flannery @talkingmouth "Hey, where'd Tia go?"
...
leaf -frownmouth @talking2mouth "Can't you two just call her?"

flannery @talkingmouth "She's already a nightmare just with a laptop. You think we're going to give her a phone?"
...
leaf "[first_name], geez, you run too fast... What the hell happened? You look like you saw a ghost."

whitney -surprised frownmouth @angry "Yeah! You knocked me over!"

redmind @surprised "None of them saw her jump? But... but she..."

show leaf -surprised with dis

flannery tiredbrow tiredmouth @talkingmouth "Way too early in the morning for this, dude. You don't yell like that unless someone's about to die."
...
leaf @talkingmouth "I know you well enough now to know when something scared the shit out of you. What happened?"

red @thinking "...You wouldn't believe me."
...
leaf -surprised @talkingmouth "Well, shit, I don't know how to help you with that one. I thought you were going to say something like 'my girlfriends were about to meet.'"

red @talking2mouth "Yeah, well, if they did, they would have known about each other beforehand. I'm not a dick."

leaf @thinking "Jury's out on that one. But about Tia... I mean, obviously, she's fine, right? So either she can jump off of buildings and be okay, or you didn't see her."

red @thinking "I guess. I {i}really{/i} feel like it was the first one, though."

leaf @talkingmouth "Maybe just ask her about it. Girl follows you around like a Rockruff, anyway, she'd probably tell you if you asked straight-up."
leaf @thinking "Oh, I guess you'd need to learn some more sign first, though, if you don't want to go through Whitney."
...
leaf @flirt "Your Queen graciously forgives your impertinence in exchange for eight hours of hard labor."

pause 1.0

red @thinking "Carrying shopping bags?"
...
whitney "Here we are, girls! And [first_name]! Welcome to the city!"

tia @surprised "There's so many people! Wow... how many people are there?"

flannery @thinking "Probably around three million?"

leaf @talking2mouth "Try a third of that. It's the biggest city in Kobukan, but Kobukan's still a tiny region."

red @talkingmouth "I read the only reason the academy is in Kobukan is because the President of Kobukan at the time basically paid for the school to be constructed here."

leaf @talking2mouth "Taking advantage of cheap land. Smart. 'If you build it, they will come,' after all."

whitney @talkingmouth "So, where are we going first?"
...
whitney @talkingmouth "I think she's just surprised. You must've done something really big to impress her, given what Lance said to you."

red @happy "Hey, I always try to impress!"

leaf @thinking "Alright, so how about [first_name] goes to the Pokécenter, while we go to the Kobukan department store?"
...
leaf @talking2mouth "But, seriously, just use your phone if you get lost, okay?"
...
redmind @frownmouth "Hm... So, if I just create a new set of boxes for myself, then I should be able to store an unlimited number of Pokémon here, right?"
...
menu:
    "{color=#66b77d}[[Knowledge] >Examine a Champion-contender's Pokémon.":
    ...
    "{color=#e226a6}[[Patience] >You'll see them personally later.":

        $ TraitChange("Patience")

        redmind @talkingmouth "Nah. It's not worth the chance of getting in trouble here."
...
if ("Poké Ball" in inventory.keys()):
    $ inventory["Poké Ball"] += 10
else:
    $ inventory["Poké Ball"] = 10
$ inventory["Premier Ball"] = 1
$ money -= 2000
...
red @thinking "I'm confused. You didn't seem to have a problem with [starter_name], right? Why are you concerned that I'll add more Pokémon to the team?"
...
#label reapportionelectric:
#
#if (classstats["Electric"] > 5):
#    narrator "Would you like to move your Electric Proficiency to another class? This is a matter of convenience, and serves as an opt-in retcon. Do not consider it 'canon.'"
#    narrator "[bluecolor]You will be left with five Electric Proficiency, and the class you move your proficiency to will be {size=40}{b}overwritten{/b}{/size}, not stacked.{/color}"
#
#    menu:
#        "Yes.":
#            $ movetype = renpy.input("Please type the name of the class you'd like to move your electric proficiency to, then press 'Enter' to confirm.", length=12, exclude="{}[[]%<>",)
#            $ movetype = movetype.strip().lower().title()
#
#            if (movetype == "Electric"):
#                narrator "You obviously can't do that.\n\n>Stop trying to break my game."
#                jump reapportionelectric
#            if (movetype in classstats.keys()):
#                $ classstats[movetype] = classstats["Electric"]
#                $ classstats["Electric"] = 5
#
#                narrator "Your stats have been readjusted."
#            else:
#                narrator "I don't recognize \"[movetype]\" as a type."
#                jump reapportionelectric
#
#        "No.":
#            pass
...
whitney @talkingmouth "I got a new set of shoes. The cleats in my old ones were wearing down. Oh, and I got a couple really cute skirts, and then there were materials to make Springsday baskets! So I bought a ton of those."

flannery @talkingmouth "I got a bag of coffee grounds."

pause 1.0

flannery @sadbrow talkingmouth "{i}Several{/i} bags. I'm going to try and kick this damn morning haze, or die trying."
...
red @thinking "Sorry, roll it back a bit--Springsday, Whitney? What's that?"
...
red @thinking "It's called Pallet Town, and having very limited internet access."

tia @surprised "I don't know what Springsday is, either!"

leaf @thinking "Now, see, {i}that's{/i} surprising."
leaf @talking2mouth "Springsday is a holiday celebrating... well, Spring. People celebrate by painting and hiding Pokémon eggs." 
...
flannery tiredbrow @talkingmouth "Yeah, and you can also celebrate by eating buttloads of chocolate. White chocolate, mostly."

whitney @talkingmouth "Did you know white chocolate isn't actually chocolate? Check the packaging. It'll always say something like 'white confection.'"

leaf @talkingmouth "Marshmallows are also pretty popular Springsday snacks. People cook them into the shape of Torchic, Psyduck and Buneary."

red @happy "Man. I'm hungry, now. When's this Springsday thing?"

whitney @talkingmouth "April 24th. So, next Saturday."

leaf @thinking "That means it'll be the last event the outgoing Student Council will host, huh? One last hurrah."
...
red @thinking "N-no. No-one said that."

leaf @angrybrow angrysmilemouth "Too bad. We're going on a restaurant tour now! I've already seen most of the restaurants in this city, so I want to find something new."
...
red @thinking "I feel like that's exactly how you find trendy."
...
leaf @flirt "Sorry. This is what you get for skipping arm day."
...
roughneck "Hey! Watch where you're going!"

narrator "Despite the fact the man barely shifted, he clearly seems as though he's ready to start a fight."

roughneck neutral "Didn't your Mom teach you any goddamn manners?! Or'm I gonna have to teach you, huh?"
...
roughneck surprised "Hey, hey, what kinda signs are those? I don't know any gang like that. And who'd accept a shrimp like you, anyway?"
roughneck angry "You tryin' to cause problems, is that it? Because I'm a big guy, you think you can just beat up on me whenever you want, huh?"

red @talking2mouth "Sir. We're not trying to cause any trouble. She was just having a bit of fun and bumped into you."

show tia happy with dis

roughneck neutral "Who the fuck is this? Your boyfriend?"
...
leaf @talkingmouth "No, but with the way they're going, give it a week."

roughneck surprised "Ugh, more of you? Oh, I know, you're some of those brats from the college, right?"

roughneck happy "...Actually, you lot are always loaded, aren't you?"

roughneck angry "Hey. When shortie here ran into me, it really hurt. Don't you think you owe me some compensation? Catch my meaning?"
...
leaf @closedbrow talking2mouth "I give it a 6/10. You could really do to explore some of the wider variants of thuggery. There's no need to restrict yourself."
...
leaf @thinking "Actually, you could even try expanding outside the range of thug and thug-adjacent roles. Obviously, with that face and bodytype, you're always going to be a bit typecast, but I bet you would make a very decent hockey goalie."

show whitney happy
show tia happy
with dis

roughneck neutral ".{w=0.25}.{w=0.25}.{w=0.25}"
...
roughneck "You sayin' I'm fat?"

leaf @happy "Good job! Give the man a cookie."

leaf @thinking "Although, actually, it might be better if you {i}don't{/i} have that cookie. Your veins are already so clogged with fat that one more cookie would probably cause you to keel over right now."

pause 1.5

roughneck @angry "...So you get that I'm going to smash your face in, right?"
...
flannery "You touch {i}any{/i} of us and I'll crack that egg-shaped head of yours over my knee."
...
flannery "That's it! You better--"

pause 1.0

flannery surprised "Wait. What time is it, Whitney?"
...
flannery @sadmouth "I mean, we shouldn't start a fight for no reason, right?"

red @angrybrow talking2mouth "{i}Seriously?!{/i}"

roughneck "Hey! I'm talking here! You better not be ignoring me!"
...
$trainer2 = Trainer("roughneck", TrainerType.Enemy, [
    Pokemon(pokedexlookupname("Scraggy", DexMacros.Id), level=8, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Rock Smash"), GetMove("Feint Attack"), GetMove("Payback"), GetMove("Headbutt")], nature=Natures.Adamant, gender=Genders.Male, ability="Intimidate"),
    Pokemon(pokedexlookupname("Skrelp", DexMacros.Id), level=8, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Acid"), GetMove("Bubble")], nature=Natures.Modest, gender=Genders.Male, ability="Adaptability"),
    Pokemon(pokedexlookupname("Sandile", DexMacros.Id), level=8, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Bite"), GetMove("Sand Tomb")], nature=Natures.Adamant, gender=Genders.Male, ability="Intimidate"),
], number=2)

call Battle([trainer1, trainer2], customexpressions=["red angrybrow frownmouth", "red angry", "roughneck", "roughneck angry"], reanchor=[False, True]) from _call_Battle_22
$ gymbattles["Roughneck1"]  = _return
...
if (WonBattle("Roughneck1")):
    roughneck "Dirty trick? You're the one who pretended to be some kinda student when you're obviously a trainer already!"
    ...
    if (money == 0):
        ...
        leaf @sadbrow talkingmouth "[first_name], no..."

        $ money = 0

roughneck "I'm getting out of here. But I'll leave you something to remember me by!"
...
show tia surprised -hat with vpunch
...
roughneck "Neener neener neener!"
...
if (len(trainer1.GetUnfaintedTeam()) > 0): 
    ...
    $trainer2 = Trainer("roughneck", TrainerType.Enemy, [
        Pokemon(pokedexlookupname("Stunky", DexMacros.Id), level=7, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Poison Gas"), GetMove("Acid Spray")], nature=Natures.Timid, ability="Aftermath"),
        Pokemon(pokedexlookupname("Rattata", DexMacros.Id), level=7, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Rock Smash"), GetMove("Quick Attack")], nature=Natures.Adamant, ability="Hustle")
    ])
    ...
    $trainer4 = Trainer("roughneck", TrainerType.Enemy, [
        Pokemon(32, level=7, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Poison Sting")], nature=Natures.Jolly, ability="Poison Point"),
        Pokemon(pokedexlookupname("Zubat", DexMacros.Id), level=7, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Supersonic"), GetMove("Astonish")], nature=Natures.Jolly, ability="Inner Focus")
    ])
    ...
    $ gymbattles["Roughnecks1"]  = _return
...
silver surprisedbrow "{w=0.25}.{w=0.25}.{w=0.25}."

silver sad "Shit."

red @confusedeyebrows talking2mouth "Silver...?"

silver @thinking "You weren't supposed to see this. I..."
...
silver "And leave the damn hat, obviously."
...
red @sad "Why? Dorm accomodations don't cost any extra money..."

silver @thinking "I need to keep an eye on these guys. They're... they're likely to get in a lot of trouble if I wasn't here."
...
red @sad "{w=0.25}.{w=0.25}.{w=0.25}."
red @sad "Anything I can do?"

silver @thinking "Hm. Actually, if you could come here once in a while, and battle them... they're always getting too near the school, trying to pick fights."
...
silver @thinking "So if you're subtle about it, you can probably make some cash."
silver @thinking "...I'd give them a bit of time, though. Like, they'll notice if you come here {i}every{/i} day. {color=#0048ff}Once every three days would probably be as much punishment as they could handle.{/color}"
silver @talkingmouth "So... wait until Monday before coming back here, alright?"

red @talkingmouth "Noted."

silver @thinking "Although we're probably not going to have time, given the Battle Team tryouts are on Monday..."

pause 1.0

red @thinking "You said your guys wander near the school?"
...
silver @thinking "You're trying to get on the SC?"

red @talkingmouth "Yeah. Today's the first day I'm actually going out of my way to make that happen, though."

silver @surprisedbrow "Your first day? {i}Shit.{/i} You work fast."
...
silver @thinking "The property's legally mine, but they won't give two shits about that if they decide they don't want us here."

pause 1.0

silver @talkingmouth "Anyway, if you do that... I'll help you get elected." 

red @thinking "Why do you care?"
...
silver @surprised "And if that happens, then people at the school will come {i}here{/i} at night. And I can't do anything about people who come here, you know?"
...
$ KnowClasses("Cheren", ["Dark"])
$ KnowClasses("Silver", ["Dark"])
...
red @surprised "...When you say you'll 'help me get elected,' what do you mean by that?"
...
show silver:
    matrixcolor BrightnessMatrix(-0.2) * ContrastMatrix(1.3) alpha 1.0
...
play music "audio/music/inspira.ogg"
...
leaf flirtbrow talkingmouth "You're in a good mood. What happened in that alleyway?"

red @happy "Oh, happy surprises. Impersonating a cop's a crime, by the way."

leaf -flirtbrow -talkingmouth @happy "What are they going to do, arrest me? You can't arrest a cop."
...
extend " in pieces, scattered across the road, and showing clear signs of having been run over by {i}several{/i} cars."

whitney @sad "Oh, no... my cleats... my Springsday baskets!"

flannery tired "Well, guess this is a sign from the universe that I'm never going to get over my morning thing. Damn, that was a lot of coffee."

leaf -sad @talkingmouth "Oh, well. It's not great, but we can just re-buy that stuff."

whitney angry "We're not all made of money, like you, Leaf!"

tia "Yeah! I can't afford another hat."
...
leaf @sad "Besides... it's kinda my fault that the stuff got hit."

red @talkingmouth "Huh? How come?"

leaf blush @embarrassed "Well... after you ran off, I told everyone to just ditch our stuff and run after you."
leaf @closedbrow talkingmouth "Which I might not have done if I remembered how fast you run, since we were like five minutes late. But whatever, I did."

flannery @talking2mouth "Yeah, she bolted right after you, like a Manectric. But... then got tired out after, like, fifty feet."
...
leaf @bigblush flirt "Yeah, I'm kinda used to it at this point."

red @thinking "Well, this is going to sound like an excuse to get out of shopping with you girls, but someone should really clean up this trash." 
...
whitney @surprisedbrow talkingmouth "Oh? Should I stay here to interpret for you, Tia?"
...
leaf @angrybrow angrysmilemouth "I'm not talking about literally eating your face, you {i}dork.{/i} I mean..."
...
red @thinking "Still, I bet Lance would never be caught dead picking up trash like this. This probably isn't making me Champion material..."
...
play sound "Audio/Pokemon/cries/88.wav"
queue sound "Audio/Pokemon/cries/568.wav"

$ sidemonnum = 88.1

sidemon "Griiime! Grimer!"

$ sidemonnum = 568

sidemon "Trub. Trub-bish!"
...
show tia concernedeyebrows concernedeyes hat frownmouth 
hide blank2
with dis
...
red @confusedeyebrows frownmouth "...Tia. Be honest with me. Did I see you jump off the roof this morning?"

narrator "Tia nods, again, without a moment of hesitation."

red @thinking "Geez. I don't know what to do with this information..."

pause 2.0

red @talkingmouth "Let's just continue our cleaning. But the next time I have some free time... and I understand sign a bit better... we're going to have a talk about this."
...
flannery @talking2mouth "Not if we {i}run{/i} back to our dorm."

leaf @surprised "You three are from Pledge Hall, right? You guys should probably go, then."

whitney @talkingmouth "Yeah, you're right. See you tomorrow, maybe? But, if not, definitely see you Monday!"
...
leaf @talkingmouth "Not so fast. What {i}actually{/i} happened in that alley?"
...
red @thinking "Hey, serious question time."
...
leaf @talking2mouth "Why would I say something I didn't want to?"
...
leaf @talking2mouth "Yeah, go ahead."

red @thinking "Okay. So, I've got two friends. And they both want very different things. Actually, the things they want are opposites."
...
leaf @talkingmouth "No, I am being serious. There's no other way. Unless you can somehow show them that they don't actually want what they think they do, you've just gotta make a choice."

red @sad "That first option sounds kinda... manipulative..."

leaf @talking2mouth "'Social engineering,' you mean."
