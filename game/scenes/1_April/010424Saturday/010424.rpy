...
play music "audio/large-crowd-talking.mp3" channel "crowd" fadein 1.5

if (1 in persondex["Instructor Valerie"]["ClassesKnown"]):
...
$ PlaySound("Pokemon/Cries/54.wav")
...
valerie @thinking "Today is a day of celebration, as we all become more aware of our place in the great circle of life."
...
calem @surprised "{size=25}We... {i}we{/i} are young? She can't be any older than twenty-five.{/size}"
...
blue -surprised @angry "Oh, yeah? Or what? You gonna do some pull-ups at me?"
...
ethan @thinking "Well, I can't exactly deny that..."

leaf @talkingmouth "Y'know, you're not actually a bad battler. You beat me in the tryouts."
...
leaf @angrybrow angrysmilemouth "Is your ego really so fragile that you need to spend every moment of every day proving you're better than everyone else?"
...
red @thinking "Anyway, what're you talking about? The egg hunt?"
...
brendan @thinking "...Uh... what am I not getting?"
...
blue @talkingmouth "This isn't just your average egg hunt. Each of the Pokemon in these eggs are the descendants of a top trainer's Pokémon."
...
brendan @thinking "Uh... I don't want to be on the Battle Team, though. I'm going to be a coordinator."

blue @surprised "What, like those girls who wear skirts and dance with their Pokémon?"

brendan @talkingmouth "Yeah, uh, there's actually a lot more to it than that. You don't have to be a girl, for one."
...
brendan @thinking "I mean, he could just buy a PP Up. They're not that expensive."

pause 1.0

leaf @happy "Hah, I see what May sees in you. You're cute, in a muscular kind of way."

ethan @thinking "So, about what Blue was saying...?"

leaf @talking2mouth "Oh, yeah, he was pretty much right. I mean, he was a dick, but this is a seriously good opportunity to pick up some powerful Pokémon."
...
redmind @thinking "Could it be some sort of weird side-effect of Frienergy? Feels like the kind of thing Old Man Oak would have mentioned, though..."

brendan @thinking "Hey, did you guys ever figure out why your Pokémon listen to you so well?"

show red surprised at Transform(xpos=0.08, yanchor=0.35)
...
leaf @thinking "Wow, so, {i}that{/i} was creepy."

pause 1.0

leaf @talkingmouth "Hey, do you think you two could put on some dresses, stand at the end of a dimly-lit hallway, and say 'come play with us?'"

brendan @talkingmouth "Oh, like in that one movie of Rosa's, right? {i}The Glimmering{/i}?"

leaf @surprised "Oh, you watch horror?"

brendan @talkingmouth "Eh, if it's on TV. May hides her face in my chest whenever we sit down to watch one, so we're both kinda distracted."

ethan @talkingmouth "Horror films are awesome! You guys ever watched 'Strong Jaws: The Revenge?' It's great."

menu:
    "{color=#b7669e}[[Charm] I watch horror, too!":
        $ TraitChange("Charm")
    ...
    "{color=#ff8412}[[Courage] Can't stomach the stuff, myself.":
        $ TraitChange("Courage")

        brendan @talkingmouth "Eh, that's alright, man. We all like different stuff. More of an action film guy?"

        leaf @happy "No way! That'd be basic, but understandable, at least. But this guy likes old black-and-white films! Like Diantha's old stuff!"

        brendan @talkingmouth "Still cool. Like I said. Different strokes."

play sound "audio/Phone.mp3"

pause 1.0

brendan @talkingmouth "Oh, that's May. She said she had a lead on an egg she really wanted, so I'm going off to meet her now!"
...
red @thinking "At the risk of giving a bit of credit to [blue_name], maybe I don't get how serious this actually is?"

leaf @talkingmouth "Well, it's like he said. There's a bunch of Pokémon eggs out there, and you can keep any you find."
...
leaf @talking2mouth "Yeah, but there's no rush there. As long as you don't, like, throw an egg in your backpack and forget about it for three days, it'll be fine."

red @thinking "Hm... you got any advice, you two?"
...
leaf @talking2mouth "There aren't any, like, prizes, for getting more, or getting specific ones, so just pick up whatever you want."

pause 1.0

leaf @closedbrow talkingmouth "But maybe not {i}every{/i} single one you want. Like, don't be a dick."

ethan @talkingmouth "Hey, uh, what's the threshhold for dickishness?"

leaf @sarcastic "I dunno. Three, maybe? I wouldn't take any more than three."

ethan @thinking "What happens if we end up picking up an egg we don't want?"

leaf @talkingmouth "[bluecolor]If you have an egg you don't want, you can just donate it to the Research Lab. At the end of the egg hunt, the school will call us all back, and the Student Council will gather up the eggs."
...
leaf @talkingmouth "Oh, it was explained during that homeroom you missed because you were too busy hanging out with the meteor girl."

ethan @surprised "Uh... a meatier girl? Who, Bea?"

show leaf surprised with dis

red @angrybrow talking2mouth "Leaf, that's meant to be private."

leaf -surprised frownmouth @sad "Ah... I'm really sorry! I just... I genuinely forgot you were there, Ethan."
...
ethan @thinking "Man, where's Catcher-In-The-Rye?"

leaf -frownmouth @talkingmouth "Oh, Serena said she had plans for him, and dragged him off somewhere. I think she's got some eggs she wants, too."

ethan @talkingmouth "Shame that Hamburger refused to get up before 7. He'll miss out on a bunch of eggs."

red @thinking "Yeah, Hilbert's been moody ever since he got into the Battle Team."
...
ethan @thinking "Threat Level: III is scary. That's when Haraam starts yelling. Dude's, like, nineteen, but his voice still cracks when he yells at you."
...
red @thinking "Nah, but give him twenty-four levels and a Dusk Stone, and he will."
...
leaf -surprised @closedbrow talkingmouth "Yeah, still creepy."

ethan @talkingmouth "So, you got any eggs you want to grab?"

leaf @talking2mouth "Nah. Maybe if something shows up, but... nothing I'm specifically looking for."
...
leaf @talking2mouth "I just think the battling would be fun."

red @talkingmouth "Maybe we'll cross paths, then. Unless you want to go together?"

leaf @flirt "You just can't get enough of me, can you?"
...
ethan @thinking "Huh? I don't think so?"
...
red @thinking "{size=25}Think we should call someone? I don't know how to handle kids.{/size}"

ethan @talkingmouth "{size=25}I mean, she must be, like, a staff member's kid, right? I think it's probably fine. Actually, I think I've seen her before.{/size}"
...
red @talkingmouth "{size=25}You cool with it?{/size}"

ethan @talkingmouth "{size=25}I guess? Probably better she tags along with us than she tries to hitch a ride with Blue.{/size}"

red @closedbrow talking2mouth "{size=25}Eeesh. Yeah, for real.{/size}"
...
ethan @closedbrow talking2mouth "Ah, jeez, I'm only eighteen. Is this how Calem felt...?"
...
$ flanneryhasmagby = False
$ biancahaswynaut = False
$ tiahaswynaut = False
$ hildahasbonsly = False
$ nessahasbonsly = False
...
if (_return == "Outside"):
    ...
    if (not visitedbaseballfield):
        ...
        red @thinking "Oh, so that must mean..." 

        may @happy "Yep! That's a Larvesta egg! Ever since I saw Alder take out his Volcarona, I knew I wanted one."

        brendan @talkingmouth "It's true. It's all she's been talkin' about. And we've been looking for it for ages."
                    ...
                    "No, I'm serious.":
                        ...
                        menu:
                            ...
                            "I'll battle you for it.":
                                ...
                                brendan @closedbrow talkingmouth "Nah, not this time."

                                #todo: burn all pokemon

                                $ maytorchicobj.Moves = [GetMove("Flame Charge"), GetMove("Quick Attack")]
                                $ trainer1 = Trainer("red", TrainerType.Player, playerparty, number=2)

                                $ trainer2 = Trainer("may", TrainerType.Enemy, [mayvenonatobj, mayheracrossobj, maytorchicobj])
                                
                                $ brendansandshrewobj.Level = 12
                                $ brendansandshrewobj.Moves = [GetMove("Rapid Spin"), GetMove("Defense Curl"), GetMove("Rollout"), GetMove("Fury Cutter")]
                                $ brendansandshrewobj.RecalculateStats()
                                $ brendanshroomishobj.Level = 12
                                $ brendanshroomishobj.Moves = [GetMove("Bark Up"), GetMove("Leech Seed"), GetMove("Mega Drain")]
                                $ brendanshroomishobj.RecalculateStats()
                                $ brendanmudkipobj.Level = 11
                                $ brendanmudkipobj.Moves = [GetMove("Water Gun"), GetMove("Mud-Slap")]
                                $ brendanmudkipobj.RecalculateStats()

                                $ trainer3 = Trainer("brendan", TrainerType.Enemy, [brendanshroomishobj, brendansandshrewobj, brendanmudkipobj])

                                call Battle([trainer1, trainer2, trainer3], currentWeather=("larvesta egg", 999), customexpressions=["red", "red angrybrow happymouth", "may sad", "brendan angry", "may sad", "brendan angry"]) from _call_Battle_52
                                $ gymbattles["BrendanMay2"] = _return
                                ...
                                if (WonBattle("BrendanMay2")):
                                    $ mayhaslarvesta = False
                                    brendan @talkingmouth "Fine. Take the egg. And get out of here, dude. I know you're not normally like this, but you're being a huge dick."

                                    show may:
                                        xpos 0.6
                                        ease 3.0 ypos 1.1

                                    may "{size=25}I... I really wanted...{/size}"

                                    if (GetRelationship("May") == "Taster"):
                                        may "{size=25}I was {i}really{/i} trying something new. I was standing up for myself. I wasn't scared of change for once. And...{/size}"
                                    ...
                                    $ mayhaslarvesta = True
                                    brendan @talkingmouth "There. It's done. Get out of here, dude. I know you're not normally like this, but you're being a huge dick."

                                    red @thinking "Damn. Burned some bridges, and didn't even get the bug out of it."
    else:
        if (mayhaslarvesta):
            ...
            menu:
                "I wanted to apologize." if not hasapologized:
                    ...
                    brendan @closedbrow "Yeah, that doesn't really get my girl her Larvesta, does it? Whatever."
                ...
                "I wanted to return the egg." if HasEgg("Larvesta Egg"):
                    ...
                    brendan -surprised @closedbrow "Damn, you couldn't have done this earlier?"

                    may -surprised @happy "Well, I'm not going to look a gift larva in the mouth! Thank you, [first_name]!"
                ...
                "Nothing.":
                    brendan @closedbrow talkingmouth "Fine."
    ...
    if (not visitedaurahall):
        ...
        ethan @thinking "Oh boy. Talk about overcomplicating the situation. [first_name], I'd just make Calimari take the egg."

        iris @thinking "Yeah, I don't think Mr. Calimari is really listening to what Ms. Misty's saying."

        $ trainer1 = Trainer("red", TrainerType.Player, playerparty)

        $ calemfletchlingobj.Level = 13
        $ calemfletchlingobj.RecalculateStats()
        $ calemflabebeobj.Level = 13
        $ calemflabebeobj.RecalculateStats()
        $ calemfalinksobj = Pokemon(870, level=13, moves=[GetMove("Focus Energy"), GetMove("Rock Smash"), GetMove("Protect")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Adamant, ability="Defiant")
        $ trainer2 = Trainer("calem", TrainerType.Enemy, [calemfalinksobj, calemfletchlingobj, calemflabebeobj])

        $ mistypsyduckobj = Pokemon(54, level=16, moves=[GetMove("Surf"), GetMove("Calm Mind"), GetMove("Healing Spring"), GetMove("Confusion")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Modest, gender=Genders.Male, ability="Swift Swim")
        $ mistystaryuobj = Pokemon(120, level=14, moves=[GetMove("Water Gun"), GetMove("Confuse Ray"), GetMove("Rapid Spin"), GetMove("Recover")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Modest, ability="Analytic")
        $ trainer3 = Trainer("misty", TrainerType.Enemy, [mistystaryuobj])
        $ sidemonnum = pokedexlookupname("Psyduck", DexMacros.Id)
        $ trainer4 = Trainer("sideportraitfull", TrainerType.Enemy, [mistypsyduckobj])
        ...
        menu:
            "Calem, just take the egg.":
                ...
                calem -surprised @angry "I... I {i}would{/i} like the egg... but I'm trying to be gentlemanly here! There's no time for self-serving goals!"
                ...
                call Battle([trainer1, trainer3, trainer2, trainer4], customexpressions=["red surprised", "red surprised", "misty surprised", "misty surprised", "calem surprised", "sideportraitfull", "calem surprised", "sideportraitfull"]) from _call_Battle_53
                $ gymbattles["Calem2"] = _return
                ...
                if (WonBattle("Calem2")):
                    ...
                    calem @thinking "I must admit, I somewhat appreciate the fact the decision-making power is now out of my hands."
            ...
            "Misty, just take the egg.":
                ...
                misty -surprised angry "I didn't care, at first, but after this guy spent all [lowertime] harrassing me, I want to {i}force{/i} him to take the egg now!"
                ...
                call Battle([trainer1, trainer2, trainer3, trainer4], customexpressions=["red surprised", "red surprised", "calem surprised", "calem surprised", "misty surprised", "sideportraitfull", "misty surprised", "sideportraitfull"]) from _call_Battle_54
                $ gymbattles["Misty2"] = _return
            ...
            "I'll take the egg.":
                ...
                calem -surprised angry "Do you mind? I'm trying to be gentlemanly here! There's no time for self-serving goals!"
                ...
                misty -surprised angry "Yeah! I didn't care, at first, but after this guy spent all [lowertime] harrassing me, I want to {i}force{/i} him to take the egg now!"
                ...
                call Battle([trainer1, trainer2, trainer3, trainer4], customexpressions=["red surprised", "red surprised", "calem surprised", "misty surprised", "sideportraitfull", "calem surprised", "misty surprised", "sideportraitfull"]) from _call_Battle_55
                $ gymbattles["CalemMisty1"] = _return
                ...
                if (WonBattle("CalemMisty1")):
                    ...
                    calem @thinking "I noticed your Psyduck seemed a bit... hard-headed during that fight."
                    ...
                    calem @thinking "I do the best I can for her, but it's never quite enough. But I still feel awful whenever I let her down."

                    if (GetRelationship("Misty") == "Jerk"):
                        misty @thinking "Yeah, and my Psyduck is always acting out for my attention, but I just don't know how to tell him he has it..."
                    else:
                        misty @thinking "Yeah, and my Psyduck just never listens to me, for no reason..."
        ...
        label calemgetegg:
            ...
            calem @thinking "...It probably would have been easier to just admit I wanted it all along, wouldn't it have been?"
        ...
        calem @thinking "A thought occurs. Who is that small child that's accompanying you and Ethan?"
        ...
        iris @thinking "And I like to watch other people battle, too! Grown-ups battle in such a cool way. I wanna be like you when I grow up!"
    ...
    if (not visitedbattlehall):
        ...
        menu:
            ...
            "Let's talk about it.":
                ...
                bea -surprised @talkingmouth "Well... okay."

                iris @talkingmouth "So, whatcha gonna do with it? You want it to take some hits, or do some hits?"

                bea @thinking "My team has some issues on the defensive, so I suppose I'd rather it could take hits than deal them..."

                ethan @talkingmouth "Defensive, huh..."

                $ KnowClasses("Bea", ["Rock"])
                ...
                bea @thinking "Flying-type moves can be learned most easily by Dragon-types. So perhaps I should seek a Pokémon that can learn fairy moves?" 
                bea @thinking "But then a sensible opponent would use a Poison-type, which my Fighting-types would also have difficulty fighting."
                ...
                bea -surprised @surprisedbrow talkingmouth "I... sorry?"
                ...
                bea @thinking "'I fear not the man who has practiced a thousand kicks, but I do fear the man who has practiced one kick a thousand times.'"
                ...
                iris @thinking "Now, you said you wanted a friend that can make your team more defensive, yep?"

                bea @talkingmouth "Yes."

                ethan @thinking "So... that'd be Hitmonchan, right? Tyrogue evolves into those guys if their defense is higher than their attack."
                ...
                iris @thinking "What does patronized mean?"
                ...
                bea @thinking "Still, it would be remiss of me not to offer you a fragment of my appreciation."
    ...
    if (melonyegg != None):
        ...
        if (not visitedacademy):
            ...
            red @thinking "Hm... Dawn said there was an egg in here, right?"
    ...
    if ((not visitedrelichallmorning and timeOfDay in ["Early Morning", "Morning", "Noon"]) or (not visitedrelichallafternoon and timeOfDay not in ["Early Morning", "Morning", "Noon"] and not magbytaken)):
        ...
        if (timeOfDay in ["Early Morning", "Morning", "Noon"]):
            ...
            menu:
                ...
                ">Just leave.":
                    red @thinking "Yep, Flannery does {i}not{/i} appreciate charity in the mornings. I should come back later."
                    jump postrelichall
        else:
            ...
            flannery -surprised @happy "Oh, hey, [first_name]! Good to see you. I've been trying to get this darn egg off the bookshelf for ages now."
            ...
            flannery @talkingmouth "Cool. Hey, kiddo. Want to ride on my shoulders? I bet if you do, we can get that darn egg!"
            ...
            ethan @thinking "Oh? Uh, hold on, I think I've got some cream in my bag."

            red @thinking "Hey, I always wondered. What's in that bag you carry around all over?"

            ethan @happy "Ah, just emergency stuff. First aid kit, spare phone, batteries. You know, stuff like that."

            flannery @talkingmouth "Well, thanks for helping me get the egg, lil' miss."
            ...
            flannery @talkingmouth "Hey, since you burned your fingers getting it, do you want it?"
            ...
            menu:
                ...
                "Take it.":
                    ...
                    if (GetRelationship("Flannery") == "Challenger"):
                        flannery @talkingmouth "Anything for my challenger! Use that lil' guy to figure out why I can't handle mornings!"

                        pause 1.0

                        red @confused "How?"

                        flannery @tired "I dunno, that's your job."
        ...
        $ flannerynumelobj.Level = 15# = Pokemon(pokedexlookupname("Numel", DexMacros.Id), level=7, gender=Genders.Male, ability="Oblivious")
        $ flannerynumelobj.Moves = [GetMove("Bulldoze"), GetMove("Ember"), GetMove("Magnitude"), GetMove("Flame Burst")]
        $ flannerynumelobj.RecalculateStats()

        $ flanneryonixobj.Level = 14# = Pokemon(pokedexlookupname("Onix", DexMacros.Id), level=8, gender=Genders.Female, ability="Sturdy")
        $ flanneryonixobj.Moves = [GetMove(GetMove("Rock Tomb"), GetMove("Curse"), GetMove("Smack Down"))]
        $ flanneryonixobj.RecalculateStats()
        ...
        $ trainer2 = Trainer("flannery", TrainerType.Enemy, [flannerydarumakaobj, flannerynumelobj, flanneryonixobj])

        call Battle([trainer1, trainer2]) from _call_Battle_56
        $ gymbattles["Flannery1"] = _return

        show flannery frownmouth with dis:
            xpos 0.75

        if (WonBattle("Flannery1")):
            flannery @talkingmouth "Hah... Hah... Hah..."

            red @thinking "Hm... she's still kinda angry, but... maybe she's tired enough now that I can grab the egg without her physically tackling me."
            ...
            menu:
                ...
                ">Give her the egg.":
                    ...
                    flannery @tiredbrow talkingmouth "...Yeah, okay."
    ...
    if (not visitedstudentcenter):
        ...
        red @thinking "Huh, something just occurred to me. Ethan, you know these two have the same name, right?"

        ethan @surprised "Huh? Yeah."

        red @thinking "So, who are they?"

        ethan @thinking "Uh... blonde is Bel and brunette is Ven?"
        ...
        if (GetRelationship("Tia") != "Protector"):
            ...
            redmind @surprised "Who-whoa! Please, one at a time!"
        ...
        red @thinking "Well, I guess someone's gotta make a call."
    ...
    if (not visitedpledgehall):
        ...
        nessa -surprised frownmouth @surprised "[first_name]? What're you doing here? ...Who's the kid?"

        hilda -surprised frownmouth @angrymouth "Look, I'm just telling 'Nessa' here where she can {i}shove{/i}--"
        ...
        $ hildaaronobj.UpdateLevel(14)
        $ hildaaronobj.RecalculateStats()
        $ hildaaronobj.Moves = [GetMove("Metal Claw"), GetMove("Headbutt"), GetMove("Rock Tomb"), GetMove("Mud-Slap")]
        $ hildaaronobj.Item = "Sitrus Berry"
        $ hildaaronobj.EVs = [0, 1, 0, 1, 0, 1]
        $ hildaaronobj.Intelligence = 1
        $ hildapawniardobj.UpdateLevel(14)
        $ hildapawniardobj.RecalculateStats()
        $ hildapawniardobj.Moves = [GetMove("Metal Claw"), GetMove("Feint Attack"), GetMove("Fury Cutter"), GetMove("Leer")]
        $ hildapawniardobj.Item = "Sitrus Berry"
        $ hildapawniardobj.Evs = [0, 1, 0, 1, 0, 1]
        $ hildapawniardobj.Intelligence = 1
        $ hildavaroomobj = Pokemon(pokedexlookupname("Varoom", DexMacros.Id), level=14, moves=[GetMove("Poison Gas"), GetMove("Sludge"), GetMove("Assurance"), GetMove("Lick")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], item="Sitrus Berry", gender=Genders.Female, nature=Natures.Adamant, ability="Overcoat", intelligence=1)

        $ nessacorsolaobj = Pokemon(222, level=14, gender=Genders.Female, moves=[GetMove("Healing Spring"), GetMove("Ancient Power"), GetMove("Bubble Beam"), GetMove("Recover")], nature=Natures.Bold, ivs=[24, 24, 24, 24, 24, 24], ability="Regenerator")
        $ nessadrednawobj = Pokemon(pokedexlookupname("Drednaw", DexMacros.Id), level=22, moves=[GetMove("Healing Spring"), GetMove("Razor Shell"), GetMove("Rock Tomb"), GetMove("Crunch")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], gender=Genders.Female, nature=Natures.Adamant, ability="Swift Swim", intelligence=1)
        
        $ trainer1 = Trainer("red", TrainerType.Player, playerparty)
        $ trainer2 = Trainer("hilda", TrainerType.Enemy, [hildaaronobj, hildavaroomobj, hildapawniardobj])
        ...
        menu:
            ">Side with Nessa.":
                ...
                $ trainer3 = Trainer("nessa", TrainerType.Ally, [nessacorsolaobj])
                $ trainer2.Number = 2
                ...
                if (WonBattle("Hilda2")):
                    ...
                    menu:
                        ...
                        ">Suggest giving the egg to Hilda.":
                            ...
                            if (GetRelationship("Nessa") == "Friend"):
                                nessa @thinking "I guess you're trying not to jeopardize that second date, huh?"
                            ...
                            hilda @thinking "I guess I got a bit worked up there... It just felt... I mean, here's this wealthy, gorgeous, popular girl who's making a big deal about how she wanted the egg {i}I{/i} wanted."
                    ...
                    red @thinking "Well, that was an awful time for everyone."
            ...
            ">Side with Hilda.":
                ...
                $ trainer2.Type = TrainerType.Ally
                $ trainer3 = Trainer("nessa", TrainerType.Enemy, [nessadrednawobj, nessacorsolaobj], number=2)
                ...
                if (WonBattle("Nessa2")):
                    ...
                    red @thinking "Yeah, that was a close one."
                    ...
                    menu:
                        ...
                        ">Insist Hilda take the egg.":
                            ...
                            if (GetRelationship("Hilda") == "Caretaker"):
                                hilda @thinking "I guess this is just another way you're doing stuff for me."
                        ...
                        ">Suggest giving the egg to Nessa.":
                            ...
                            nessa -surprised @talking2mouth "And you're her messenger?"
    ...
    if (not visitedgarden):
        ...
        red @thinking "Hm, let's see, it's..."
        ...
        ethan @thinking "Yeah. It's looking for something."
        ...
        ethan @thinking "It's probably feeling real insecure, since it's got this, like, urge to do something, but doesn't know what. Our knack for Pokémon might not be enough to overcome that."
    ...
    if (happinyegg == None):
        ...
        label gaveegg:
            ...
            iris @thinking "It's still a baby though. It should probably go to the research center, to get a check-up and shots and stuff."
    ...
    if (not visitedrecreationcenter):
        ...
        red @thinking "Hm. Any idea what that one is?"
        ...
        show skyla surprised with vpunch
        ...
        menu:
            ">Just don't peek.":
                ...
                skyla -surprised "Alright, {i}now{/i} you can look."
                ...
                ethan -surprised @thinking "Let me guess. It's a Water-type, and its eggs are safe underwater?"
            ...
            ">Just don't not peek.":
                ...
                red @thinking "Surely just a single peek wouldn't--"
                ...
                red "Wait, how did you know I was opening my eyes?"
                ...
                ethan @thinking "{size=25}...Worth.{/size}"
        ...
        skyla thinking "Hm. It's kinda weird, 'cause I could {i}swear{/i} that I'd seen her before..."
        ...
        red @thinking "That's a bit weird, right?"

        ethan @talking2mouth "Yeah, a bit. I feel like I've seen Sclera before as well, but..."

        pause 1.0

        red @thinking "Sclera? Do you mean Skyla? Or Iris?"
    ...
    if (not visitedresearchcenter):
        ...
        leaf @embarrassed "Um... well, yes..."

        nate @talkingmouth "Well, hey, L, carry on. Don't let me stop you."

        leaf @angrybrow angrysmilemouth "Hey, has anyone told you that's a bit rude?"

        nate @surprised "What?"

        leaf @closedbrow talkingmouth "Oh, I dunno, just calling me 'L.' I mean, of all the nicknames--really?"
        ...
        rosa @thinking "So... what's your Nate-name?"
        ...
        leaf @thinking "So... can you change my nickname to, like, 'Princess?'"

        red @thinking "I thought you were a queen? Or possibly a pirate ship captain?"
        ...
        show leaf bigblush flirtbrow talking2mouth with dis     
        ...
        leaf -flirtbrow -talking2mouth @closedbrow talkingmouth "Ugh, it's {i}always{/i} like that, isn't it?"

        show rosa surprised
        show ethan surprised

        leaf @talkingmouth "Hey, [first_name], just so I'm not wasting my time, you {i}do{/i} like girls, right?"
        ...
        leaf @talking2mouth "Cool."

        pause 1.0

        leaf @flirtbrow talking2mouth "And what about you, Backup Plan?"

        ethan -surprised @angry "Oh, come on!"
        ...
        leaf @closedbrow talkingmouth "Damn."

        leaf @sarcastic "Alright, fine, I guess you're back at the top of my list, [first_name]."

        red @confused "Imagine my joy."

        leaf @talkingmouth "Yeah, you're blessed. Anyway, wrapping back around to the real point of the convo... Nate, can't you just call me, like, LG?"

        nate @thinking "Life's good? Sure."

        leaf @sarcastic "Uh, no. Leaf Green."

        red @thinking "Tell me that's not your name."

        leaf @angry "What?! It's totally my name! And it's an awesome name, too!"

        ethan @talking2mouth "It sounds like a dispensary, dude."

        leaf @talkingmouth "Oh, yeah? Well, what's your last name?!"

        ethan @talkingmouth "Gold."

        leaf @closedbrow talkingmouth "Oh, that's actually kinda cool. Uh, give me a second to think up something snarky..."
        ...
        leaf @thinking "Well... who do you want to join, [first_name]?"

        $ trainer1 = Trainer("red", TrainerType.Player, playerparty)

        $ nateklinkobj.UpdateLevel(13)
        $ nateklinkobj.Moves = [GetMove("Charge Beam"), GetMove("Vise Grip")]
        $ natetrubbishobj.UpdateLevel(13)
        $ natetrubbishobj.UpdateMoves(["Toxic Spikes", "Acid Spray", "Bad Breath", "Pound"])
        $ natemagnemiteobj = Pokemon(pokedexlookupname("Magnemite", DexMacros.Id), level=12, moves=[GetMove("Thunder Wave"), GetMove("Thunder Shock"), GetMove("Magnet Bomb"), GetMove("Energize")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Modest, ability="Analytic")
        $ trainer2 = Trainer("nate", TrainerType.Enemy, [natetrubbishobj, nateklinkobj, natemagnemiteobj])  

        $ rosapikachuobj = Pokemon(25, level=18, gender=Genders.Female, moves=[GetMove("Energize"), GetMove("Electro Ball"), GetMove("Quick Attack"), GetMove("Thunder Wave")], ivs=[24, 24, 24, 24, 24, 24], nature=Natures.Timid, ability="Static")
        $ rosacharmanderobj = Pokemon(pokedexlookupname("Charmander", DexMacros.Id), level=8, ivs=[31, 31, 31, 31, 31, 31], moves=[GetMove("Ember"), GetMove("Smokescreen"), GetMove("Growl"), GetMove("Scratch")], nature=Natures.Timid, ability="Blaze")
        $ rosaeeveeobj = Pokemon(pokedexlookupname("Eevee", DexMacros.Id), level=8, ivs=[31, 31, 31, 31, 31, 31], moves=[GetMove("Covet"), GetMove("Quick Attack"), GetMove("Tackle"), GetMove("Helping Hand")], nature=Natures.Jolly, ability="Adaptability")
        $ trainer3 = Trainer("rosa", TrainerType.Enemy, [rosapikachuobj, rosacharmanderobj, rosaeeveeobj])

        $ trainer4 = Trainer("leaf", TrainerType.Enemy, [leafbulbasaurobj, leafhelioptileobj, leafdratiniobj])
        $ invitedleaf = False
        ...
        menu:
            "I'll join Nate.":
                ...
                leaf @talkingmouth "Whatever, jughead."
                ...
                leaf @flirt "Oh, my dear, poor, foolish, child."
                ...
                leaf @talkingmouth "Hey, Rosa, if we beat them, can we take a victory selfie together?"
            ...
            "I'll join Rosa.":
                ...
                leaf @talkingmouth "Hey, Rosa, if I beat you, will you let me take a couple pictures with you?"
                ...
                if (WonBattle("LeafNate1")):
                    ...
                    rosa @sadbrow talkingmouth "Um... that egg is one of the few Pokemon my agency approved that I can actually use, so... if you don't mind..."
                    ...
                    nate @thinking "Can't say I'm surprised."

                    rosa @surprised "Oh! Um... I lost, though."

                    leaf @talkingmouth "Yeah, but... your team. I think I know what's going on there. You {i}need{/i} this egg."
            ...
            "I'll join you." if not invitedleaf:
                ...
                leaf @talking2mouth "Um... I mean... you have the chance to team up with an internationally-famous movie star..."
            ...
            "I'll take you all on!":
                ...
                leaf @talking2mouth "I'll give you one chance to back out, skippy."

                menu:
                    "Nothing ventured, nothing gained!":
                        leaf @thinking "Is this your first time against three at once?"
                        leaf "I'll be gentle."

                        rosa @talkingmouth "This'll definitely be a show, no matter how it turns out. Let me just set up a camera..."

                        nate @thinking "Choosing to be outnumbered and outgunned here, huh. Three people against one..."
                        ...
                        $ gymbattles["LeafNateRosa1"] = _return
                        ...
                        if (WonBattle("LeafNateRosa1")):
                            ...
                            rosa @sadbrow "Eeesh. That was a great fight, but I don't think I can use that footage... it's just embarrassing, losing that hard!"

                            leaf @flirt "Well, victor, who gets the egg? We, the lowly defeated, must bow to your judgment."
                            ...
                            leaf @angrybrow angrysmilemouth "Hey. Nate. Anything you want to say?"
                            ...
                            leaf @thinking "Us beating him didn't actually solve anything, did it?"

                            nate @closedbrow "Nope."

                            rosa @thinking "Well... um... if it matters, at all... that egg hatches into one of the few Pokemon my agency lets me use that I can actually train, so..."

                            pause 1.0

                            leaf @angrybrow angrysmilemouth "So you're not going to take that away from Queen Rosa, are you, {i}Nathan?{/i}"

                            nate @surprised "Woah. You sound like my Mom."

                            pause 1.0 

                            nate @thinking "Yeah, alright, Rosa. You can take the egg."
        ...
        red @thinking "Yeah, actually, I've got a question about your team, Rosa."

        rosa @thinking "Oh, no. It's, um... it looks a bit silly, doesn't it?"

        nate @thinking "Yeah. A Charmander, a Pikachu, and an Eevee? Kinda an overplayed hand, isn't it, R?"
        ...
        rosa @thinking "I might just have to see if the agency can send someone to train them for me... but that'd kinda defeat the point of being at Kobukan, wouldn't it?"
        ...
        leaf @flirtbrow talkingmouth "Running after Tia again, huh..."
...
iris @thinking "Yeah, I think he's in the academy building."

red @thinking "Makes sense. Let's just go by the research center to drop off our eggs, then."
...
queue music "audio/music/tension.mp3"
...
red @thinking "You guys understand this is robbery, right? Like, this isn't just a hazing ritual. I could report you to the Office of Student Conduct and Conflict Resolution. Heck, I could report you to the {i}cops.{/i}"
...
face @angry "{size=25}Piss.{/size}"

mace @angrybrow talkingmouth "{size=25}See? I told you we should've listened to your sister. She {i}told{/i} us this wouldn't work.{/size}"

face @angrybrow "{size=25}It was {i}your{/i} idea!{/size}"

mace @angry "{size=25}My idea which I {i}acknowledged{/i} was a bad one.{/size}"

red @confused "Hey, kinda out of the blue, but what's you guys' relationship?"

ethan @thinking "I've been wondering that, too. The matching clothes are throwing me off. Are you, like, siblings? Lovers? Both?"
...
$ PlaySound("pokemon/cries/428.wav")

pause 1.0

red @thinking "What was...?"
...
redmind @talking2mouth "Something's coming."
...
$ trainer1 = MakeRed()
$ lopunnyobj = Pokemon(428.1, level=22, moves=[GetMove("Mirror Coat"), GetMove("Magic Coat"), GetMove("Jump Kick"), GetMove("Bounce")], ability="Scrappy")
...
$ gymbattles["Lopunny1"] = _return

$ lopunnyobj.Id = 428
$ lopunnyobj.UpdateLevel(10)
$ lopunnyobj.Experience = lopunnyobj.CalculateAllExperienceNeededForLevel(10)
$ lopunnyobj.Ability = RandomChoice(["Klutz", "Cute Charm", "Limber"])
$ lopunnyobj.UpdateMoves(["Pound", "Magic Coat", "Mirror Coat", "Healing Wish"])
...
red night @thinking "Yeah. But... I'm confused."

ethan frownmouth @thinking "Right. I only {i}just{/i} learned this, but that was a Mega-Evolved Lopunny. Don't Pokémon need trainers to Mega Evolve? How did it do that?"
...
red @thinking "And this was clearly a wild Pokémon."

if (lopunnyobj in playerparty or lopunnyobj in box):
    red @thinking "I mean, my Poké Ball wouldn't have worked on it if it was registered to another trainer."

ethan @thinking "No kidding."
...
red @thinking "So... if another Pokémon, like, for example, a Lopunny, ate a fragment of a meteor... would it be able to Mega Evolve, too?"

iris @thinking "Mmm... I don't think so. Rayquaza's the only one with that organ, I think. And it's prolly gotta be a special kind of meteor. Like how grown-ups need to eat their broccoli to get big."

red @thinking "Hm..."

pause 1.0

ethan @thinking "What're you thinking, man?"

red @happy "I'm thinking I'm out of my depth, here! I guess it's something to ask Old Man Oak."

ethan @thinking "Yeah... I guess so. Well, let's go back to the Research Center. We've still gotta drop these eggs off."
...
$ numeggs = NumEggs()
if (numeggs > 1):
    "Attendant" "\"Welcome. It looks like you currently have... [numeggs] eggs with you. Would you like to donate any of them to the school, or have us keep them until they hatch?\""
...
if (not wasdick and NumEggs() <= 3):
    ...
    iris @thinking "I think you two should take these."
...
red @thinking "Well, will I see you around the school?"
...
red @thinking "Cute kid."

ethan @thinking "Yeah. Feels like the little sister I never had."
...
mace -surprised @angry "You! You're one of those cretins who ripped that Charmander from out of our hands!"

cheren @thinking "My efforts hardly contributed to that."

face @talkingmouth "Why should we take you at your word? You're doubtlessly a beneficiary of nepotism yourself!"

cheren @thinking "'Nepotism.'{w=0.5} You keep using that word.{w=0.5} ...Who recommended you to this school?"

mace @talkingmouth "Our parents, who are lauded alumni, and sit on the Board of Trustees!"

pause 1.0

cheren @thinking "You understand how that, in itself, is nepotism, right? You're no less guilty than [first_name]. Unless you have access to information I do not about his particular situation."

face @angry "Psh. Just look at him. He's a barely-literate fool who bungled--"

cheren @thinking "Bungled his way onto the Battle Team, yes, I know, I know. I've heard all these complaints before, from Blue."
...
cheren @thinking "Damn me for it, but I am confident there is something about [first_name] that is... unbeatable. That no fair play can overcome."
...
cheren @thinking "If I am right about the truth I believe is lying undercover, then... yes. It will win. But I need {i}your{/i} aid to find it."
...
cheren @thinking "{i}(Forgive me for this, [first_name]. But I must be sure.){/i}"
