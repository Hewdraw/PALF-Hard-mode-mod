...
sonia @talkingmouth "Yeah, so, that's... that's my situation. Um. So, if you, y'know, have any odd jobs for me... I'd be right chuffed if you let me know."
...
sonia @thinking "I just... Since we're on the Battle Team together, I thought I'd mention. I just {i}really{/i} need to get some money quick, or else... in five months..."
...
sonia -surprised @surprised "Um, yes, I--"
...
sonia @angrybrow talkingmouth "You must be very proud, but I don't see..."
...
sonia @angrybrow talkingmouth "I'm not going to sell my body."
...
sonia @talkingmouth "...And this is profitable?"
...
gardenia @happy "I'll let you buy in for a modest $1,000 fee. You literally {i}can't{/i} get a better deal than that. For the price of a small burger, I'll loop you into a deal with an {size=25}(almost){/size} [bluecolor]{i}guaranteed{/i} 5%% rate of return every school day.{/color}"
...
sonia @closedbrow talkingmouth "Look, about the investment, I..."
...
menu:
    "Sonia, don't!":
        ...
        gardenia -surprised @surprised "Eh?"
        ...
        sonia -surprised @talkingmouth "I'm... I'm just... I'm desperate, [first_name]."
    ...
    "Wait, I want in!" if money >= 1000:
        ...
        gardenia @happy "Well, sure! Not a problem with me! The more we all invest, the more we all get!"

        sonia -surprised @sad "Wait... will that mean... would I get less, then?"
        ...
        $ InvestmentChange(1000)

        gardenia @happy "Pleasure doing business with you!"

        sonia @talkingmouth "Ah... right. I'm... I'm not sure if I..."
        ...
        menu:
            ...
            ">Stay silent.":
                ...
                sonia @thinking "Right-o. I'll keep that in mind, then."
                sonia @sadbrow talking2mouth "Ah... thanks for the hand."
                ...
                redmind @confused "Hm... sounds kinda sketchy, but it might be worth checking out. The stock of the shops in-town could definitely do with a bit more attention."

    ">Stay silent.":
        sonia @talkingmouth "Alright. I... I don't have the money on me, right now. When I get it, where should I find you?"

        gardenia @happy "I knew you had some business savvy about you! [bluecolor]If you want to manage your investments, you can find me at the baseball fields.{/color}"
...
dawn "Guys? I fell into a vase, and I can't get out."
...
dawn "I guess this is my life now..."
...
red @closedbrow "Uh, yeah. You too? Who was it from?"
...
red @thinking "Yeah, come to think of it..."
...
nate "Don't worry about it. Oh, but we should exchange contact deets, in case it gets loose, and we need you to wrangle it again."
...
red @thinking "Yeah, but where to?"

pause 1.0

red @talkingmouth "...She's not responding."

ethan @thinking "Maybe she went to bed already? 'Studying dreams'?"
...
ethan @thinking "Nah, mostly just worried about the curfew. It's {i}really{/i} soon."
...
ethan @thinking "I mean... she's pretty close to Chadwick, right? And Chadwick isn't exactly happy with you, if what Nigerundayo's been telling me is correct."
...
brendan @talking2mouth "Ah, yeah, sorry, Hilbert. Didn't hear that, either. I was on the phone with May. What'd you say?"
...
red night @thinking "Hm... remember when those Lopunny and Buneary attacked us?"
...
ethan @thinking "It's weird that they came so far out of the forest. And so many of them, too. Lopunny normally live there, right?"

redmind @thinking "It reminds me of that Absol that ran out of the mountains... they have to be connected somehow, right?"

red @thinking "Maybe something moved into their territory."
...
ethan @happy "{size=25}Unless...?{/size}"
...
red @thinking "Actually, we're here to study, but that just felt right to say in the moment."
...
if (lopunnyobj in playerparty or lopunnyobj in box):
    red @thinking "I mean... I caught it, Sir. If it would help, I could give it to Professor Oak to study for a while?"

ethan @thinking "Besides what your daughter's told you, I'm not sure that I can think of anything else."

drayden @sad "Hm..."

red @thinking "There was a meteor that landed outside of campus a while ago. But, right before that, there was an Absol that came down from the mountains. Almost like it was warning us about the meteor."

red @thinking "That Absol was outside of its habitat, and it was acting really crazy, too. Like the Lopunny."
...
if (absolobj in playerparty):
    ...
    red @thinking "The Absol's in my PC box... well, Janine's, actually... in case you want to see it, Sir."
...
red @thinking "Um... Sonia Magnolia. It seems like Mr. Lance talked to you and you worked out some sort of deal. Since she was a student last year, she isn't available for most of the tuition waivers, right?"
...
ethan @thinking "What do you mean, Sir?"
...
brendan @talkingmouth "Did you guys run into Hilbert as well? He went out after you guys."

show ethan with dis

ethan @surprised "Huh? No, we didn't see him at all. It's past curfew now, isn't it?"

calem @thinking "Hm... concerning. One can only imagine what he's getting himself into now."
...
nate @thinking "Things are getting weirder and weirder. And it's all centered around that meteor. If {i}my{/i} team wasn't the first there... who was?"
...
show nate surprised at night with dis:
    ease 0.5 xzoom -1 xpos 0.75 

hilbert @talkingmouth "You. What are you doing out so late?"

nate -surprised @happy "Hey, H! Just enjoying the night air. What about you?"
...
nate "Woah, buddy, what?"

hilbert "I've been watching you for weeks now. Every single Steel-type class. I {i}knew{/i} I had seen you before. I might have forgotten, like so much else in my life, but my subconscious knew."

pause 1.0

hilbert @sad "I thought I'd dreamed it, to be honest. No way a... a {i}child{/i} could be responsible for what happened."

hilbert "But I recognize that hair. That undersuit. Those glassy, dark eyes of yours."
...
hilbert "You'll tell me what those eyes saw. {i}Now.{/i}"

nate @thinking "I... what... {i}what{/i} did I see?"

hilbert "{cps=30}My parents.{w=0.5} You were the last one to see my parents.{w=0.5}{/cps}{nw}" 

show blank2

extend "{w=0.5} {cps=15}{i}Alive.{/i}{/cps}"
