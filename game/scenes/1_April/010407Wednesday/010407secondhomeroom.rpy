...
oak @closedeyes "I simply need time to collect my thoughts. Given the importance of the conversation we're to have, it wouldn't do to tell you anything... incorrect."

hide oak with dis
show oakbg with dis

redmind "Sigh. That's Old Man Oak for you. A brilliant, brilliant man, but nothing short of a miracle can get him to move on anyone else's schedule..."
...
blue uniform angry "{size=18}--t{/size}{size=20}ell{/size}{size=22}ing{/size} {size=24}you{/size} {size=26}to{/size} {size=28}get{/size} {size=30}out{/size} {size=32}of{/size} {size=34}my{/size} {size=36}way{/size} {size=38}!{/size}"

redmind "That sounded like [blue_name].{w=0.5} What's he trying to start now?"

show blue angry:
    xpos 1300 alpha 0.0
    ease 0.5 xpos 1000 alpha 1.0

show janine angrybrow angrymouth:
    xpos 350 alpha 0.0
    pause 0.25
    parallel:
        ease 0.5 alpha 1.0
...
janine @talkingmouth"And I'm telling you we're not open for new memberships yet!{w=0.5} All that hair must be weighing down on that puny brain of yours!"

red @talkingmouth "Uh, hi. Is this where the Battle Team meets?"

show janine -angrybrow -angrymouth with dis:
    xpos 450
    ease 0.5 xpos 400
    
janine "Another one?"

show janine angrybrow with dis:
    xpos 400
    ease 0.5 xpos 450

janine "Look, if you have any complaints about our selection process, please take them to the team advisor!"
...
janine @closedbrow talkingmouth"Yes. Do you know him?{w=0.7}{nw}"
extend @angrybrow talkingmouth" Please tell him that {color=#0048ff}the Battle Team isn't open to new members until later in the year!{/color}"
...
blue "Shut up and let me in!{w=0.5} Do you have any idea who I am?"

janine @talkingmouth "I know you're annoying as hell."
...
play sound "Audio/Metal Door Slam.ogg"
...
if WonBattle("Blue1"):
    ...
    redmind @confusedeyebrows "What reputation?"

    blue @thinking "Wait, if they find out that we're both from Pallet Town, then they would.{w=0.25}.{w=0.25}.{w=0.5} and I..."
...
red @talkingmouth "...Anyway, what's the deal?{w=0.5} Don't tell me you actually expected them to let you join just like that."
...
blue @closedbrow talkingmouth "I bet you had no idea, but the Battle Team's hosting an exhibition match here at 6 p.m. tonight.{w=0.5} Everyone in school's gonna be showing up."

red @thinking "That's a lot of hype for just an exhibition."

blue @angry "Are you dense or what?{w=0.5} This is Kobukan Academy's Battle Team we're talking about."
blue @thinking "Tch, why are you even in this school?"
...
brendan @talkingmouth "Ready, guys?"

ethan @talkingmouth "Three..."
calem @talkingmouth "Two..."
brendan @talkingmouth "One..."

play sound ["Audio/Pokemon/Ball sound.ogg", "audio/Pokemon/Cries/669.wav", "audio/Pokemon/Cries/172.wav"]
...
play sound ["Audio/Pokemon/Ball sound.ogg", "audio/Pokemon/Cries/285.wav"]
...
ethan @talkingmouth "After our chat last night, we all called our parents and asked for them to be sent over."
brendan @thinking "I think the little guy missed me. When I let him out at the Pokécenter, he let his spores out everywhere!"
brendan @surprised "Got in a little trouble for that..."
calem @thinking "Yes, and my Flabébé is being... tsundere."
...
brendan "Shroomish, where are you going? Wait for me!"
calem "Flabébé? Please, not now! I'll give you lots of attention!"
...
play sound "Audio/Pokemon/Cries/172.wav"
...
red @happy "There's an exhibition match at the Battle Hall! The Battle Team is going to show off for us. Thought you guys might want to come!"
...
ethan @thinking "Yeah... still no luck figuring out what's up with us. Or our Pokémon, I guess. I've tried to ask Professor Cherry a few times, but I haven't learned anything."

red @thinking "Same here. I think Professor Oak is going to tell me something soon, though."
...
$ playerparty.append(Pokemon(25, level=9, nickname=pika_name, ivs=[3, 2, 5, 6, 3, 4], nature=Natures.Lax, gender=Genders.Male, moves=[GetMove("Thunder Wave"), GetMove("Thunder Shock"), GetMove("Play Nice"), GetMove("Tail Whip")], ability="Freelectric"))
...
redmind -uniform @talkingmouth "Wow, the whole school is here.{w=0.5} I guess it's a good thing we showed up early after all."

$ renpy.music.stop(channel='crowd2', fadeout=7.0)

show brendan at rightside with dis

brendan @surprised "Yeah, I knew it was gonna be crazy, but this is ridiculous.{w=0.5} I had no idea the Battle Team was this popular."

show calem at leftside with dis

calem @thinking "Seems some people are still trying to get in. I do hope no-one gets crushed."

show ethan at centerside with dis

ethan @sadbrow talkingmouth "It's orientation week all over again.{w=0.5} I still can't get used to big crowds like this."

brendan @talkingmouth "Oh yeah, you're from New Bark Town.{w=0.5} Isn't the population there under 1,000 or somethin'?"

ethan @happy "Something like that."

if (classstats["Ground"] == 5):
...
ethan @thinking "It'd be weird, I think, if he didn't. No way he'd miss such a high-profile battling thing, right?"

calem @thinking "His presence is no guarantee we'll see him, though."
...
brendan surprised "Yo, look over there, [first_name]!"
...
calem @thinking "Hm.{w=0.5} Lance.{w=0.5} It makes sense that he'd be here."
brendan @surprisedbrow talkingmouth "Yeah. I mean, he {i}is{/i} the manager of the Battle Team."
...
ethan @thinking "It's freakin' crazy to me that a National Champion has the time to manage a random school's Battle Team."
...
brendan @happy "He actually won two National Championships! Becomin' a National Champion twice is pretty unheard of."
red @thinking "Yeah... I'm fuzzy on the details, but I think that's why the Kantonian and Johtonian league merged into the Indigo League, like, a decade ago."
...
calem @thinking "Besides the top four, the last world Championships was a slaughter."
...
calem @talkingmouth "Er... yes. And I'm still kicking myself that I missed that."
...
red "Whoa, slow down, [pika_name]!{w=0.5} You're gonna leave crumbs all over my clothes."
...
redmind "...I can feel everyone's eyes on me.{w=0.5} What did I do?"
red @confusedeyebrows talkingmouth "Uh... can I help you? Mr. Lance? Sir?"

lance @talkingmouth "Unacceptable."
lance @sadbrow "Feeding your Pokémon this...{w=0.5}{nw}"
extend @angrybrow talkingmouth " this {i}swill.{/i}"

lance @sadbrow talkingmouth "Do you not have the vaguest idea of the dietary needs of a Pokémon?"

red @talking2mouth confusedeyebrows "I.{w=0.25}.{w=0.25}.{w=0.25} thought I did?"
...
redmind @angrybrow frownmouth ".{w=0.5}.{w=0.5}.{w=0.5}Assholes."
...
lance @talkingmouth "Junk food like that will only serve to rot their body and mind.{w=0.5} If your Pokémon want snacks, feed them Poké Beans or berries."
...
lance @talkingmouth "This Pikachu.{w=0.5} Do you plan on including it in your academy evaluations?"

red "Yeah, of course. He's my partner.{w=0.5} If there's anyone I can count on, it's{nw}"

show lance closedbrow with dis:
    xpos 0.6
    ease 0.6 xpos 0.5

lance @talkingmouth "Remove him at once."

red "--him.{w=0.5} Wait, what?"

lance @talkingmouth "Your Pikachu is inadequate.{w=0.5} Using such a weak Pokémon will get you nowhere in this academy."
lance @talkingmouth "If, for example, a student applied to the Battle Team with this Pokémon on their team..."
lance @angrybrow talkingmouth "I would disqualify them at once, regardless of their battle skills."

$ renpy.music.play("Audio/Stadium_murmur.ogg", channel='crowd3', loop=True, fadein=1.0)

pause 1.5

lance -closedbrow @talkingmouth "Even though you're allowed six, a single Pokémon like that will only serve to be a crippling liability to your party."
...
silver "You think because you're a Champion, you know what makes a Pokémon good or bad? You think you can tell the worth of a Pokémon at a glance?!"
...
silver "You know what your problem is?! Because you can't get your dick hard unless you're a World Champ, and you failed at that, you're looking for someone else to blame."
...
silver "I knew another guy who couldn't accept his own failure. And he took a trip down Tohjo falls. The fast way."
...
lance -angry @talkingmouth "Silver, was it?{w=1.0} Please, tell me. What do you think is the appropriate punishment for this flagrant display of disrespect?"
...
lance closedbrow @talkingmouth "As a part-time employee of this school, I cannot do that."

pause 1.0

lance @talkingmouth "So hear this, instead." 
lance -closedbrow @talkingmouth "Regardless of your skills.{w=0.5} Regardless of the Pokémon you have on-hand.{w=0.5} Regardless of how much you {i}deserve{/i} it."
lance @angrybrow talkingmouth "You two will {i}not{/i} join the Battle Team."

silver surprised "W-wait. [first_name], too? I was the one who--{nw}"

lance @closedbrow "I have said it;{w=1.0} It is so."

red frownmouth -talking2mouth "..."

show silver -surprised with dis

redmind "I know I should just walk away and keep my mouth shut, but I can't just let that slide."
...
lance @talkingmouth "Is that right?"
...
red @closedbrow talking2mouth "Instructor Bruno said we needed impeccable grades, a strong team, and the vote of our team members to join the Battle Team. He didn't say anything about your vote."
red @angry "So go ahead and 'advise' the team not to take us. Me, Silver, [pika_name]. We're getting in anyway. Because we're friends."
...
lance @closedbrow talkingmouth "...Naive."
lance @angrybrow talkingmouth "The world doesn't work like that.{w=0.5} Say what you want about your Pokémon, 'friendship' will not help you any more than twiddling your thumbs."
lance @angrybrow talkingmouth "Get stronger Pokémon. And a sense of which fights you {i}cannot{/i} win. In this world, only the best of the best can survive.{w=0.5} The weak and foolish are purged."
    
red "..."

lance closedbrow "I'd take my advice if I were you. And as for you, Silver... learn to hold your tongue, else you're liable to lose it."
...
show ethan sad at centerside with dis
show calem sad at leftside with dis

ethan @sadbrow talking2mouth "H-hey... [first_name].{w=0.5} Are you alright?"
    
brendan @sadbrow talkingmouth "That looked painful."
...
brendan @talkingmouth "But damn, I was really surprised when that red-haired kid said all that stuff to him.{w=0.5} That was incredible!"
...
brendan "Oh yeah. H-heh.{w=0.5}{nw}"
extend sad " Y'know, Lance is kind of a big deal, and if I said the wrong thing it might've made you look worse and--"

calem sad @sadbrow talking2mouth "I apologize. I failed in my first priority as your roommate--as your friend."
ethan sad @sadbrow talking2mouth "Yeah, me too. I just figured if I stepped in, then he'd start yelling at me... 'cause I'm kinda in the same boat as you..."
...
leaf @talkingmouth "Yeah, this place is so packed just getting here was like trying to navigate a maze."
...
leaf "Who's this little guy?{w=0.5} Is he one of your Pokémon from home?"
...
may @talkingmouth "Aw! And is [pika_name] getting along well with your lil' Shroomy, Brendan?"
brendan @happy "Well, uh, they haven't actually met yet. Didn't think it was a good idea to let him out in here."
may @thinking "Oh, that's probably smart..."
...
brendan surprised "Hey, how come he's not shocking {i}her?{/i} What's up with that?!"

leaf @surprisedbrow talkingmouth "What?"

may "Oh, is [pika_name] getting along with your [starter_species_name]?"
...
leaf @talkingmouth "How long have you and [pika_name] been together?"
    
red @thinking "Since I was 10 years old.{w=0.5} Old Man Oak gave me and [blue_name] a Pokémon each as a present."

may @surprised "'[blue_name]?' That spiky-haired weirdo in our homeroom?"

red "Yeah, that's him. Anyway, we've been best friends ever since then.{w=0.5} [pika_name], not [blue_name].{w=0.5} [pika_name] and I do everything together."
red @happy "...Even if he tries to get out of our runs!"

leaf @talkingmouth "So, how come you haven't evolved him yet?"
...
leaf @talkingmouth "Oh yeah, I heard on the way over here that Janine is battling in the first match."

red @talkingmouth "Who's Janine?"

leaf @surprisedbrow talkingmouth "You don't know?{w=0.5} She's the Battle Team captain two years running and a runner-up at the National Tournament last year."
...
leaf @thinking "She's a tough one.{w=0.5} Uncompromising, supposedly, so you might want to steer clear if you ever see her."
...
brendan "Hey, I think they're starting!"
...
$ BecomeNamed("Janine")
redmind "That must be Janine."

redmind @thinking "...Wait a minute, that's the woman who kicked Blue out of the Battle Hall!"
redmind "So. That's the woman I need to convince to let me onto the Battle Team."
...
"Announcer" "\"Welcome ladies and gentlemen, boys and girls, to this special exhibition match hosted by Kobukan Academy's Battle Team! How're you all feeling tonight?\""
...
"Announcer" "\"Awesome! Let's get right to it then!\""
"Announcer" "\"Boy, do we have a treat for you all.{w=0.5} First up to grace the battlefield is none other than our Battle Team's very own captain, Janine!\""
...
"Announcer" "\"Janine is starting out strong with her signature Pokémon, Venomoth!{w=0.5} These two have dominated the Kobukan leaderboards since their arrival and they show no signs of stopping!"
...
$ renpy.music.queue("audio/pokemon/cries/419.wav", channel="altcry", loop=None)
...
"Announcer" "\"On the other side, her opponent sends out a Floatzel, a Pokémon well-known for its agility in the ring!{w=0.5} Can these two rise up to the challenge?"

hide janine

janine uniform @talkingmouth "He's going to need a lot more than just speed to match my Venomoth."
...
"Announcer" "\"And now the moment you've all been waiting for!{w=0.5} The first round of the annual Kobukan Academy Battle Team exhibition!\""
...
"Announcer" "\"And we're underway!{w=0.5} It looks like the challenger's Floatzel is jumping straight in with Aqua Jet!\""
...
play sound "Audio/Pokemon/Moves/AquaJet.ogg"
...
"Announcer" "\"...Well, that didn't seem to do much!\""
...
leaf @talkingmouth "You know, with Floatzel's speed, it's probably able to hit first, even without the boost from Aqua Jet."
...
play sound "Audio/Pokemon/Moves/StunSpore.ogg"
...
"Announcer" "\"What's this?{w=0.5} The arena is being filled with Venomoth's Stun Spore! Spectators close to the ring please avoid inhaling too much of it!\""
...
"Announcer" "\"Oh no, it looks like Floatzel is paralyzed!{w=0.5} Things are definitely not looking good for our challenger!\""
...
calem @thinking "Now the Venomoth can take out the Floatzel at its own pace."
ethan @thinking "That Floatzel... what is it, a water type? I think I've seen some Venomoth with Energy Ball."
...
play sound "Audio/Pokemon/Moves/EnergyBall.ogg"
$ renpy.pause(1.9, hard=True)

$ renpy.music.play("Audio/Stadium_chant.ogg", channel='crowd2', loop=True, fadein=1.0)

$ renpy.music.play("Audio/Pokemon/cries/419.wav", channel="altcry", loop=None)
show exhibition01
show exhibit01veno
show exhibit01para
show energyball
...
"Announcer" "\"Spectacular! With a surprise Energy Ball, Floatzel is down and out in one hit!{w=0.5} How will Janine's opponent respond to this explosive power?\""   
...
brendan @happybrow talking2mouth "Heh, why bother with tactics when you can just go for a knockout punch, huh?"
...
leaf @talkingmouth "It was smart of her to not to reveal it so soon.{w=0.5} That Floatzel's Trainer was totes caught off guard."
leaf @embarrassed "But... I wonder why she bothered with the Stun Spore?"
calem @thinking "Perhaps she wasn't certain of her ability to KO. If your opponent is of an unknown strength, it's usually a good strategy to lower their potential to manageable levels before attempting an attack."
    
$ renpy.music.stop(channel='crowd2', fadeout=3.0)

$renpy.music.play("audio/pokemon/ball sound.ogg", channel="altcry", loop=None)
$ renpy.music.queue("audio/pokemon/cries/344.wav", channel="altcry", loop=None)
...
"Claydol" "\"Clay.{w=0.33} Dol.\""

"Announcer" "\"And the next Pokémon out of the gate is Claydol, a dual Ground and Psychic-type Pokémon!{w=0.5} What can the challenger be planning to use with such a peculiar Pokémon?\""

hide exhibition01
hide exhibit01veno

red "Hm. Claydol. Hoenn-native. It has high defenses, normally. Only ability is Levitate, but that's probably not going to come up here..."
    
leaf @talkingmouth "I might go with Venomoth on this one.{w=0.5}{nw}"
extend leaf @closedbrow talkingmouth " Claydol's got the defensive advantage since it's tankier by nature, but that Venomoth might have another trick up its sleeve."

may surprised "You really think Venomoth's that strong?"

leaf happy "Hey, this {i}is{/i} Janine we're talking about here.{w=0.5} You never know."

calem @thinking "A lot of people take note of Claydol's bulk, but it also boasts a respectable offensive moveset.{w=0.5} Keep in mind its super-effective Psychic moves."

brendan @talkingmouth "Nah, my money's still on Venomoth."
...
"Announcer" "\"And the second round is underway!{w=0.5} Let's see what our challenger's Claydol has in store for Janine's Venomoth!\""
...
play sound "Audio/Pokemon/Moves/QuiverDance_Base.ogg"
$ renpy.pause(2.0, hard=True)
play sound "Audio/Pokemon/Moves/QuiverDance_Boost.ogg"

"Announcer" "\"Oh! It looks like Venomoth is opening this round with two successive Quiver Dances, ladies and gentlemen!{w=0.5} It's quickly raising its strength! How will our challenger respond?\""
...
$ renpy.music.play("Audio/crowd_cheer.ogg", channel='crowd3', loop=False, fadein=0.0)
play sound "Audio/Pokemon/Moves/Psybeam.ogg"
...
"Announcer" "\"And Claydol attacks with a powerful Psybeam!{w=0.5} Folks, I think that's it for Venomoth!"
...
"Announcer" "\"Wait, what's this?{w=0.33} I don't believe it! Venomoth completely shrugged it off!{w=0.5} There's barely a scratch on it thanks to Quiver Dance!\""
...
"Announcer" "\"...And Venomoth still continues to power up with its {i}third{/i} use of Quiver Dance!{w=0.5} If our challenger doesn't have an answer, Venomoth will be unstoppable!\""

play sound "Audio/Pokemon/Moves/CosmicPower_Boost.ogg"

show exhibit02psy with dis:
    alpha 1.0

"Announcer" "\"It looks like Claydol is responding by using Cosmic Power to bolster its defenses, but it might be too little too late!{w=0.5} Is this the end of the road for Claydol?\""
...
$ renpy.music.play("Audio/crowd_cheer.ogg", channel='crowd3', loop=False, fadein=0.0)
play sound "Audio/Pokemon/Moves/GigaDrain.ogg"
$ renpy.pause(1.5, hard=True)
$ renpy.music.play("Audio/Pokemon/Cries/344.wav", channel="altcry", loop=None)
$ renpy.pause(0.25, hard=True)
$ renpy.music.play("Audio/Stadium_chant.ogg", channel='crowd2', loop=True, fadein=0.5)
...
"Announcer" "\"Ouch!{w=0.3} And there it is! A direct hit with Giga Drain!{w=0.5} Claydol is down and out for the count! Janine and Venomoth easily take round two!\""
"Announcer" "\"The challenger is down to his last Pokémon!{w=0.5} Is this Pokémon the key to a surprise reversal or will this be yet another clean sweep from Janine?\""
...
calem @thinking "Splendid. She made no wrong moves. It's like watching a skilled painter..."
ethan @thinking "Yeah, but why'd she have Giga Drain {i}and{/i} Energy Ball? I don't know if that was the play."
...
"Announcer" "\"Now we're here in the third round!{w=0.5} Has the challenger figured out a way to deal with Janine's Venomoth?\""
...
"Announcer" "\"It's a... Victreebel!{w=0.5} Can this Pokémon be the saving grace for our challenger or will Janine take yet another victory under her belt?\""

may @surprised "Two Kanto Pokémon... I'm not familiar with 'em, but this looks like another even match, right?"
leaf @closedbrow talkingmouth "Not even.{w=0.5} With those Quiver Dances, Venomoth's got everything it needs to mop up that Victreebel."
...
"Announcer" "\"And here we go, ladies and gentlemen!{w=0.5} We have Venomoth and Victreebel facing off in the third and what could be the final round of this exhibition match!\""

hide venomoth
hide victreebel

$ renpy.music.play("Audio/crowd_cheer.ogg", channel='crowd3', loop=False, fadein=0.0)
play sound "Audio/Pokemon/Moves/Psychic.ogg"
...
"Announcer" "\"Venomoth attacks with a powerful Psychic attack, but Victreebel is trying to recover with Synthesis!{w=0.6}{nw}"

play sound "Audio/Pokemon/Moves/Synthesis.ogg"

extend " Can our challenger hang on?"
...
"Announcer" "\"And Victreebel is down! Another absolutely crushing victory for Janine!\""
...
"Announcer" "\"Is anyone surprised at the results?{w=0.5} Once again Janine has proven why she is the captain of Kobukan Academy's Battle Team!\""
...
show brendan surprised at rightside with dis
...
brendan -surprised @sadbrow happymouth "Hey, this was my first time, too!{w=0.5} How was I gonna know the guy's Pokémon would get stomped like that?"

show leaf surprisedbrow with dis

red @frownmouth "..."

leaf -surprisedbrow @talking2mouth surprisedbrow "You okay, [first_name]?{w=0.5} You look really pale."

red @surprisedeyes surprisedeyebrows "Huh?{w=0.25} Oh, yeah, I'm fine.{w=0.5} It's probably from all the excitement just now."
...
narrator "You stay to watch the rest of the exhibition matches, but Janine's match still stands head and shoulders above the others."
