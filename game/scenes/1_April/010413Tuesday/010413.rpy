...
red @surprised "Woah. Hello there, welcome to my personal space. What's up?"
...
brendan @talkingmouth "Maybe catch some new Pokémon, y'know?"

if (not sandshrewcaught):
    brendan @thinking "I still wanna try and catch a Sandshrew after that last one got away."

red @happy "Oh, sure! That sounds great. Just the two of us?"

$ renpy.music.stop(channel='crowd', fadeout=1.0)

brendan @talking2mouth "Yeah. I'd ask the others, but..."
...
hilbert @talkingmouth "Try to get me out of this bed before 7:00 AM and I will commit murder."

brendan surprised "But you're already awake, bro."
...
brendan thinking "...I don't get it."
...
brendan @talkingmouth "Huh, not sure I like the name. How about, uh, Flachu?"
...
red "...No, I think it'd still be better if we went with your third idea."

show brendan with dis

brendan @thinking "Yeah, that was a good one. What was that one, again? Flanachu?"

red "Yeah, except two 'n's. So, like, Flan-nachu."
...
red @thinking "Hungry for the nachos, I guess? I know you don't like sweet things."
...
brendan @talkingmouth "We sure are! Thought we might catch some Pokémon, as well."
...
red @thinking "Really... of all the candidates I know of, it seems like he's been trying the hardest. And his ideas sound really good, if hard to achieve."
...
red @thinking "...Huh. What do you mean?"
...
if (not council_campaigning):
    menu:
        ...
        "Yeah, fine, I guess.":
            ...
            red @thinking "I wasn't, at first, but it seems like everyone else is kinda pushing me into it. I mean, even Cheren thinks I'm his biggest opponent."
...
red @thinking "Maybe? I've been hanging out with [highest] a lot. Maybe people just see the two of us together, know that [highest] is involved in Student Council stuff, and think I am, too?"
...
menu:
    "{color=#b7669e}[[Charm] Wait! Put in a good word for me with the Council?" if council_campaigning:
    ...
    "{color=#b7669e}[[Charm] Wait! I want to join the Student Council!" if not council_campaigning:
...
red @thinking "It'd probably be a lot harder to catch Pokémon with both of our guys acting at once."

brendan @surprised "Oh, yeah, that makes sense, dude." 
brendan @talkingmouth "Well, catch you later, then! Let's meet up before we go back to the dorms."

hide brendan with dis

if (GetNumItems("Poké Ball") == 0):
    red "...Uh. Brendan?"
    ...
    if (ballsleft > 10):
        ...
        $ inventory["Poké Ball"] = ballsgained
        ...
        brendan @thinking "Uh... I don't actually have all that many after Saturday. Think you could just take, like, five?"
...
brendan -happy @talkingmouth "No shit? That's amazing, man! Or, uh, wo-man!"
...
if (monscaught == 1):
    ...
    red @thinking "Maybe more, if I can find somewhere to store these guys..."
else:
    red @thinking "Not this time."

if (not sandshrewcaught):
    if (ballsused == 20):
        brendan @talkingmouth "Oh, hey, guess what! I found a Poké Ball in a thorn bush. I guess Brawly musta left it there, or maybe one of the other SC guys."

    $ brendansandshrewobj.Gender = Genders.Male
    $ brendansandshrewobj.Level = 7
    $ brendansandshrewobj.RecalculateStats()
    brendan @talking2mouth "I caught a Sandshrew! Pretty sick, right? It's not the same one from last time, but it's still cool."
else:
    brendan @talkingmouth "I didn't get anything."

brendan @thinking "I was kinda hoping I'd catch somethin' else, but there's always next time, I guess."
...
play sound "Audio/Pokemon/Cries/359.wav"
...
red @confusedeyebrows talking "What was that?"

skyla -surprised @thinking "Hm... I don't see anything..."

brendan -surprised sadbrow frownmouth @talkingmouth "Oh, man, that's an Absol. They're from Hoenn, and they're bad news."

skyla @surprised "Bad news? How can a Pokémon be bad news?"

brendan @talkingmouth "They only show up when something {i}real{/i} bad is about to happen. Normally they stay up in their mountains, so if one's close enough for us to hear, we might be in trouble."
...
python:
    skyladucklettobj = Pokemon(580, level=13, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Water Sport"), GetMove("Water Pulse"), GetMove("Wing Attack"), GetMove("Defog")], nature=Natures.Timid, gender=Genders.Female, ability="Hydration")
    skylalaprasobj = Pokemon(131, level=13, nature=Natures.Modest, ivs=[24, 24, 24, 24, 24, 24], moves=[GetMove("Sing"), GetMove("Growl"), GetMove("Confuse Ray"), GetMove("Ice Shard")], ability="Hydration")
    absolobj = Pokemon(359, level=30, moves=[GetMove("Double Team"), GetMove("Quick Attack"), GetMove("Night Slash"), GetMove("Swords Dance")])

    absolobj.ApplyStatus("frenzied")

    trainer1 = Trainer("red", TrainerType.Player, playerparty)
    trainer2 = Trainer("brendan", TrainerType.Ally, [brendansandshrewobj, brendanmudkipobj, brendanshroomishobj])
    trainer3 = Trainer("skyla", TrainerType.Ally, [skyladucklettobj, skylalaprasobj])
    sidemonnum = 359
...
$ gymbattles["Absol1"]  = _return

stop music
queue music "audio/music/fieldstheme_start.ogg"
queue music "audio/music/fieldstheme_loop.ogg"

show brendan surprised at rightside
show skyla surprised at leftside
with dis

if (absolobj in playerparty):
    $ absolobj.Level = 8
    $ absolobj.Moves =[GetMove("Pursuit"), GetMove("Quick Attack"), GetMove("Leer"), GetMove("Scratch")]
    $ absolobj.Experience = absolobj.CalculateAllExperienceNeededForLevel(8)
    $ absolobj.RecalculateStats()
    
    brendan "Woah! Look at that, [first_name]! The Absol totally calmed down."
    skyla "I'm surprised, [first_name]! You're kinda crazy-good at battling, huh? Are you sure you just started out?"

    $ ValueChange("Skyla", 2, 0.25, pausing=False)
    $ ValueChange("Brendan", 2, 0.75)

    red @thinking "Pretty sure, yeah. Besides, looks like it's not actually as powerful as we thought... I guess it was just {i}really{/i} upset."

elif ((trainer1.HasMons() or trainer2.HasMons() or trainer3.HasMons()) and absolobj.GetHealthPercentage() <= 0):
    brendan "Ah, geez, that was tough! We just barely beat it off..."
    skyla "I'm surprised, [first_name]! You're pretty good at battling, huh? Are you sure you just started out?"

    $ ValueChange("Skyla", 1, 0.25, pausing=False)
    $ ValueChange("Brendan", 1, 0.75)

    red @thinking "Pretty sure, yeah."

elif ((trainer1.HasMons() or trainer2.HasMons() or trainer3.HasMons()) and absolobj.GetHealthPercentage() > 0):
    brendan "Ugh, that thing was too tough. Good thing we got out of there when we did."
    ...
    brendan "What the heck? This thing kicked all our asses, and just ran off? Geez..."
    skyla @angry "Ugh. What a lousy battle. I totally messed that up..."

    $ ValueChange("Skyla", -1, 0.25, pausing=False)
    $ ValueChange("Brendan", -1, 0.75)

brendan -surprised @thinking "It's weird, though. Absol're bad luck, everyone knows that, but normally they're pretty calm. Wonder what got this one so riled up?"

red @thinking "Who could say? Maybe its habitat was disturbed by something? Or--"
...
brendan sadbrow frownmouth @talkingmouth "Not me, man."

skyla -surprised @happy "We {i}need{/i} to investigate that!"

brendan @talkingmouth "I dunno. Meteors are nasty business, y'know? We should probably get a Professor. And homeroom's soon..."

skyla @angrybrow happymouth "But what if it's an alien invader?! Then we have a duty to vanquish it!"

brendan @angrybrow talkingmouth "Alien invaders aren't our problem. I mean, we're not even legal trainers yet."

skyla @happy "Well, what do you think, [first_name]?"

pause 2.0

skyla surprised "Uh... where'd he go?"

brendan @talkingmouth "Dude's already halfway to the impact site... guess we're going, then."

skyla -surprised @winkbrow happymouth "Well, hey, if you want to run back and get a Professor, be my guest. {i}I'm{/i} going!"

show skyla:
    ease 0.5 xpos -0.5

brendan @talkingmouth "Man... I really can't afford to be late to class..."
...
red @thinking "Wait... what's the number for an ambulance in Kobukan? It's not 119, like in Kanto... is it 999? Like in Galar?"
...
brendan @thinking "Hey, I caught up. What's--"
...
skyla @thinking "I think I saw a helicopter in Inspira... if I hitched a ride to the city, I might be able to steal it..."
...
tia sadeyebrows sadeyes frownmouth "..."
...
red @thinking "Uh... anyone?"

skyla @sad "Oh, I think I know what's happening here..."

skyla @sadbrow happymouth "Hey, sweetie. Can you, um... speak?"

show tia closedeyes -surprised with dis

narrator "The girl shakes her head."

brendan @talkingmouth "Damn. Imagine not being able to speak, {i}and{/i} gettin' hit by a meteor. That's double-unlucky."
...
red @thinking "Wait... where is it?"

brendan @talkingmouth "Most meteors vaporize before they hit the ground, and those that don't usually vaporize on impact."
brendan @thinking "Maybe the meteor hit, vaporized, and then she fell in the crater?"
...
red @thinking "Alright. Uh... let's head back to the school. Brendan, I know you want to get back to homeroom, so you don't need to stick around for this."

brendan @sadbrow happymouth "Are you sure, man?"

red @thinking "Yeah, it's fine. Go on back to homeroom. I'll call you if something comes up."

brendan @talkingmouth "Alright. Thanks a bunch."
...
red @thinking "Right... And Skyla, you obviously don't, either."
...
skyla winkbrow smirkmouth "Well, that's a neat trick."

red @surprised "I swear I didn't do it on purpose."
...
red "So. We've got paper here. What's your name?"

narrator "The girl, in quick and messy handwriting, writes 'Venetia. But I go by Tia.'"

$ BecomeNamed("Tia")
red "Venetia, huh? That doesn't sound like a Kobukanian name. Or a Kantonian one, come to think of it."

tia @happy "It's not! I'm new to the region."

red "Are you a student here? That would explain how you ended up in the fields..."
...
red @confusedeyebrows frownmouth "...Are you sure?"
...
show oak surprised at leftside 
...
oak "Lad?! What on earth happened? And who's this?"
...
red @thinking "When we arrived at the impact zone, there weren't any traces of the meteor, but this girl was in the crater."

oak -surprised @talkingmouth "Oh? Are you alright?"

show oak surprised with dis

narrator "Tia quickly begins signing at Professor Oak at rapid speed."

pause 2.0

oak -surprised @sadeyes sadeyebrows sadmouth "Er... apologies, but this method of communication utterly escapes me."

red "Hold on, she's got a pad of paper, and a pen here."
...
oak thinking "Who's your homeroom teacher? I'll let them know that you were delayed, and not to mark you absent."
...
oak surprised "Eh? Cherry? Well, she's a decent enough Professor, I suppose. Startlingly young. But that's certainly nothing I hold against her."

oak thinking "Actually, I keep meaning to have a good sit-down conversation with her, but her schedule is so full, I can rarely find time to talk to her."

oak -thinking @talkingmouth "Anyway, miss, your homeroom teacher?"

tia -surprised @happy "Professor Cherry."

oak @talkingmouth "Oh, is that right? Well, perhaps you can just tell her to call me to confirm your excused absence. Tracking that woman down outside of her homeroom is utterly impossible."

pause 1.0

oak @thinking "Ah, excuse me. I don't believe I caught your name. Refresh me?"
...
red @thinking "So, you actually {i}are{/i} Bianca?"
...
red @thinking "And you have her ID card."

narrator "Tia nods."

red @thinking "Did you steal it?"
...
red "Here, take my phone. Just type out a message there."
...
red @confusedeyebrows happymouth "Hey, c'mon. What's with the sad face?"
...
red @thinking "...Do you know how to sign up for electives? If this is your first day, and you weren't around for the opening weekend, you must've missed that, right?"
