...
oak "...To summarize, the range of Pokémon intelligences varies greatly. Some, like Alakazam, have consistently shown IQs that are incomparably vast compared to human intelligences."
oak "On the other hand, certain Pokémon, like fellow Psychic-type Slowbro, register as so unintelligent that they should be incapable of the very act of living." 
oak "As such, many leading researchers believe that human methods of measuring intelligence simply don't work on Pokémon, whether intelligent..."
...
oak "...or not.{w=0.5} And that, I believe, was the bell. Dismissed!"
...
red uniform @thinking "Vongole... oh, Ti-Bianca! Got it!"
...
oak @thinking "I haven't a clue. The team collected a few shards, and took a soil sample of the area, but nothing substantial."
...
ethan @thinking "Uh... a new girl showed up in Professor Cherry's class today."

red @smilemouth confusedeyebrows "Oh, that right? What was she like?"
...
ethan @thinking "Sometimes Professor Cherry would ask her a question, and she would just flash gang signs at her."
...
brendan @talking2mouth "Yeah? What's up?"

red @talkingmouth "Hey. You haven't told anyone about that meteor this morning, have you?"

brendan @thinking "Nah. I was going to tell May later, but the whole thing kinda just freaks me out, so I haven't gotten around to it."
...
red @thinking "...I guess May's alright. Couples shouldn't have secrets from each other. But tell {i}her{/i} not to tell anyone."
...
redmind @thinking "I don't have Skyla's contact information, so I'll just talk to her tomorrow, I guess..."
