...
alder "And that's the end of the lecture!"
...
red @sadeyes sadeyebrows "{size=25}I'm not paying to be here at all...{/size}"
...
red @confusedeyebrows "Uh... okay."

whitney @happy "Go easy on me! I'm very delicate!"

$ trainer1 = Trainer("red", TrainerType.Player, playerparty)
$ trainer2 = Trainer("whitney", TrainerType.Enemy, 
    [Pokemon(173, level=5, gender=Genders.Male, moves=[GetMove("Metronome")], nickname="Treble", ability="Magic Guard"),
    Pokemon(241, level=12, gender=Genders.Female, moves=[GetMove("Defense Curl"), GetMove("Stomp"), GetMove("Milk Drink"), GetMove("Rollout")], nickname="Milty", ability="Scrappy")])

call Battle([trainer1, trainer2], uniforms=[True, True]) from _call_Battle_15
$ gymbattles["Whitney1"]  = _return
...
if (WonBattle("Whitney1")):
    ...
    whitney @sadmouth "B-but... but I {i}really{/i} wanted to! I tried so hard! And so did lil' Treble and tough Milty!"
    ...
    red "It's alright. I know being defeated is disappointing, especially if you're not used to it. And, from how strong you are, I can tell you're {i}definitely{/i} not used to it."

    whitney "Mmm."

    whitney -frownmouth -sadbrow @happy "Hee hee. Thanks, [first_name]. You're pretty cool."
    ...
    whitney @talkingmouth "Aw, don't worry about it. You did really well. And if I hadn't taken you by surprise, I might've lost."
    ...
    whitney frownmouth @talkingmouth "Oh... okay."
...
whitney @happy "You know, most people can't give me a really tough fight. And some don't even try. So it's cool that you went all-out like that."

red @talkingmouth "Oh, yeah? How come?"

whitney @talkingmouth "Don't mean to brag or nothin', but I'm kinda popular! Not, like, {i}Rosa{/i} popular, but well-known enough. And I guess people think beating me would make them look bad?"
...
whitney @talkingmouth "Pretty much, yeah."

red @thinking "Weird question, but there's a student I want to talk with, and she doesn't speak. Do you know anyone in this school who knows sign language?"

whitney @surprised "Do I? Totally. Which region's?"

red @surprised "Uh... I have no idea."

whitney @thinking "Well, if you want to head to lunch together, maybe we can find this girl of yours, and I might recognize her signs."

red @thinking "You have experience with sign language?"

whitney @talkingmouth "Yeah, I even know the Johto variant."
...
whitney @thinking "Anyway, Bianca? Like that blonde who hangs out around the Unovans? Nah, my girlfriend was blue-haired. And her name was... well, it wasn't Bianca."

red @talkingmouth "Huh. Past tense, I'm noticing."

whitney @closedbrow talkingmouth "All good things come to an end. {i}Sigh...{/i}"
