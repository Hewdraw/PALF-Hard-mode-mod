...
alder "And that concludes the lecture! I hope you were keeping a keen eye on the Battle Team tryouts yesterday--you can tell the battlers there were listening to their lessons!"
...
if (GetRelationship("Serena") == "Conspirator"):
    ...
    red @thinking "Um... he's still single. And no wacky hi-jinx have been required to maintain that status."
    ...
    menu:
        ">Accept the pat":
            ...
            python:
                renpy.show("traitspointplus1", [pointsup(0.5), Transform(matrixcolor=TintMatrix("#ff3b90"))])
        ...
        ">Do not accept the pat":
            ...
            serena @sadbrow "Ah, of course. Pardon my forwardness."
...
[Pokemon(pokedexlookupname("Houndour", DexMacros.Id), level=11, moves=[GetMove("Ember"), GetMove("Howl"), GetMove("Snarl"), GetMove("Steady Flame")], ivs=[24, 24, 24, 24, 24, 24], gender = Genders.Male, nature=Natures.Modest, ability="Flash Fire"),
Pokemon(pokedexlookupname("Rhyhorn", DexMacros.Id), level=11, moves=[GetMove("Stomping Tantrum"), GetMove("Smack Down")], ivs=[24, 24, 24, 24, 24, 24], evs=[0, 1, 0, 1, 0, 1], gender = Genders.Female, nature=Natures.Hardy, ability="Lightning Rod", intelligence=1)],
number = 2)

call Battle([trainer1, trainer2], uniforms=[True, True]) from _call_Battle_47
$ gymbattles["Serena1"]  = _return
