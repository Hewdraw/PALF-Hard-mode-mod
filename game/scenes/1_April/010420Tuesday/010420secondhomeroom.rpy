...
oak "Oh? Looks like we're out of time. I get so caught up in my lectures on sound-based moves. I can hardly stop talking about them, hah hah!"

pause 1.0

oak "Well, I thought that was funny. Dismissed!"
...
oak -surprised @talking2mouth "Please explain."
...
red @thinking "Okay, no-one else is here... Janine basically confessed that the Battle Team tryouts weren't {i}really{/i} for me. All I needed to do was show up, and she would let me in."
...
oak -surprised @happy "Oh, there's no need to worry about that. He said he had the utmost respect for my professorial position, and understood me loud and clear. His exact words."
...
oak @thinking "If the person with Frienergy is aware of their power, and trying to keep it a secret, then its effect is lessened."
...
oak @thinking "Besides. I'm fairly certain that a boy as good-natured as you doesn't truly {i}want{/i} to keep it a secret. You probably want to tell everyone, right? Get that weight off your conscience?"
...
play sound "audio/Auto-Door.wav"
...
sonia @talkingmouth "Er... Am I interrupting something, Professor?"

oak @talkingmouth "No, we were just finishing. What can I help you with, Miss...?"

sonia @talkingmouth "Magnolia. Sonia Magnolia."
...
oak @thinking "Hmmm. Did you say Magnolia? Are you by any chance related to the Professor Magnolia, famed Dynamax scholar of the Galar region?"

sonia @talkingmouth "Right. She's my Gran, actually."
...
sonia @talkingmouth "Well... I've been a bit involved in the study of Wishing Stars in Galar. Actually, I was part of the team that proved they weren't fragments of celestial rock, like we thought, but parts of a massive, unknown, Pokémon."
...
sonia @talkingmouth "Ah... this was my uniform last year, and... yes, it's a bit tight."
...
red @thinking "No, Professor Oak. I'll be going now."
...
ethan @thinking "I dunno, man. With my win ratio, I don't think I'm even getting a rejection letter."
...
ethan @thinking "Bibarel delivered it, but she does stuff for everyone. Ran off before we could ask her."
...
red @thinking "Yeah. Anyone got any scissors?"
...
ethan -surprised @thinking "Oh, wow, that {i}could{/i} blow the ears out of a Loudred. You were right."
...
hilbert -surprised @talkingmouth "If the Battle Team is letting in mediocre trainers like myself, I'm not sure I care to be part of it anymore..."

red @talkingmouth "Well, what did your letter say? Janine must have had a good reason."

hilbert @sad "Just some nonsense about how my strategy to ensure obedience was very creative, and out-of-the-box thinking like that has been sorely lacking in the team's previous rosters."
...
ethan @thinking "{w=0.5}.{w=0.5}.{w=0.5}.{nw}"
...
brendan @talkingmouth "Oh, guys, look! There's some items and stuff in here! Maybe those're your awards for joining the Battle Team?"
...
if (wins > 4):
    ...
    python:
        falinksobj = Pokemon(870, level=9)
        AddMon(falinksobj)
...
queue sound "Audio/Pokemon/Cries/870.wav"
...
if (wins > 4):
    hilbert @sad "Yeah... she gave one to me, too."
...
red @thinking "Not a great idea. It's a Fighting-type. It'd decimate the local population in the fields. Maybe the forest? But even then, it should live in mountains."
...
calem -surprised @talkingmouth "Oh. Well... thank you!"
...
if (wins > 4):
    ...
    red @thinking "Let's see... what kinda name should I give you?"

    label falinksnickname:

    $ falinks_name = renpy.input("{color=#e70000}Your Falinks' nickname? (Press Enter for the default){/color}", length=16, exclude="{}[[]%<>",)
    $ falinks_name = falinks_name.strip()

    if falinks_name == "" or falinks_name == "falinks":
        $ falinks_name = "Falinks"

    red "Hm... I think [falinks_name] would suit you just fine."
...
red @thinking "I should probably get to bed soon, too. Got some awkward conversations to have tomorrow."

calem @thinking "Oh? Care to elaborate?"
...
menu:
    "{color=#60c2f8}[[Wit] >Look through the trash for Ethan's letter.":
    ...
    "{color=#e226a6}[[Patience] >Just go to sleep.":

        $ TraitChange("Patience")

        redmind @talkingmouth "Nah. I'm not going to dig through the trash to read Ethan's private letter. That'd be messed up."
