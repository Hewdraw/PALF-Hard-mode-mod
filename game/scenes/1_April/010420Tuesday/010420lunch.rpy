...
nessa "Your grandma kept asking where you were, and we didn't know what to tell her!"
...
redmind uniform @confusedeyebrows "...Dare I involve myself in this drama?"
...
if (GetRelationship("Nessa") != "Date"):
    ...
    red "[first_name], actually, but that's not important. How are you paying for a second year at Kobukan? You aren't getting any financial aid, right?"
    ...
    nessa @closedbrow "{i}Sigh.{/i} Let's get you sorted for electives."
    ...
    sonia -frownmouth @happybrow "Ness!"
    ...
    nessa @talkingmouth "Don't {i}you{/i} start."
