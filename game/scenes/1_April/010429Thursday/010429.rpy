...
oak "And that's about the end of the lesson, students! Two things to remember. The first is that there will be a quiz in the homeroom at the end of the day. Don't forget that!" 
oak "The second thing is--have you all seen those posters around the school encouraging you to vote in the new student council elections?"

show whitney uniform at leftside with dis

whitney @talkingmouth "Oh, totally! I'm pretty sure that if I vote for Jasmine, she'll open up some kind of accessibility office, and I can get paid for doing what I'm already doing!"
...
dawn surprised "W-w-wait! I meant Calem! Not Cheren. Sorry, I always get their names confused. I meant Calem!"
...
leaf @flirt "Sure, sure, but we're {i}all{/i} voting for [first_name], right?"

oak "Well, I should certainly hope so!"

red uniform @happy "Heh. Professor, I'm not sure you should be saying that, but I appreciate the support."

menu:
    "{color=#e226a6}[[Charm] >Ask for the class' support.":
    ...
    "{color=#b7669e}[[Patience] >Talk up the other hopefuls.":
...
flannery @talkingmouth "Uggggh. Way too early in the morning for this kind of self-promotion."

if (GetRelationship("Flannery") == "Flannery"):
    red @thinking "Didn't you say you had to do a bunch of promotion for your gym, back in Lavaridge?"

    flannery "Yeah."

    pause 0.5

    flannery @closedbrow talkingmouth "And I hated it."

red @happy "Sorry, Flannery! I'll see you in the auditorium on Saturday, though?"

flannery @talkingmouth "Yeah. {i}Everyone{/i}'ll be there. It's too damn early to hold an election, if you ask me, but whatever."
...
whitney -frownmouth @surprisedbrow "Oh? {w=0.5}Guess you caught that, huh?"

whitney @thinking "I'm concerned about Tia. She's been moody recently. Like, since yesterday."

red @confused "That doesn't seem like a very long time to be moody."

whitney @talkingmouth "No, it's not, but she's usually hyper-happy, all the time."

flannery @closedbrow talkingmouth "It gets annoying."

whitney @talkingmouth "A little bit, but it's part of her, you know?"

red @confused "Have you asked her what's wrong?"

whitney @talkingmouth "Yeah, but she won't say. Maybe you could ask her?"

red @thinking "Sure. I'll find her before lunch."

whitney @talkingmouth "Alright. Thanks!"
