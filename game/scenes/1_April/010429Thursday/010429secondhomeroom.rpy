...
oak "Good afternoon, students! Who's ready for today's quiz?"

$ PlaySound("class_groan.ogg", "crowd2")

pause 0.5

oak "Well, there's no use complaining to me about it. Success in these classes is the surest way to graduating with honors."
oak "Besides, do well enough in them, and the school may provide some tuition waivers. Which I'm sure {i}all{/i} of you would appreciate, regardless of your financial situation."
oak "Remember, correct usage of items will be key to handling this test properly. I'll go ahead and tell you that {color=#0048ff}your opponent is not holding an item, and only knows Crunch.{/color}"
oak "I cannot express, enough, the importance of looking over your team {i}very{/i} carefully before committing to any moves."
oak "[bluecolor]Remember, you can see summaries of your party at any time by 'clicking' on the 'Pokémon' option in battle.{/color}"

pause 0.5

oak "...Well, that's a metaphor, but you understand what I mean."
...
if (WonBattle("Oak7")):
    ...
    red @closedbrow frownmouth "...That was bullshit. Just four weeks ago I was using Dragon Rage with a Deino. Could someone stop the school year, please? I'd like to get off."
...
oak "Items are going to be a standard part of the curriculum, moving forward. Expect to see them on most future quizzes, and your classmates using them in battles."
oak "Remember, [bluecolor]all items except berries return to the user at the end of battle.{/color}"

pause 0.5

oak "Well, that's it for today, class.{w=0.5} You're all dismissed."
