...
menu:
    ">Study with Whitney":
        whitney @talkingmouth "Sure, happy to help.{w=0.5}{nw}"
        extend @happy " I'm the {i}best{/i} study partner out there, after all!"
        menu:
            ">Study Normal and Fairy-types":
                ...
                $ IncreaseProficiency("Fairy", 0.35)
    ...
    ">Study with Bianca":
        ...
        menu:
            ">Study Normal and Psychic-types":
                show bianca:
                    xpos xposition
                    linear 0.1 ypos 1.1
                    linear 0.1 ypos 1.0
    ...
    ">Study with Leaf":
        leaf @flirtbrow talkingmouth "Oh, you want a 'private lesson' with Professor Leaf? Then please, step into my office..." 
        menu:
            ">Study Grass, Electric and Dragon-types":
                ...
                $ IncreaseProficiency("Electric", 0.25)
    ...
    ">Study with Tia (and Whitney)" if not IsBefore(14, 4, 2004):
        ...
        whitney @thinking "Girl, tone it down."
        menu:
            ">Study Psychic and Dragon-types":
                ...
                $ IncreaseProficiency("Psychic", 0.2)
                $ IncreaseProficiency("Dragon", 0.2)
    ...
    ">Just join the conversation":
        ...
        if (convo == 0):
            ...
            leaf @flirt "Wait, don't tell me. They were roommates?"
            ...
            red uniform @thinking "You're really good at tests, huh, Bianca?"

            leaf "Dude, it's cause she stays up until three in the morning, studying..."

        elif (convo == 4):
            bianca "What's the cutest Pokemon? I think it's Munna! It's round and pink!"
            ...
            red uniform @thinking "I think [starter_species_name] is pretty cute."

            bianca @surprised "Really? Um... well... that's a choice."

        elif (convo == 5):
            bianca "Bianca's so cute! I'm so glad she joined our table!"
            leaf @thinking "Are you talking about her? Or about yourself, in third person?"
            ...
            gardenia "Oh, gotcha. Man, I've got a swiss army knife of things I learned for exes."
            bianca "I'd like an ex someday! I've never had one."

            red uniform @thinking "I think you might want to start off with having a boyfriend, first?"
            ...
            whitney @thinking "Yeah, and you didn't even bring any Pokemon from home, right?"
