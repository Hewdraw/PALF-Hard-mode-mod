...
menu:
    ">Study with Nate" if "Nate" in npcs:
        ...
        menu:
            ">Study Electric, Steel and Poison-types":
    ...
    ">Study with Skyla" if "Skyla" in npcs:
        ...
        menu:
            ">Study Flying and Water-types":
                ...
                $ IncreaseProficiency("Water", 0.35)
    ...
    ">Study with Nessa" if "Nessa" in npcs:
        ...
        menu:
            ...
            "Nevermind":
                nessa -surprised @sad "Yeah, I figured."
                jump aftercharsbusy
    ...
    ">Study with Sonia" if "Sonia" in npcs:
        ...
        menu:
            ">Study Electric and Fairy-types":
                ...
                $ IncreaseProficiency("Electric", 0.35)
    ...
    ">Study with Rosa" if "Rosa" in npcs:
        ...
        menu:
            ">Study Electric, Psychic and Bug-types":
                ...
                $ IncreaseProficiency("Electric", 0.25)
                $ IncreaseProficiency("Psychic", 0.25)
    ...
    ">Just join the conversation":
        ...
        if (calDate.day == 20 and calDate.month == 4 and calDate.year == 2004):
            ...
            red uniform @thinking "So, who's handling your flights in Unova now?"
            ...
            red uniform @thinking "I can probably name one actor, one pilot, and one model. And they're all at this table."
            ...
            red uniform @thinking "Yeah, I'm pretty sure that no-one wants me to be a model."
            ...
            red uniform @thinking "You don't strike me as a guy with a rich family..."
