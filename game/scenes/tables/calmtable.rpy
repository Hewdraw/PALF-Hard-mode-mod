...
menu:
    ">Study with Sabrina" if "Sabrina" in npcs:
        sabrina @talkingmouth "Fine."
        menu:
            ">Study Psychic and Ghost-types":
                ...
                $ IncreaseProficiency("Psychic", 0.35)
                $ IncreaseProficiency("Ghost", 0.35)
    ...
    ">Study with Bea" if "Bea" in npcs:
        ...
        menu:
            ">Study Fighting and Rock-types":
                ...
                $ IncreaseProficiency("Fighting", 0.35)
                $ IncreaseProficiency("Rock", 0.35)
    ...
    ">Study with Hilda" if "Hilda" in npcs:
        ...
        menu:
            ">Study Poison, Steel and Rock-types":
                ...
                $ IncreaseProficiency("Poison", 0.25)
                $ IncreaseProficiency("Steel", 0.25)
                $ IncreaseProficiency("Rock", 0.25)

            "Nevermind":
                hilda @happy "Oh, you're cancelling? Great. Actualy, there are a couple other things I should be doing right now..."
                jump aftercharscalm
    ...
    ">Study with Cheren" if "Cheren" in npcs:
        ...
        menu:
            ">Study Dark and Normal-types":
                ...
                $ IncreaseProficiency("Normal", 0.35)
    ...
    ">Study with Jasmine" if "Jasmine" in npcs:
        ...
        menu:
            ">Study Steel and Ground-types":
                ...
                $ IncreaseProficiency("Steel", 0.35)
                $ IncreaseProficiency("Ground", 0.35)
    ...
    ">Study with Grusha" if "Grusha" in npcs:
        ...
        menu:
            ">Study Ice and Flying-types.":
                ...
                $ IncreaseProficiency("Ice", 0.35)
                $ IncreaseProficiency("Flying", 0.35)
    ...
    ">Just join the conversation":
        ...
        if ("Cheren" in npcs):
            if (randnum < 0.2):
                ...
                sabrina @talkingmouth "Cheren appreciates your 'ride-or-die attitude,' but he'd actually prefer we just send emails to the administration."

                red uniform @thinking "I dunno, I like Bea's idea more."
                ...
                sabrina @talkingmouth "I am not a suitable opponent for your specialty."
                cheren @sadmouth "Er... I suppose that leaves me, then, but, er..."

                red uniform @thinking "You're afraid of being folded like an old napkin?"
                ...
                sabrina @talkingmouth "Yes. If you were to just leave him alone, you would never see him again."

                red uniform @thinking "Sure, but just 'cause you can't see a problem doesn't mean it doesn't exist."
                ...
                red uniform @thinking "But since it's been asked, might as well answer it. Sabrina?"

                sabrina @talkingmouth "...Everything, everywhere, all at once."
                ...
                sabrina @talkingmouth "I truly wish I could somehow put the concept of selfishness into your mind."
                cheren @sadmouth "Er... I was going to ask if you would help with some Student Council business, but now I feel rather..."
                
                red uniform @thinking "Hm... I mean, this is a great opportunity. I can't think of how I could take advantage of it, though."
            ...
            if (IsDate(26, 4, 2004)):
                ...
                bea @talkingmouth "I see you do not have your cane today, Jasmine. I suppose it's a good day, then."
                ...
                red uniform @thinking "Hey, you can sit wherever you want, Sabrina. We know you can't help the mind-reading."
                ...
                bea @talkingmouth "I would ask one of you to act as my sparring partner tomorrow."
                if ("Grusha" in npcs):
                    grusha @closedbrow "No thanks. Sounds like a pain."
                hilda @talkingmouth "Shit no. I remember what happened last time I agreed to that. My ass {i}still{/i} hurts."
                sabrina @talkingmouth "I am not a suitable opponent for your specialty."
                ...
                red uniform @thinking "I'm afraid of being folded like an old napkin."
                ...
                if ("Grusha" in npcs):
                    grusha @closedbrow "I'd listen to the guy."
                sabrina @talkingmouth "Yes. If you were to just leave him alone, you would never see him again."
                ...
                if ("Grusha" in npcs):
                    grusha @closedbrow "You should take a break. Go snowboarding, or something."
