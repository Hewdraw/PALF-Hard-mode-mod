...
menu:
    ">Study with Blue":
        ...
        menu:
            ">Study Flying and Dragon-types":
                ...
                $ IncreaseProficiency("Dragon", 0.35)
    ...
    ">Study with Hilbert":
        ...
        menu:
            ">Study Ghost, Steel and Ice-types":
                ...
                $ IncreaseProficiency("Ghost", 0.25)
    ...
    ">Just join the conversation":
        ...
        if (randnum < 0.2):
            ...
            blue @closedbrow "Idiots! Why can't you get that it's a stew?"
            ...
            blue @surprisedbrow "What {i}about{/i} him?"
            ...
            red uniform thinking "I heard some people are refusing to visit Galar over Dexit, actually..."
