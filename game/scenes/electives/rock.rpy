...
if (2.1 in persondex["Instructor Olivia"]["ClassesKnown"]):
    menu:
        "{b}>General Studies{/b}":
            pass
        ...
        ">Craft items" if (3.1 in persondex["Instructor Olivia"]["ClassesKnown"]):
            jump itemcraftrock

if (persondex["Instructor Olivia"]["ClassesKnown"] == []): #first class
    $ persondex["Instructor Olivia"]["ClassesKnown"].append(1)
    $ renpy.pause(1.0, hard=True)
    ...
    olivia "Olivia. Just Olivia. Definitely not Missus. Olivia never be a Missus, with my luck."

    redmind uniform thinking "I think our teacher needs therapy..."

    olivia "What am I doing wrong? I stay in shape. I work at a prestigious University. I'm literally throwing myself at any man who makes eye contact."

    redmind "Ah, well, there's your problem."

    olivia "...Nevermind that. Rock-types, right? Hard. Solid. Unbreakable. Unlike my heart..."

    show nessa uniform at rightside with dis
    show bea uniform with dis
    show hilda uniform at leftside with dis

    olivia "Now, the thing about rock types is, despite their reputation as strong defenders, almost all the most powerful rock types focus primarily on offense."
    olivia "Can anyone think of why that might be?"

    hilda @talkingmouth "Is it that rock types have unfavorable elemental matchups against several powerful types?"

    olivia "Yes, that's right. Rock can be destroyed by Fighting, Water, and Ground, easily. That's not even mentioning Grass and Steel."
    ...
    olivia "Well, matched by Fighting, maybe, but yes. Therefore, despite how many rock types present themselves, the best strategy for a Rock-type is to hit fast, hard, and get out."
    ...
    red "Oh boy. This is going to be a depressing class."
    ...
    hide olivia
elif (2.1 not in persondex["Instructor Olivia"]["ClassesKnown"] and classstats["Rock"] >= 10):#Splinter Shield
    show olivia with dis
    if (2 not in persondex["Instructor Olivia"]["ClassesKnown"]):
        hide olivia with dis
        ...
        olivia "...Oh, what does it matter? I've got a job to do."
        ...
        red "[first_name] [last_name], Ms. Olivia."
        ...
        red @thinking "I'd never heard of that move before."
        ...
        $ persondex["Instructor Olivia"]["ClassesKnown"].append(2)
    else:
    ...
    $ gymbattles["Instructor Olivia1"]  = _return

    show olivia with dis

    if (WonBattle("Instructor Olivia1")):
        $ persondex["Instructor Olivia"]["ClassesKnown"].append(2.1)
    ...
    hide olivia with dis
elif (3.1 not in persondex["Instructor Olivia"]["ClassesKnown"] and classstats["Rock"] >= 20):#Hard Stone
    show olivia with dis
    if (3 not in persondex["Instructor Olivia"]["ClassesKnown"]):
        ...
        red @thinking "I was just wondering about those crystals you're wearing."
        ...
        red @thinking "Why would I want a Hard Stone?"
        ...
        $ persondex["Instructor Olivia"]["ClassesKnown"].append(3)
    else:
        red uniform @talking2mouth "Ms. Olivia, I've trained some more. I'm pretty sure I can win this time, if you'd let me try again."
    ...
    $ gymbattles["Instructor Olivia2"]  = _return

    show olivia with dis

    if (WonBattle("Instructor Olivia2")):
        $ persondex["Instructor Olivia"]["ClassesKnown"].append(3.1)
    ...
    hide olivia with dis
elif (4.1 not in persondex["Instructor Olivia"]["ClassesKnown"] and classstats["Rock"] >= 30):#Rock Tomb
    show olivia with dis
    if (4 not in persondex["Instructor Olivia"]["ClassesKnown"]):
        ...
        $ persondex["Instructor Olivia"]["ClassesKnown"].append(4)
    else:
        red uniform @talking2mouth "Ms. Olivia, I've trained some more. I'm pretty sure I can win this time, if you'd let me try again."
    ...
    $ gymbattles["Instructor Olivia3"]  = _return

    show olivia with dis

    if (WonBattle("Instructor Olivia3")):
        $ persondex["Instructor Olivia"]["ClassesKnown"].append(4.1)
        ...
        olivia @sad "Oh, no... am I getting worse at teaching?"
...
if (4.1 in persondex["Instructor Olivia"]["ClassesKnown"]):
...
menu:
    ...
    ">Learn Rock Tomb" if (4.1 in persondex["Instructor Olivia"]["ClassesKnown"]):
...
menu:    
    ">Excavate Hard Stone" if (3.1 in persondex["Instructor Olivia"]["ClassesKnown"]):
