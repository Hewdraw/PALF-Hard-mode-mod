...
if (2.1 in persondex["Instructor Melony"]["ClassesKnown"]):
    menu:
        "{b}>General Studies{/b}":
            pass
        ...
        ">Craft items" if (3.1 in persondex["Instructor Melony"]["ClassesKnown"]):
            jump itemcraftice

if (persondex["Instructor Melony"]["ClassesKnown"] == []): #first class
    $ persondex["Instructor Melony"]["ClassesKnown"].append(1)
    $ renpy.pause(1.0, hard=True)
    ...
    red "Looks like we're getting... a bit of a chilly reception."
    ...
    red "I guess we can't expect to have an ice time here?"
    ethan "Oh, hail no."
    red "Hahaha!"
    ethan -happy "Hah. C'mon, let's--"
    ...
    ethan thinking ".{w=0.25}.{w=0.25}.{w=0.25}"
    red thinking ".{w=0.25}.{w=0.25}.{w=0.25}"

    dawn sad "...Oh, no, I killed it, didn't I?"
    red "Uh... well, it wasn't the most graceful of--"
    ...
    red "Well, I'm going to go check in on Hilbert."
    ...
    red "Well, it seemed kind of interesting.{w=0.5} I know you're taking it because 'it's the best' or whatever..."
    hilbert sad "..."
    hilbert closedbrow "Well, you're more tolerable than Ethan."
    red @angrybrow "Flattered."
    ...
    hilbert -sad "We're seven minutes into the class, and all you've done is tell a lame pun and admit you don't know where your attendance sheet is."
    hilbert @angrybrow "Is this really the look you want to present to new students?"
...
elif (2.1 not in persondex["Instructor Melony"]["ClassesKnown"] and classstats["Ice"] >= 10):#Slow Freeze
    show melony with dis
    if (2 not in persondex["Instructor Melony"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @closedeyes "...But that {i}does{/i} mean you need to start teaching some new material."

        melony -tears @thinking "Ohhh... alright, alright."
        ...
        red @thinking "I'm not familiar with that, I think."
        ...
        melony @thinking "Well, freezing {i}is{/i} a very powerful status."

        red @happy "Well, I'm not going to freeze now! Let me show you a scorching-hot battle!"

        $ persondex["Instructor Melony"]["ClassesKnown"].append(2)
    else:
    ...
    $ gymbattles["Instructor Melony1"]  = _return

    show melony with dis

    if (WonBattle("Instructor Melony1")):
        $ persondex["Instructor Melony"]["ClassesKnown"].append(2.1)
...
elif (3.1 not in persondex["Instructor Melony"]["ClassesKnown"] and classstats["Ice"] >= 20):#Never-Melt Ice
    show melony with dis
    if (3 not in persondex["Instructor Melony"]["ClassesKnown"]):
        ...
        red @thinking "You've been looking at that picture for a while now. Staring at it pretty intently."
        ...
        melony tears sadbrow @talking2mouth "But... he would rather head out on his journey alone. Trainer schools aren't common in Galar, so it's not unusual for boys his age, but... oh... I miss him so."
        ...
        red @sweat thinking "Uh... yeah. Sure."

        $ persondex["Instructor Melony"]["ClassesKnown"].append(3)
    else:
        red uniform @talking2mouth "Mrs. Melony, I'm ready to retake my advancement exam. And I {i}will{/i} advance this time."
    ...
    $ gymbattles["Instructor Melony2"]  = _return

    show melony with dis

    if (WonBattle("Instructor Melony2")):
        $ persondex["Instructor Melony"]["ClassesKnown"].append(3.1)
    ...
    hide melony with dis
elif (4.1 not in persondex["Instructor Melony"]["ClassesKnown"] and classstats["Ice"] >= 30):#Ice Shard
    show melony with dis
    if (4 not in persondex["Instructor Melony"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @thinking "I was just wondering why you, uh, became a teacher."
        ...
        melony @thinking "I thought about going to work at Naranjuva Academy, but I wasn't sure if I'd get along well with the adult students Naranjuva accepts."
        ...
        $ persondex["Instructor Melony"]["ClassesKnown"].append(4)
    else:
        red uniform @talking2mouth "Mrs. Melony, I'm ready to retake my advancement exam. And I {i}will{/i} advance this time."
    ...
    $ gymbattles["Instructor Melony3"]  = _return

    show melony with dis

    if (WonBattle("Instructor Melony3")):
        $ persondex["Instructor Melony"]["ClassesKnown"].append(4.1)
        ...
        melony -closedbrow sadbrow -cry "Since you've beaten an Ice-type, a Pokémon that Ice-types do well against, and one they don't do well against... I can move you up a level."
...
if (4.1 in persondex["Instructor Melony"]["ClassesKnown"]):
...
menu:
    ...
    ">Learn Ice Shard" if (4.1 in persondex["Instructor Melony"]["ClassesKnown"]):
...
menu:    
    ">Craft Never-Melt Ice" if (3.1 in persondex["Instructor Melony"]["ClassesKnown"]):
