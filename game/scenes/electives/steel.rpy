...
if (2.1 in persondex["Instructor Byron"]["ClassesKnown"]):
    menu:
        "{b}>General Studies{/b}":
            pass
        ...
        ">Craft items" if (3.1 in persondex["Instructor Byron"]["ClassesKnown"]):
            jump itemcraftsteel

if (persondex["Instructor Byron"]["ClassesKnown"] == []): #first class
    $ persondex["Instructor Byron"]["ClassesKnown"].append(1)
    $ renpy.pause(1.0, hard=True)
    ...
    red "What's with the shovel and cloak? Is this an archeology class?"
    ethan @thinking "Maybe he's on his way back from conquering a castle?"
    red -thinking @confusedeyebrows "Huh?"
    ethan @happy "Y'know, like a castle full of rats, with a big knight at the end! Like in a video game?"
    red "Ethan, what the hell are you talking about?"
    ...
    byron norm "I respect you standing up for your friend. Don't let me catch you doing it again, though."
    ...
    byron angry2 "You should be familiar with my teaching methods and know that I won't allow any dawdling or bellyaching in this classroom."
    ...
    byron "If you want to succeed in the Pokémon field and beyond that, a weak character and lack of confidence will only serve as a crippling liability."
    byron "This should be common sense, but your generation seems to lack it."
    byron "In this day and age, it's all about hard work."
    byron "I can guarantee you that if you work hard and persevere through the hardships in life, there's nothing you can't do.{w=0.5} But that's easier said than done."
    byron "Like Steel Pokémon, you have to be resilient, determined, but not too forceful to the point of antagonizing others."
    byron "Be tough and guarded, but not to the point where you start putting up walls."
    byron "...I apologize for starting off the class on such a serious note, but I just wanted you all to know that."
    ...
    byron "Well, now that we're all acquainted, let's get started on the lecture."
    ...
    hide byron
elif (2.1 not in persondex["Instructor Byron"]["ClassesKnown"] and classstats["Steel"] >= 10):#Metallize
    show byron with dis
    if (2 not in persondex["Instructor Byron"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @thinking "Oh, uh, the one about... Aron relocation efforts in Hoenn, right? How they were eating up the railways, and--"
        ...
        red @thinking "I even sent an email to a guy who lives in Dewford for a first-hand account. And he was really hard to get anything out of." 
        red @thinking "He just kept talking about how BEAN SPACEMAN is the trendy thing. Personally, I don't get it."
        ...
        red @thinking "Well... yeah, that's how the world {i}should{/i} work."
        ...
        red @thinking "I don't think I know this one...?"

        byron @norm4 "My son invented it. We thought he was going to take over my gym someday. That didn't happen, but..."
        ...
        $ persondex["Instructor Byron"]["ClassesKnown"].append(2)
    else:
    ...
    $ gymbattles["Instructor Byron1"]  = _return

    show byron with dis

    if (WonBattle("Instructor Byron1")):
        $ persondex["Instructor Byron"]["ClassesKnown"].append(2.1)
    ...
    hide byron with dis
elif (3.1 not in persondex["Instructor Byron"]["ClassesKnown"] and classstats["Steel"] >= 20):#Iron Coat
    show byron with dis
    if (3 not in persondex["Instructor Byron"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @thinking "Hm. 133.4 pounds, I think, Sir."

        byron @norm2 "Right. And how much base power would Low Kick have on it?"

        red @thinking "80, unless the Bronzor's ability is Heavy Metal, in which case it would have 100."
        ...
        red @thinking "Those are the items that boost your Steel-type moves by 10%%, right?"
        ...
        $ persondex["Instructor Byron"]["ClassesKnown"].append(3)
    else:
    ...
    $ gymbattles["Instructor Byron2"]  = _return

    show byron with dis

    if (WonBattle("Instructor Byron2")):
        $ persondex["Instructor Byron"]["ClassesKnown"].append(3.1)
    ...
    hide byron with dis
elif (4.1 not in persondex["Instructor Byron"]["ClassesKnown"] and classstats["Steel"] >= 30):#Metal Claw
    show byron with dis
    if (4 not in persondex["Instructor Byron"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @thinking "I don't know. That's what I was hoping the exam would tell me."
        ...
        $ persondex["Instructor Byron"]["ClassesKnown"].append(4)
    else:
        red uniform @talking2mouth "Instructor Byron, I've studied since the last time we fought--and now I'm ready to advance for real."
    ...
    $ gymbattles["Instructor Byron3"]  = _return

    show byron with dis

    if (WonBattle("Instructor Byron3")):
        $ persondex["Instructor Byron"]["ClassesKnown"].append(4.1)
...
byron @norm2 "I can teach Metallize, which is a move that adds the steel type to any Pokemon on the field, including Steel-types."
if (4.1 in persondex["Instructor Byron"]["ClassesKnown"]):
...
menu:
    ...
    ">Learn Metal Claw" if (4.1 in persondex["Instructor Byron"]["ClassesKnown"]):
...
menu:    
    ">Craft Metal Coat" if (3.1 in persondex["Instructor Byron"]["ClassesKnown"]):
