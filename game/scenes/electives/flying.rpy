...
if (2.1 in persondex["Instructor Winona"]["ClassesKnown"]):
    menu:
        "{b}>General Studies{/b}":
            pass
        ...
        ">Craft items" if (3.1 in persondex["Instructor Winona"]["ClassesKnown"]):
            jump itemcraftflying

if (persondex["Instructor Winona"]["ClassesKnown"] == []): #first class
    $ persondex["Instructor Winona"]["ClassesKnown"].append(1)
    $ renpy.pause(1.0, hard=True)
    ...
    winona @talking2mouth "Hello, students."        
    winona @talking2mouth "Let's get this class started right away."
    ...
    if (not IsDate(5, 4, 2004)):
        winona @surprised "I see we have some new students joining us. Well, then..."

    winona @talking2mouth "First off, let me formally welcome you to your first {color=#0048ff}Flying-type class{/color} of the school year."
    winona @talkingmouth"I'm sure it'll be a fulfilling experience for us all."

    pause 1.5

    winona @closedbrow talking2mouth"{size=28}{i}Um... let's see...{w=0.5} I suppose the next thing would be to introduce ourselves.{/i}{/size}"
    ...
    winona @closedbrow talking2mouth "If, however, I start to veer off-course, I trust that you'll give me a heads-up."

    blue angry uniform "{size=30}Great. We've got a complete newbie for a teacher.{/size}"

    pause 1.0

    winona @talking2mouth "Well. Let's begin the lesson, now."
    winona @closedbrow talkingmouth "Let me start off with the basic background of Flying-type Pokémon."
    winona @talking2mouth "Millions of years ago when the world was just created, there were Water and Ground Pokémon..."

    ethan uniform "Basic background, huh? Sounds to me like we're digging real deep in there."
    red "Huh? Looks like Skyla's on her phone... I guess I can't blame her.{w=0.5} This isn't exactly the most exciting way to start off a class."

    window hide

    image note1 = "GFX/Note1.png"
    image note2 = "GFX/Note2.png"
    ...
    winona @sad "...But if you really, really, can't bear to part with it, then at least put it in silent mode."
    ...
    red -happy "Hey, I'm not judging, I think it's cool that you like that show."
    ...
    red "Skyla, you're a pilot. Everything you do is cool by default. You could be into freakin' {i}My Little Ponyta{/i}, and it'd be cool."
    skyla ".{w=0.25}.{w=0.25}.{w=0.25}"
    ...
    red "Of course. Your secret's safe with me."
    ...
    winona @closedbrow talking2mouth "...And that's when we believe Flying Pokémon were born, long after the birth of Arceus.{w=0.5} With its power, it is responsible for all the Pokémon we see here today."
    ...
    if (IsDate(5, 4, 2004)):
        winona "Yes? Your name is...?"

        calem @talkingmouth "It's Calem, miss."

    winona @talking2mouth "Go ahead, Calem."

    calem @thinking "Isn't Rayquaza the ancestor of Flying Pokémon?{w=0.5} Like how Water and Ground Pokémon came from Kyogre and Groudon, respectively."
    calem @talkingmouth "Rayquaza created the sky, and all the Pokémon that came with it was a byproduct, right?"
    ...
    winona @closedbrow talking2mouth "Rayquaza may be the first Pokémon we can categorize as a Flying-type, but like I've mentioned, we can trace even further back to Arceus, the creator."
    ...
    ethan thinking "Although my grandma would flip her lid if she knew Kobukan was teaching Arceism..."
    ...
    hide winona
elif (2.1 not in persondex["Instructor Winona"]["ClassesKnown"] and classstats["Flying"] >= 10):#Wing It
    show winona with dis
    if (2 not in persondex["Instructor Winona"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        winona "But you're clearly all bored to tears."
        ...
        red "That's alright. It's [first_name]."
        ...
        red @thinking "Wow. Yeah, I can see how that would be useful. Okay! I'm ready to go!"

        $ persondex["Instructor Winona"]["ClassesKnown"].append(2)
    else:
    ...
    $ gymbattles["Instructor Winona1"]  = _return

    show winona with dis

    if (WonBattle("Instructor Winona1")):
        $ persondex["Instructor Winona"]["ClassesKnown"].append(2.1)
        ...
        winona @talking2mouth "That's alright. At least we livened the class up. Try again in the future, okay?"

        redmind uniform @thinking "Damn... that was an embarrassing loss. Still, at least I learned something..."

    hide winona with dis
elif (3.1 not in persondex["Instructor Winona"]["ClassesKnown"] and classstats["Flying"] >= 20):#Sharp Beak
    show winona with dis
    if (3 not in persondex["Instructor Winona"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)

        winona @talkingmouth "[first_name]."

        red uniform @talkingmouth "Yes, Instructor Winona?"

        winona @talkingmouth "Do you think you're ready to take the advancement exam?"

        red @thinking "Um... geez, Instructor, I don't know. Absolutely no offense intended, but isn't it your job to tell me if I am?"

        winona @talkingmouth "Yes. But I just want to make sure you agree."
        winona @sadbrow happymouth "I'm still a pretty new teacher. I figure you, my students, have the best understanding of... well, your current understanding of the material."
        ...
        winona @happy "Well, I don't want to push you out of the nest before you can fly, if that makes sense."

        red @happy "Absolutely. And, as a flightless primate, I appreciate your concern."

        winona @talkingmouth "Hah. So, how are you feeling?"

        red @thinking "Well... what do I get if I take the advancement exam?"
        ...
        red @thinking "That sounds useful."

        pause 0.5

        red @happy "Then, yeah! I believe I can fly!"

        winona @happy "Oh, I love that song."

        pause 0.5

        winona @sad "Right, right. The exam."

        $ persondex["Instructor Winona"]["ClassesKnown"].append(3)
    else:
        red uniform @talking2mouth "Instructor Winona, I'm ready to try the advancement exam again. Will you let me?"
    ...
    $ gymbattles["Instructor Winona2"]  = _return

    show winona with dis

    if (WonBattle("Instructor Winona2")):
        $ persondex["Instructor Winona"]["ClassesKnown"].append(3.1)

        winona @talkingmouth "Good work. That's your second exam down, right? {size=30}Where was that paperwork I put your first exam results on...?{/size}"
        winona @closedbrow talkingmouth "...Hm. Well, I'll have to find it later. For now, though, take this."
    ...
    hide winona with dis
elif (4.1 not in persondex["Instructor Winona"]["ClassesKnown"] and classstats["Flying"] >= 30):#Pluck
    show winona with dis
    if (4 not in persondex["Instructor Winona"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        winona @talkingmouth "That's right. I was very lucky to get a job at Kobukan immediately out of postgrad. Apparently, there weren't many other qualified Flying-type specialists, so the pool was pretty small."
        ...
        $ persondex["Instructor Winona"]["ClassesKnown"].append(4)
    else:
        red uniform @talking2mouth "Instructor Winona, I'm ready to try the advancement exam again."

    winona @talkingmouth "This will be a standard one-on-one battle. {color=#0048ff}This time, I cannot recommend bringing a Flying-type.{/color}"
    ...
    $ gymbattles["Instructor Winona3"]  = _return

    show winona with dis

    if (WonBattle("Instructor Winona3")):
        $ persondex["Instructor Winona"]["ClassesKnown"].append(4.1)

        winona @talking2mouth "Good job. That's three tests you've completed. Acccording to this rubric, you needed to beat a Flying-type, beat a Pokémon strong against the Flying-type, and beat a Pokémon weak to the Flying-type."
...
if (4.1 in persondex["Instructor Winona"]["ClassesKnown"]):
...
menu:
    ">Learn Wing It":
        $ taughtmove = "Wing It"
    ">Learn Pluck" if (4.1 in persondex["Instructor Winona"]["ClassesKnown"]):
        $ taughtmove = "Pluck"
    "Nevermind":
...
menu:    
    ">Obtain Sharp Beak" if (3.1 in persondex["Instructor Winona"]["ClassesKnown"]):
