...
if (2.1 in persondex["Instructor Burgh"]["ClassesKnown"]):
    menu:
        "{b}>General Studies{/b}":
            pass
        ...
        ">Craft items" if (3.1 in persondex["Instructor Burgh"]["ClassesKnown"]):
            jump itemcraftbug

if (persondex["Instructor Burgh"]["ClassesKnown"] == []): #first class
    $ persondex["Instructor Burgh"]["ClassesKnown"].append(1)
    $ renpy.pause(1.0, hard=True)
    ...
    brendan "...Um, What, uh, what does 'rendering models' mean?"
    ...
    hide burgh
elif (2.1 not in persondex["Instructor Burgh"]["ClassesKnown"] and classstats["Bug"] >= 10):#Chrysalize
    show burgh with dis
    if (2 not in persondex["Instructor Burgh"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        show brendan uniform at farrightside 
        with dis

        brendan @happy "Hey, don't say that, bro! I think it looks great."
        ...
        brendan @talkingmouth "Yeah, and the mandibles look kinda like a moustache anyway, so you're good, man!"
        ...
        brendan @thinking "Uh, a lot of 'em have cocoon stages?"
        ...
        brendan @sadbrow talkingmouth "Uh... Burgh, it kinda sounds like you're sayin' we shouldn't be training Bug-types."
        ...
        $ persondex["Instructor Burgh"]["ClassesKnown"].append(2)
    else:
    ...
    $ gymbattles["Instructor Burgh1"]  = _return

    show burgh with dis

    if (WonBattle("Instructor Burgh1")):
        $ persondex["Instructor Burgh"]["ClassesKnown"].append(2.1)
    ...
    hide burgh with dis
elif (3.1 not in persondex["Instructor Burgh"]["ClassesKnown"] and classstats["Bug"] >= 20):#Silver Powder
    show burgh with dis
    if (3 not in persondex["Instructor Burgh"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        $ persondex["Instructor Burgh"]["ClassesKnown"].append(3)
    else:
        red uniform @talking2mouth "Burgh, I've studied since the last time we fought--and now I'm more than ready to beat you."
    ...
    $ gymbattles["Instructor Burgh2"]  = _return

    show burgh with dis

    if (WonBattle("Instructor Burgh2")):
        $ persondex["Instructor Burgh"]["ClassesKnown"].append(3.1)
    ...
    hide burgh with dis
elif (4.1 not in persondex["Instructor Burgh"]["ClassesKnown"] and classstats["Bug"] >= 30):#Silver Wind
    show burgh with dis
    if (4 not in persondex["Instructor Burgh"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        $ persondex["Instructor Burgh"]["ClassesKnown"].append(4)
    else:
        red uniform @talking2mouth "Burgh, I've studied since the last time we fought--and now I'm more than ready to beat you."
    ...
    $ gymbattles["Instructor Burgh3"]  = _return

    show burgh with dis

    if (WonBattle("Instructor Burgh3")):
        $ persondex["Instructor Burgh"]["ClassesKnown"].append(4.1)
...
if (4.1 in persondex["Instructor Burgh"]["ClassesKnown"]):
...
menu:
    ...
    ">Learn Silver Wind" if (4.1 in persondex["Instructor Burgh"]["ClassesKnown"]):
...
menu:    
    ">Craft Silver Powder" if (3.1 in persondex["Instructor Burgh"]["ClassesKnown"]):
