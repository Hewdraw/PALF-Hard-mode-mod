...
if ((calDate.day > 11 or calDate.month > 4) and persondex["Erika"]["ClassesKnown"] == []):
    narrator "You recognize a familiar student and go to approach her."

    show erika uniform with dis

    if (classstats[classtype] > 5):
    ...
    erika @thinking "Yes, it had originally been intended for me to simply attend Kobukan Academy in a provisionary role."
