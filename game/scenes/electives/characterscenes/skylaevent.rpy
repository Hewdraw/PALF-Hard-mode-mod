...
if (not persondex["Skyla"]["Named"]):
    ...
    red -happy "All the way over there? You've got good eyes."

    skyla surprised "Really?"

    red "What? I mean, you {i}must{/i} know."

    skyla happy "No, I know, it's just..."
    skyla -happy "I don't think anyone's ever told me that. Normally I'm the one who tells people I've got good eyes!"
    ...
    red "No. So you must be a pretty good one. Don't want to be a sniper who looks like a sniper, right?"

    skyla thinking "Oh, yeah... that'd be like a ninja who wears bright orange, right?"

    red "Yeah, or one of those spandexed teens with attitude."
    ...
    red "Yeah. Neither am I."
    
    skyla thinking "Um... anyway, to answer your first question, I'm actually a pilot."
    ...
    skyla -thinking "Not sure what the rules are in Kobukan, but in Unova, where I come from, you only need to be seventeen. And I was flying solo since I was sixteen."

    red "Hey, that's pretty impressive. How'd you end up doing that?"

    skyla thinking "Well, I'm from Mistralton City, in the West, but there's a town on the East side of the region called Lentimas, and they were, like, really isolated, so..."
    skyla happy sweat "I learned to fly so I could, uh, transport stuff over there. Food and medicine and stuff."

    pause 1.0

    red "Uh... so you had family there, or something?"

    skyla -happy -sweat talkingmouth "Nope. No connection. Well, before I got my pilot's license, anyway."

    red "So you just... learned to fly planes... to help out a town on the opposite side of the region? That you had no connection to?"
    ...
    red -happy "I'm really impressed. I came up to chat, just expecting a casual conversation, but now... wow."
    ...
    red @angrybrow "Is that an invitation?"

    skyla winkbrow "Think of it more like a threat."

    pause 1.0

    skyla -winkbrow "Soooo...?"
    ...
    red "...Skyla? And you're a pilot?"

    skyla @angry "Yeah, I've heard that one before."

    red "Forgive me. It was too easy."
