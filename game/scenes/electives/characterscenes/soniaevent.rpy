...
if (not IsBefore(20, 4, 2004) and "ClassMeet" not in GetEvents("Sonia")):
    ...
    sonia @thinking "Oh... hello. [first_name], right?"
    ...
    sonia @closedbrow talkingmouth "Just thinking about the kerfuffle I caused is... rather embarrassing."
    ...
    sonia @talkingmouth "Oh, yes."

    if (location == "electric"):
        sonia @happy "Lieutenant Surge is a real barrel of laughs. He's a fantastic teacher."

        sonia @talkingmouth "My partner, Yamper, has been with me for many years. He's a good boy." 
        sonia @sad "I wanted so desperately to help him become strong, and I certainly ought to have been able to, given the instruction I recieved. That didn't quite pan out, though."
    elif (location == "fairy"):
        sonia @happy "Instructor Valerie is a splendid teacher. Her commitment to her goals and lifestyle is nothing but impressive."

        sonia @sad "There was a thought, back in Galar, that I might become a Fairy-type gym leader at some point. That didn't quite pan out, though."
    ...
    sonia @talkingmouth "Ugh. I'm a wreck."

    pause 1.0

    red @talkingmouth "I think you're being too hard on yourself."

    sonia @surprisedbrow talkingmouth "Oh, you do, do you? I've had three once-in-a-lifetime chances, and I've bungled all of them. What descriptor asides from 'wreck' fits me, then?"

    red @talkingmouth "Determined. You didn't give up."

    sonia @talkingmouth "Ugh. I gave up my dignity, though..."
    ...
    sonia @talkingmouth "Ah. Well. She's... not a fan. Of me. I can't say that anything she said was wrong, necessarily, but..."

    sonia sadbrow @sadmouth "I would have appreciated the, ah... break. Just a break would have been all I needed. Just a break..."

    pause 0.5

    sonia @thinking "{i}...Sigh.{/i}"
    ...
    sonia -sadbrow @talkingmouth "Well. I don't know what I can do. Or if I can even do anything. But I, at the very least, have been through this school before. So I might be able to give you a bit of advice."

    red @thinking "I'll keep that in mind."

    sonia @talkingmouth "Mm."

    pause 0.5

    sonia @happy "If it helps, I've got a pretty good memory, and I remember most of the assignments I was given last year."

    sonia @talkingmouth "So... like, if you want me to help you... I can."
    sonia @closedbrow "No need to pay, of course. I just want to help my teammates. Reckon that might make up for last year."
