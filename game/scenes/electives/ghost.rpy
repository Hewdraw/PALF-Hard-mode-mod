...
if (2.1 in persondex["Instructrice Fantina"]["ClassesKnown"]):
    menu:
        "{b}>General Studies{/b}":
            pass
        ...
        ">Craft items" if (3.1 in persondex["Instructrice Fantina"]["ClassesKnown"]):
            jump itemcraftghost

if (persondex["Instructrice Fantina"]["ClassesKnown"] == []): #first class
    $ persondex["Instructrice Fantina"]["ClassesKnown"].append(1)
    $ renpy.pause(1.0, hard=True)
    ...
    fantina happy2 "And much to my delight, {i}c'était magnifique!{/i}{w=0.5} They were unlike anything I have seen!"
    ...
    show gardenia surprised uniform:
        xpos 0.25 ypos 2.0
        ease 0.2 ypos 1.0
    ...
    hide hilbert at rightside with dis
    hide sabrina at leftside with dis
    ...
    hide fantina
elif (2.1 not in persondex["Instructrice Fantina"]["ClassesKnown"] and classstats["Ghost"] >= 10):#Deathless
    show fantina with dis
    if (2 not in persondex["Instructrice Fantina"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        fantina norm @norm2 "Ah, but, {i}mon cherie!{/i} I was just so revelled by your progress in the class, it thrilled me!"
        ...
        red @thinking "Okay... so, that being the case, then... what do shows and ghosts have in common?"
        ...
        red @thinking "So... what does that mean for battle?"
        ...
        red @thinking "Hm. Sounds edgy. I'm not sure what that does...?"
        ...
        red @thinking "Seems like it'd still be really good. But I guess you wouldn't teach a bad move, huh?"
        ...
        $ persondex["Instructrice Fantina"]["ClassesKnown"].append(2)
    else:
    ...
    $ gymbattles["Instructrice Fantina1"]  = _return

    show fantina with dis

    if (WonBattle("Instructrice Fantina1")):
        $ persondex["Instructrice Fantina"]["ClassesKnown"].append(2.1)
...
elif (3.1 not in persondex["Instructrice Fantina"]["ClassesKnown"] and classstats["Ghost"] >= 20):#Spell Tag
    show fantina with dis
    if (3 not in persondex["Instructrice Fantina"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @surprisedeyebrows "Oh. Well, that's fine, too."
        ...
        $ persondex["Instructrice Fantina"]["ClassesKnown"].append(3)
    else:
        red uniform @talking2mouth "Fantina, I've brushed up on the script since last time, and I'm ready for an encore."
    ...
    $ gymbattles["Instructrice Fantina2"]  = _return

    show fantina with dis

    if (WonBattle("Instructrice Fantina2")):
        $ persondex["Instructrice Fantina"]["ClassesKnown"].append(3.1)
    ...
    hide fantina with dis
elif (4.1 not in persondex["Instructrice Fantina"]["ClassesKnown"] and classstats["Ghost"] >= 30):#Shadow Punch
    show fantina with dis
    if (4 not in persondex["Instructrice Fantina"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @thinking "Hm... well, they're not very physically bulky. Most of them, I mean. A few have high defenses, but they often have low health."
        ...
        $ persondex["Instructrice Fantina"]["ClassesKnown"].append(4)
    else:
        red uniform @talking2mouth "Fantina, I've brushed up on the script since last time, and I'm ready for an encore."
    ...
    $ gymbattles["Instructrice Fantina3"]  = _return

    show fantina with dis

    if (WonBattle("Instructrice Fantina3")):
        $ persondex["Instructrice Fantina"]["ClassesKnown"].append(4.1)
...
if (4.1 in persondex["Instructrice Fantina"]["ClassesKnown"]):
...
menu:
    ...
    ">Learn Shadow Punch" if (4.1 in persondex["Instructrice Fantina"]["ClassesKnown"]):
...
menu:    
    ">Craft Spell Tag" if (3.1 in persondex["Instructrice Fantina"]["ClassesKnown"]):
