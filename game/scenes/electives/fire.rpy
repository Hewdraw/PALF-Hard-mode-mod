...
if (2.1 in persondex["Instructor Blaine"]["ClassesKnown"]):
    menu:
        "{b}>General Studies{/b}":
            pass
        ...
        ">Craft items" if (3.1 in persondex["Instructor Blaine"]["ClassesKnown"]):
            jump itemcraftfire

if (persondex["Instructor Blaine"]["ClassesKnown"] == []): #first class
    $ persondex["Instructor Blaine"]["ClassesKnown"].append(1)
    $ renpy.pause(1.0, hard=True)
    ...
    if (not (calDate.month == 4 and calDate.day == 5)):
        blaine "Ah, looks like we've got some new faces! Ethan and [first_name], right? I hope you're excited to be in my class!"
    else:
        blaine "Hello, students! I'll wager you're all very excited to be here, yes?"

    show blaine:
        xpos 800 alpha 1.0
        
    blaine "Well, it doesn't matter if you are or not, because you will be!"
    if (not (calDate.month == 4 and calDate.day == 5)):
        ...
        blaine @surprised "This is the {color=#0048ff}Fire class,{/color} for all you knuckleheads that might be in the wrong class.{w=0.5} And I'll be your instructor for the year."
    
    $ BecomeNamed("Instructor Blaine")
    blaine happy "You can call me Blaine.{w=0.5} I've been researching Fire Pokémon since your parents were in their diapers!"
    ...
    blaine "Yes, Fire is one of the most popular Pokémon types and it's no surprise that my class is always jam-packed!"
    ...
    blaine "That's because Fire Pokémon have all the best aspects of strength and intelligence!"
    blaine "They are naturally powerful.{w=0.5} There's no need for any of that silly effort training this generation is so obsessed with!"
    ...
    show fireclass_b:
        subpixel True
        zoom 1.0 xpos 0
        ease 1.5 zoom 1.1 xpos -100 ypos -100

    narrator "Your head slowly tips forward as you drift into unconsciousness."

    pause 1.0

    play sound "Audio/Wood Kick.ogg"
    show fireclass_b:
        zoom 1.1 xpos -100 ypos -100
        block:
            parallel:
                ease 0.03 xpos -120
                ease 0.03 xpos -80
    ...
    show fireclass_b:
        zoom 1.15 xpos -100 ypos -100
        ease 0.7 zoom 1.0 xpos 0 ypos 0

    show serena uniform at leftside:
        alpha 0.0
        ease 0.5 alpha 1.0

    red "Uh... what's up, Serena?"
    ...
    if (timeOfDay == "Morning"):
        ...
        flannery closedbrow tiredmouth uniform ".{w=0.25}.{w=0.25}."

        play sound "Audio/Snore_F.ogg"
        ...
        "Male Student" "\"Is it coming from that girl over there?\""
        ...
        flannery surprised -veins "..."

        blaine "Pardon me? Sorry, my hearing's not as good as it used to be, little missy."

        flannery sweat sadbrow talkingmouth "U-Uh, I said, 'I love Boldore'...{w=0.3} or something..."

        blaine "I see."
        blaine "Thank you for sharing that with us, but this is the Fire class, not the Rock class.{w=0.5} If you want to discuss Rock Pokémon, you can speak with me after class."

        show flannery:
            xpos 300 ypos 1.0
            ease 1.0 xpos 100 ypos 1.2
            
        flannery thinking -sweat "Right, sorry..."
        ...
        flannery closedbrow tiredmouth ".{w=0.25}.{w=0.25}."
        ...
        show flannery surprised uniform:
            alpha 0.0 xpos -270 ypos 1.1 zoom 1.2
            ease 0.25 alpha 1.0 xpos 300 ypos 1.0
        ...
        flannery sweat sadbrow talkingmouth "O-oh. I'm very sorry, Professor. This class is so warm, and your voice is so soothing, I dozed off.{w=0.5}{nw}"
        ...
        flannery happy -sweat "Of course, Sir! Sorry."
        blaine "Moving on! When the wonders of trading was first invented, the capsule system..."

        if (persondex["Flannery"]["Value"] == 0):
            redmind "Wow. Flannery's {i}really{/i} different in the afternoons.{w=0.5} She's kind of cute to watch."
    ...
    blaine "Hmm, looks like our time is up.{w=0.5} No homework! Class is dismissed!"

    hide flanintro
elif (2.1 not in persondex["Instructor Blaine"]["ClassesKnown"] and classstats["Fire"] >= 10):#Steady Flame
    show blaine with dis
    if (2 not in persondex["Instructor Blaine"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)

        narrator "The class is coming to the end of one of Instructor Blaine's snore-inducing reminiscences, when... "
        ...
        red @thinking "Fire types have really strong offensive matchups, and their moves are often very powerful."

        blaine surprised "Is that your final answer, then?"

        red @thinking "Hm... well, actually... Fire is a pretty good defensive typing. It's got more resistances than any other type except Steel."
        ...
        red @thinking "Are there a lot of them?"
        ...
        blaine neutral "I'll be able to teach you Steady Flame. A decades' worth of scientific research lead to a {i}consistent{/i} way for Fire-types to burn a foe--without relying on any of that Ghost-type voodoo nonsense."

        red @thinking "That sounds really useful."
        ...
        $ persondex["Instructor Blaine"]["ClassesKnown"].append(2)
    else:
    ...
    call Battle([trainer1, trainer2], customexpressions=["red uniform", "red uniform angrybrow happymouth", "blaine neutral", "blaine happy"], reanchor=[False, True]) from _call_Battle_30
    $ gymbattles["Instructor Blaine1"]  = _return

    show blaine with dis

    if (WonBattle("Instructor Blaine1")):
        $ persondex["Instructor Blaine"]["ClassesKnown"].append(2.1)
...
elif (3.1 not in persondex["Instructor Blaine"]["ClassesKnown"] and classstats["Fire"] >= 20):#Charcoal
    show blaine with dis
    if (3 not in persondex["Instructor Blaine"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @thinking "Hm... I'm not sure, Instructor Blaine."
        ...
        red @thinking "Well, I think I'd have to take it on a case-by-case basis. There's no one item that is the best option for {i}every{/i} Pokémon."
        red @thinking "The closest item I can think of that fits that description would be... I dunno, Leftovers?"
        ...
        $ persondex["Instructor Blaine"]["ClassesKnown"].append(3)
    else:
    ...
    call Battle([trainer1, trainer2], customexpressions=["red uniform", "red uniform angrybrow happymouth", "blaine neutral", "blaine angry"], reanchor=[False, True]) from _call_Battle_86
    $ gymbattles["Instructor Blaine2"]  = _return

    show blaine with dis

    if (WonBattle("Instructor Blaine2")):
        $ persondex["Instructor Blaine"]["ClassesKnown"].append(3.1)
    ...
    hide blaine with dis
elif (4.1 not in persondex["Instructor Blaine"]["ClassesKnown"] and classstats["Fire"] >= 30):#Flame Charge
    show blaine with dis
    if (4 not in persondex["Instructor Blaine"]["ClassesKnown"]):
        $ renpy.pause(1.0, hard=True)
        ...
        red @thinking "Oh! I see. I {i}think{/i} I'm sleeping well enough, yeah..."
        ...
        red @thinking "Yeah. I remember it was a really big thing a few years back. It happened just a few miles south of where I lived, in Pallet Town."
        ...
        red @thinking "Wow. Well... I guess that explains it. But I {i}really{/i} am fine. It's just the warmth of the classroom."
        ...
        $ persondex["Instructor Blaine"]["ClassesKnown"].append(4)
    else:
    ...
    blaine @neutral2 "Go on, then, pick one Pokémon. {color=#0048ff}But don't pick a Fire-type, or you'll be snuffed out.{/color}"
    ...
    $ trainer1 = Trainer("red", TrainerType.Player, [playerparty[newindex]])
    $ trainer2 = Trainer("blaine", TrainerType.Enemy, [
        Pokemon("Drednaw", level=22, moves=[GetMove("Counter"), GetMove("Headbutt"), GetMove("Rock Tomb"), GetMove("Razor Shell")], ability="Shell Armor", item="Sitrus Berry")
    ])

    call Battle([trainer1, trainer2], customexpressions=["red uniform", "red uniform angrybrow happymouth", "blaine neutral", "blaine happy"], reanchor=[False, True]) from _call_Battle_87
    $ gymbattles["Instructor Blaine3"]  = _return

    show blaine with dis

    if (WonBattle("Instructor Blaine3")):
        $ persondex["Instructor Blaine"]["ClassesKnown"].append(4.1)
...
if (4.1 in persondex["Instructor Blaine"]["ClassesKnown"]):
...
menu:
    ...
    ">Learn Flame Charge" if (4.1 in persondex["Instructor Blaine"]["ClassesKnown"]):
...
menu:    
    ">Craft Charcoal" if (3.1 in persondex["Instructor Blaine"]["ClassesKnown"]):
