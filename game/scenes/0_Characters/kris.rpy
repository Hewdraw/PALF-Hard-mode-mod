init python:
    def KrisHasUnseenScene():
        if (GetCharValue("Professor Cherry") >= 10 and GetRelationship("Professor Cherry") != "Investigator"):
            return "Kris1"
        return False
...
queue music "audio/music/celebi.mp3" fadein 1.5
...
kris @closedbrow "It's only a small amount of poison damage, though, so it wasn't anything big. I think it was probably a--"
...
$ PlaySound("pokemon/cries/48.wav")
...
extend "twice...{w=1.0} {nw}" 

show kris -surprised angrybrow angrymouth with dis

extend "three times...{w=1.0} {nw}" 

show kris -angrybrow -angrymouth happy with dis

extend  "and then click."
...
show kris surprised with vpunch

red @surprised "Ma'am, I need you to tell me how to do that."

kris -surprised @talkingmouth "Oh, the capturing a Pokémon by kicking the Poké Ball?"
...
kris @closedbrow "Memorizing nexus locations. There isn't really an easy way to do that. You kind of have to just sit down with a book and memorize them slowly."
...
red @thinking "Huh? What just happened?"
...
red @thinking "Nothing about you, don't worry."
...
ethan @thinking "Right, so you picked up on her... avoidance of talking about her past, huh."
...
red blackglasses talking2mouth "Alright. [bluecolor]Investigator{/bluecolor} [last_name] is on the case."
