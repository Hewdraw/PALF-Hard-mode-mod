init python:
    def SkylaHasUnseenScene():
        if (GetCharValue("Skyla") >= 10 and personalstats["Patience"] >= 4 and GetRelationship("Skyla") != "Wingman"):
            return "Skyla1"
        return False
...
skyla "Woah! [first_name], is that you?"

red @talkingmouth "Huh? Oh, yeah. I was just doing some shopping. What's up?"

skyla -surprised @angrybrow happymouth "Adventure's up! I'm hot on the tail of a couple of criminals!"

red @thinking "...Criminals?"
...
red @thinking "Right. Well, if you're trying to stop an actual criminal, shouldn't we leave that to the cops?"

skyla @thinking "Cops are useless! If anyone's going to step up and be a hero, it'll be us!"
...
red @thinking "And you know they're criminals because...?"

skyla @thinking "Well... I mean..."
...
red @thinking "Skyla, I think you might be hot on the tail of a couple of {i}bears{/i}."
...
show skyla surprised at night with dis

skyla "Look! [first_name], this is it! I was right! This must be their evil hideout!"
...
skyla surprised "See? They admit to their... their heinous crimes!"
...
show skyla -surprised frownmouth with dis

red @happy "But let's ignore all that, and just play this out."
red @thinking "Let's say you {i}did{/i} manage to beat these two in a Pokémon battle."
...
skyla @thinking "Um... tie them up a smidgen on the tight side, then leave them for the cops?"

red @thinking "Didn't you say the police were useless earlier? Well, whatever."
...
red @thinking "That's not even mentioning that vigilantism is illegal. So beating and tying up a criminal, even if they totally {i}did{/i} do something wrong, is probably going to let them go free."
...
red @thinking "So, like, a firefighter?"
...
if (not IsBefore(1, 5, 2004)):
    ...
    red @sad2eyes "Okay, maybe it is, a little bit, but it's not {i}really.{/i}"
...
skyla @thinking "Besides, you don't need powers to be a Superhero. You just need..."
...
if (persondex["Skyla"]["ClassesKnown"] == []):
    skyla thinking "I'm from Mistralton City, in the West of Unova, but there's a town on the East side of the region called Lentimas, and they were, like, really isolated, so..."
    ...
    skyla closedbrow sweat -talkingmouth "Yyyyyep."

    red @happy "That's insane."

    skyla @smirkmouth "I've heard that before."

skyla @thinking "I just... heroes are {i}it{/i}, you know? They're the best thing there is. The best kind of person."
...
red @thinking "I guess that's true."

show skyla:
    ease 0.25 ypos 1.2 zoom 1.3

skyla "I want to {i}help{/i} people, [first_name]. Really help them. And I want to punish those who hurt others."
...
red @thinking "I can't help but feel like you're already helping people. Like, a {i}lot.{/i} Doesn't that mean you're already a hero?"
...
skyla @thinking "Well, the producers of {i}Pokémon Rangers{/i} call her that."
...
red @thinking "I mean, being a Ranger is a great goal. And I support that for you, seriously. But running into the middle of a city, and looking for a fight, just seems dangerous."
red @happy "And I can't see how that'll make you any more heroic, honestly."

skyla sad "But..."

red @thinking "If you want to be a hero, I think the best chance you have is to {i}help{/i} people. Keep on doing what you've been doing."
...
skyla @thinking "If I wanted to do good things for the wrong reasons, is that so bad?"

red @thinking "I genuinely have no idea. We might need to ask a Professor that one. It's a bit too philosophical for me to figure out."
...
skyla @thinking "I wasn't really thinking, and if I'd gone into that alley alone, and had to face down all those thugs by myself, well... I don't know what would've happened."
...
skyla @thinking "Were you secretly part of their evil team? But then you broke away, blowing up their base as you left, but not before stealing a powerful piece of forbidden technology?"
...
skyla "Oh, but when {i}I{/i} do it, suddenly you're all 'vigilantism is bad' this and 'with great power comes great responsibility' that!"
...
red @thinking "If that's the price I have to pay to not have you {i}literally be killed,{/i} then that's what I'll do."
...
red @thinking "Maybe later. How about, for now... I be your wingman?"

skyla @happy "Alright! I'll take it! That can even be your codename--{color=#0048ff}Wingman!{/color}"

$ persondex["Skyla"]["Relationship"] = "Wingman"
$ persondex["Skyla"]["RelationshipRank"] = 1

$ renpy.music.set_volume(0.1, delay=0.0, channel="music")
play sound "audio/sav.wav"
$ renpy.music.set_volume(1.0, delay=1.0, channel="music")

narrator "Your heart shifts as you feel your relationship with Skyla evolve from '{color=#0048ff}Friend{/color}' to '{color=#0048ff}Wingman{/color}'!"
...
"{color=#686080}???{/color}" "Thanks for handling that. She's tried to 'vanquish' my guys a couple of times. It's getting {s}fucking{/s} {s}goddamn{/s} {s}really{/s} annoying. Keep her out of my hair, and you'll be rewarded.{w=1.0} -S"
