init python:
    def MayHasUnseenScene():
        if (GetCharValue("May") >= 10 and GetRelationship("May") != "Taster"):
            return "May1"
        return False
...
if (not IsBefore(1, 5, 2004)):
    ...
    red @sweat "The ones I don't have."

    may @angrybrow happymouth "Yeah, those ones."

    red @closedbrow sweat "Alright, just making sure we're on the same page. So, you said you're doing research?"
...
red @thinking "Your Dad... oh, Professor Birch, right?"
...
red @thinking "So, is that what you want to do when you graduate?"
...
red @thinking "How did you and Brendan end up becoming interested in coordinating, anyway?"

may @talkingmouth "{i}Contest{/i} coordinating. Musical coordinating is a different thing."

red @surprised "Oh, right. My bad."
...
may @closedbrow frownmouth "Actually, I think he's a bit angry at Brendan, because he thinks Brendan made me want to be a coordinator."

red @surprised "Really? But Brendan's always talked so highly about your Dad."
...
if (IsBefore(1, 5, 2004)):
    ...
    red @thinking "So... you're not sure you can trust him, now?"
...
may @thinking "What if it turns out I'm not good at any others?"

red @thinking "Well... then you could practice, I guess."
...
if (not IsBefore(1, 5, 2004)):
    ...
    may @closedbrow frownmouth "No. I have standards for my boyfriend."
...
may @thinking "Mm... maybe. Maybe I should flip a coin for this..."
...
may -surprised angry "Hey! That's a bit rude!"
...
may -angry -angrybrow frownmouth @thinking "I guess you aren't entirely wrong..."
...
may @thinking "I never thought that was a bad thing, though. Everything's going fine now, so why try to fix what isn't broken?"
...
may @thinking "What about a boyfriend?"
...
if (IsBefore(1, 5, 2004)):
    ...
    red @thinking "Maybe a bit less spicy than you would normally do, though."
...
may @thinking "He's so kind. If he thinks anybody is feeling lonely, or needs help with something, he's always there. Even if he's not actually good at the thing he's helping with."
