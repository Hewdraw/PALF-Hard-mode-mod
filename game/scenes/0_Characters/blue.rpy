init python:
    def BlueHasUnseenScene():
        if (GetCharValue("Blue") >= 10 and personalstats["Charm"] >= 6 and GetRelationship("Blue") != "Listener"):
            return "Blue1"
        return False
...
blue @closedbrow "You've had enough damn handouts."

pause 1.0

stop music fadeout 1.5
show screen songsplash("Pallet Town", "Zame")
$ renpy.music.queue("Audio/Music/palletpiano.mp3", channel='music', loop=True, tight=None)
...
show blue surprised with vpunch
...
red @thinking "...Aren't the Pokémon here at way too low a level for you?"
...
if (bluepidgeottoobj.GetId() != pokedexlookupname("Pidgeotto", DexMacros.Id)):
    $ speciesname = "Pidgeot"

blue "Hah! Did you see that? My [speciesname] totally rocks!"
...
blue -surprised frownmouth angrybrow @angrymouth "Don't say that. Don't apologize for other people, dumbass!"
...
blue -surprised @angry "You don't mean that."
...
red @thinking "Maybe I will."

$ persondex["Blue"]["Relationship"] = "Listener"
$ persondex["Blue"]["RelationshipRank"] = 1
$ persondex["Blue"]["Nature"] = TrainerNature.Moody

$ PlaySound("sav.wav")

narrator "Your heart shifts as you feel your relationship with Blue evolve from '{color=#0048ff}Rival{/color}' to '{color=#0048ff}Listener{/color}'!"
