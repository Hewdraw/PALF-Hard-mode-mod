...
define config.version = "10.29.2023"
...
init -1 python hide:
    style.menu_choice_button.background = Frame("GUI/Choice_Idle.png",10,10)
    style.menu_choice_button.hover_background = Frame("GUI/Choice_Hover.png",10,10)
...
define config.main_menu_music = "Audio/Music/Shelf of Memories (Prelude).mp3"