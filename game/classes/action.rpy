init python:
    class Action:
        def __init__(self, priority, speed, actionType, userTrainer, user, move, targetTrainers, targets, turn):
            ...
            self.Turn = turn#int
            self.TargetSlots = GetSlots(targets)#[int] the slot the targets were in. Useful if the targets become invalid
