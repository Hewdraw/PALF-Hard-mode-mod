    ...
    if (excusesecondelective or excusesecondhomeroom):
        ...
        menu:
            "That's fine.":
                ...
                $ classstudied[selectedtype] = True
        ...
        menu: 
            "Yeah, sure.":
                ...
                $ imagestring = randomstudent.lower()
                if (imagestring == "tia" and not IsBefore(17, 4, 2004)):
                    $ imagestring += " hat"
            ...
            "No, contact someone else.":
                ...
                if (contact.lower() not in WillStudy(selectedtype)):
                    pause 3.0
                    ...
                    menu:
                        ">Give [interaction] the [item]":
                            python:
                                ...
                                if (presentvalue > 10):
                                    ValueChange(interaction, 10, 0.12, pausing=False)
...
python:
    ...
    if (len(added) > 0 and pikachuobj in playerparty and not IsBefore(1, 5, 2004)):
        ...
        for i in range(0, len(added), 3):
            ...
            if (persondex["Yellow"]["Value"] != 0):
                persondex["Yellow"]["Value"] = len(foreveralinv)
